#[doc = "Register `TIMG8_STAT` reader"]
pub type R = crate::R<Timg8StatSpec>;
...
#[doc = "Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`timg8_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg8StatSpec;
impl crate::RegisterSpec for Timg8StatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg8_stat::R`](R) reader structure"]
impl crate::Readable for Timg8StatSpec {}
#[doc = "`reset()` method sets TIMG8_STAT to value 0"]
impl crate::Resettable for Timg8StatSpec {}
