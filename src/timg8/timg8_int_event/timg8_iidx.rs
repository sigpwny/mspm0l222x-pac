#[doc = "Register `TIMG8_IIDX` reader"]
pub type R = crate::R<Timg8IidxSpec>;
...
#[doc = "Interrupt index\n\nYou can [`read`](crate::Reg::read) this register and get [`timg8_iidx::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg8IidxSpec;
impl crate::RegisterSpec for Timg8IidxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg8_iidx::R`](R) reader structure"]
impl crate::Readable for Timg8IidxSpec {}
#[doc = "`reset()` method sets TIMG8_IIDX to value 0"]
impl crate::Resettable for Timg8IidxSpec {}
