#[doc = "Register `TIMG8_ISET` writer"]
pub type W = crate::W<Timg8IsetSpec>;
#[doc = "Zero event SET\n\nValue on reset: 0"]
...
#[doc = "Field `DC` writer - Direction Change event SET"]
...
#[doc = "Field `QEIERR` writer - QEIERR event SET"]
...
impl W {
    ...
    #[inline(always)]
    pub fn z(&mut self) -> ZW<'_, Timg8IsetSpec> {
        ZW::new(self, 0)
    }
    #[doc = "Bit 1 - Load event SET"]
    #[inline(always)]
    pub fn l(&mut self) -> LW<'_, Timg8IsetSpec> {
        LW::new(self, 1)
    }
    #[doc = "Bit 4 - Capture or compare down event SET"]
    #[inline(always)]
    pub fn ccd0(&mut self) -> Ccd0W<'_, Timg8IsetSpec> {
        Ccd0W::new(self, 4)
    }
    #[doc = "Bit 5 - Capture or compare down event SET"]
    #[inline(always)]
    pub fn ccd1(&mut self) -> Ccd1W<'_, Timg8IsetSpec> {
        Ccd1W::new(self, 5)
    }
    #[doc = "Bit 8 - Capture or compare up event SET"]
    #[inline(always)]
    pub fn ccu0(&mut self) -> Ccu0W<'_, Timg8IsetSpec> {
        Ccu0W::new(self, 8)
    }
    #[doc = "Bit 9 - Capture or compare up event SET"]
    #[inline(always)]
    pub fn ccu1(&mut self) -> Ccu1W<'_, Timg8IsetSpec> {
        Ccu1W::new(self, 9)
    }
    #[doc = "Bit 25 - Trigger Overflow event SET"]
    #[inline(always)]
    pub fn tov(&mut self) -> TovW<'_, Timg8IsetSpec> {
        TovW::new(self, 25)
    }
    #[doc = "Bit 27 - Direction Change event SET"]
    #[inline(always)]
    pub fn dc(&mut self) -> DcW<'_, Timg8IsetSpec> {
        DcW::new(self, 27)
    }
    #[doc = "Bit 28 - QEIERR event SET"]
    #[inline(always)]
    pub fn qeierr(&mut self) -> QeierrW<'_, Timg8IsetSpec> {
        QeierrW::new(self, 28)
    }
}
#[doc = "Interrupt set\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timg8_iset::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg8IsetSpec;
impl crate::RegisterSpec for Timg8IsetSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`timg8_iset::W`](W) writer structure"]
impl crate::Writable for Timg8IsetSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMG8_ISET to value 0"]
impl crate::Resettable for Timg8IsetSpec {}
