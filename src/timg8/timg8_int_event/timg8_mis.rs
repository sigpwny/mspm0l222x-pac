#[doc = "Register `TIMG8_MIS` reader"]
pub type R = crate::R<Timg8MisSpec>;
...
#[doc = "Field `QEIERR` reader - QEIERR"]
...
#[doc = "Masked interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`timg8_mis::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg8MisSpec;
impl crate::RegisterSpec for Timg8MisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg8_mis::R`](R) reader structure"]
impl crate::Readable for Timg8MisSpec {}
#[doc = "`reset()` method sets TIMG8_MIS to value 0"]
impl crate::Resettable for Timg8MisSpec {}
