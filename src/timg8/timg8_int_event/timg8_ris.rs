#[doc = "Register `TIMG8_RIS` reader"]
pub type R = crate::R<Timg8RisSpec>;
...
#[doc = "Field `DC` reader - Direction Change"]
...
#[doc = "Field `QEIERR` reader - QEIERR, set on an incorrect state transition on the encoder interface."]
...
#[doc = "Raw interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`timg8_ris::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg8RisSpec;
impl crate::RegisterSpec for Timg8RisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg8_ris::R`](R) reader structure"]
impl crate::Readable for Timg8RisSpec {}
#[doc = "`reset()` method sets TIMG8_RIS to value 0"]
impl crate::Resettable for Timg8RisSpec {}
