#[doc = "Register `TIMG8_IMASK` reader"]
pub type R = crate::R<Timg8ImaskSpec>;
#[doc = "Register `TIMG8_IMASK` writer"]
pub type W = crate::W<Timg8ImaskSpec>;
#[doc = "Zero Event mask\n\nValue on reset: 0"]
...
#[doc = "Direction Change Event mask\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Dc {
    #[doc = "0: Disable Event"]
    Clr = 0,
...
#[doc = "Field `DC` reader - Direction Change Event mask"]
...
#[doc = "Field `DC` writer - Direction Change Event mask"]
...
#[doc = "Field `QEIERR` reader - QEIERR Event mask"]
pub type QeierrR = crate::BitReader<Qeierr>;
impl QeierrR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Qeierr {
        match self.bits {
            false => Qeierr::Clr,
            true => Qeierr::Set,
        }
...
#[doc = "Field `QEIERR` writer - QEIERR Event mask"]
...
impl R {
    ...
    #[doc = "Bit 27 - Direction Change Event mask"]
    #[inline(always)]
    pub fn dc(&self) -> DcR {
        DcR::new(((self.bits >> 27) & 1) != 0)
    }
    #[doc = "Bit 28 - QEIERR Event mask"]
    #[inline(always)]
    pub fn qeierr(&self) -> QeierrR {
        QeierrR::new(((self.bits >> 28) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Zero Event mask"]
    #[inline(always)]
    pub fn z(&mut self) -> ZW<'_, Timg8ImaskSpec> {
        ZW::new(self, 0)
    }
    #[doc = "Bit 1 - Load Event mask"]
    #[inline(always)]
    pub fn l(&mut self) -> LW<'_, Timg8ImaskSpec> {
        LW::new(self, 1)
    }
    #[doc = "Bit 4 - Capture or Compare DN event mask CCP0"]
    #[inline(always)]
    pub fn ccd0(&mut self) -> Ccd0W<'_, Timg8ImaskSpec> {
        Ccd0W::new(self, 4)
    }
    #[doc = "Bit 5 - Capture or Compare DN event mask CCP1"]
    #[inline(always)]
    pub fn ccd1(&mut self) -> Ccd1W<'_, Timg8ImaskSpec> {
        Ccd1W::new(self, 5)
    }
    #[doc = "Bit 8 - Capture or Compare UP event mask CCP0"]
    #[inline(always)]
    pub fn ccu0(&mut self) -> Ccu0W<'_, Timg8ImaskSpec> {
        Ccu0W::new(self, 8)
    }
    #[doc = "Bit 9 - Capture or Compare UP event mask CCP1"]
    #[inline(always)]
    pub fn ccu1(&mut self) -> Ccu1W<'_, Timg8ImaskSpec> {
        Ccu1W::new(self, 9)
    }
    #[doc = "Bit 25 - Trigger Overflow Event mask"]
    #[inline(always)]
    pub fn tov(&mut self) -> TovW<'_, Timg8ImaskSpec> {
        TovW::new(self, 25)
    }
    #[doc = "Bit 27 - Direction Change Event mask"]
    #[inline(always)]
    pub fn dc(&mut self) -> DcW<'_, Timg8ImaskSpec> {
        DcW::new(self, 27)
    }
    #[doc = "Bit 28 - QEIERR Event mask"]
    #[inline(always)]
    pub fn qeierr(&mut self) -> QeierrW<'_, Timg8ImaskSpec> {
        QeierrW::new(self, 28)
    }
}
#[doc = "Interrupt mask\n\nYou can [`read`](crate::Reg::read) this register and get [`timg8_imask::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timg8_imask::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg8ImaskSpec;
impl crate::RegisterSpec for Timg8ImaskSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg8_imask::R`](R) reader structure"]
impl crate::Readable for Timg8ImaskSpec {}
#[doc = "`write(|w| ..)` method takes [`timg8_imask::W`](W) writer structure"]
impl crate::Writable for Timg8ImaskSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMG8_IMASK to value 0"]
impl crate::Resettable for Timg8ImaskSpec {}
