#[doc = "Register `TIMG8_DESC` reader"]
pub type R = crate::R<Timg8DescSpec>;
...
#[doc = "Module Description\n\nYou can [`read`](crate::Reg::read) this register and get [`timg8_desc::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg8DescSpec;
impl crate::RegisterSpec for Timg8DescSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg8_desc::R`](R) reader structure"]
impl crate::Readable for Timg8DescSpec {}
#[doc = "`reset()` method sets TIMG8_DESC to value 0"]
impl crate::Resettable for Timg8DescSpec {}
