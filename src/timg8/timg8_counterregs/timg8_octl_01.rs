#[doc = "Register `TIMG8_OCTL_01[%s]` reader"]
pub type R = crate::R<Timg8Octl01Spec>;
#[doc = "Register `TIMG8_OCTL_01[%s]` writer"]
pub type W = crate::W<Timg8Octl01Spec>;
...
impl W {
    #[doc = "Bits 0:3 - CCP Output Source"]
    #[inline(always)]
    pub fn ccpo(&mut self) -> CcpoW<'_, Timg8Octl01Spec> {
        CcpoW::new(self, 0)
    }
    #[doc = "Bit 4 - CCP Output Invert The output as selected by CCPO is conditionally inverted."]
    #[inline(always)]
    pub fn ccpoinv(&mut self) -> CcpoinvW<'_, Timg8Octl01Spec> {
        CcpoinvW::new(self, 4)
    }
    #[doc = "Bit 5 - CCP Initial Value This bit specifies the logical value put on the signal generator state while the counter is disabled (CTRCTL.EN == 0)."]
    #[inline(always)]
    pub fn ccpiv(&mut self) -> CcpivW<'_, Timg8Octl01Spec> {
        CcpivW::new(self, 5)
    }
}
#[doc = "CCP Output Control Registers\n\nYou can [`read`](crate::Reg::read) this register and get [`timg8_octl_01::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timg8_octl_01::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg8Octl01Spec;
impl crate::RegisterSpec for Timg8Octl01Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg8_octl_01::R`](R) reader structure"]
impl crate::Readable for Timg8Octl01Spec {}
#[doc = "`write(|w| ..)` method takes [`timg8_octl_01::W`](W) writer structure"]
impl crate::Writable for Timg8Octl01Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMG8_OCTL_01[%s] to value 0"]
impl crate::Resettable for Timg8Octl01Spec {}
