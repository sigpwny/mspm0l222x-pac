#[doc = "Register `TIMG8_IFCTL_01[%s]` reader"]
pub type R = crate::R<Timg8Ifctl01Spec>;
#[doc = "Register `TIMG8_IFCTL_01[%s]` writer"]
pub type W = crate::W<Timg8Ifctl01Spec>;
...
impl W {
    #[doc = "Bits 0:3 - Input Select (CCP0) This field selects the input source to the filter input. 4h-7h = Reserved"]
    #[inline(always)]
    pub fn isel(&mut self) -> IselW<'_, Timg8Ifctl01Spec> {
        IselW::new(self, 0)
    }
    #[doc = "Bit 7 - Input Inversion This bit controls whether the selected input is inverted."]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<'_, Timg8Ifctl01Spec> {
        InvW::new(self, 7)
    }
    #[doc = "Bits 8:9 - Filter Period. This field specifies the sample period for the input filter. I.e. The input is sampled for FP timer clocks during filtering."]
    #[inline(always)]
    pub fn fp(&mut self) -> FpW<'_, Timg8Ifctl01Spec> {
        FpW::new(self, 8)
    }
    #[doc = "Bit 11 - Consecutive Period/Voting Select This bit controls whether the input filter uses a stricter consecutive period count or majority voting."]
    #[inline(always)]
    pub fn cpv(&mut self) -> CpvW<'_, Timg8Ifctl01Spec> {
        CpvW::new(self, 11)
    }
    #[doc = "Bit 12 - Filter Enable This bit controls whether the input is filtered by the input filter or bypasses to the edge detect."]
    #[inline(always)]
    pub fn fe(&mut self) -> FeW<'_, Timg8Ifctl01Spec> {
        FeW::new(self, 12)
    }
}
#[doc = "Input Filter Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`timg8_ifctl_01::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timg8_ifctl_01::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg8Ifctl01Spec;
impl crate::RegisterSpec for Timg8Ifctl01Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg8_ifctl_01::R`](R) reader structure"]
impl crate::Readable for Timg8Ifctl01Spec {}
#[doc = "`write(|w| ..)` method takes [`timg8_ifctl_01::W`](W) writer structure"]
impl crate::Writable for Timg8Ifctl01Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMG8_IFCTL_01[%s] to value 0"]
impl crate::Resettable for Timg8Ifctl01Spec {}
