#[doc = "Register `TIMG8_CTTRIG` writer"]
pub type W = crate::W<Timg8CttrigSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn trig(&mut self) -> TrigW<'_, Timg8CttrigSpec> {
        TrigW::new(self, 0)
    }
}
#[doc = "Timer Cross Trigger Register\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timg8_cttrig::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg8CttrigSpec;
impl crate::RegisterSpec for Timg8CttrigSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`timg8_cttrig::W`](W) writer structure"]
impl crate::Writable for Timg8CttrigSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMG8_CTTRIG to value 0"]
impl crate::Resettable for Timg8CttrigSpec {}
