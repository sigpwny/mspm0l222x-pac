#[doc = "Register `CPUSS_INT_GROUP0_IMASK` reader"]
pub type R = crate::R<CpussIntGroup0ImaskSpec>;
...
#[doc = "Interrupt mask\n\nYou can [`read`](crate::Reg::read) this register and get [`cpuss_int_group0_imask::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CpussIntGroup0ImaskSpec;
impl crate::RegisterSpec for CpussIntGroup0ImaskSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpuss_int_group0_imask::R`](R) reader structure"]
impl crate::Readable for CpussIntGroup0ImaskSpec {}
#[doc = "`reset()` method sets CPUSS_INT_GROUP0_IMASK to value 0xff"]
impl crate::Resettable for CpussIntGroup0ImaskSpec {
