#[doc = "Register `CPUSS_DESC` reader"]
pub type R = crate::R<CpussDescSpec>;
...
#[doc = "Module Description\n\nYou can [`read`](crate::Reg::read) this register and get [`cpuss_desc::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CpussDescSpec;
impl crate::RegisterSpec for CpussDescSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpuss_desc::R`](R) reader structure"]
impl crate::Readable for CpussDescSpec {}
#[doc = "`reset()` method sets CPUSS_DESC to value 0"]
impl crate::Resettable for CpussDescSpec {}
