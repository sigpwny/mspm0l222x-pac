#[doc = "Register `CPUSS_INT_GROUP1_IIDX` reader"]
pub type R = crate::R<CpussIntGroup1IidxSpec>;
...
#[doc = "Interrupt index\n\nYou can [`read`](crate::Reg::read) this register and get [`cpuss_int_group1_iidx::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CpussIntGroup1IidxSpec;
impl crate::RegisterSpec for CpussIntGroup1IidxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cpuss_int_group1_iidx::R`](R) reader structure"]
impl crate::Readable for CpussIntGroup1IidxSpec {}
#[doc = "`reset()` method sets CPUSS_INT_GROUP1_IIDX to value 0"]
impl crate::Resettable for CpussIntGroup1IidxSpec {}
