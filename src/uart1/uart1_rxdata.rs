#[doc = "Register `UART1_RXDATA` reader"]
pub type R = crate::R<Uart1RxdataSpec>;
...
#[doc = "UART Receive Data Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uart1_rxdata::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart1RxdataSpec;
impl crate::RegisterSpec for Uart1RxdataSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart1_rxdata::R`](R) reader structure"]
impl crate::Readable for Uart1RxdataSpec {}
#[doc = "`reset()` method sets UART1_RXDATA to value 0"]
impl crate::Resettable for Uart1RxdataSpec {}
