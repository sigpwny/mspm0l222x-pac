#[doc = "Register `UART1_INT_EVENT0_MIS` reader"]
pub type R = crate::R<Uart1IntEvent0MisSpec>;
...
#[doc = "Field `FRMERR` reader - Masked UART Framing Error Interrupt."]
...
#[doc = "Field `PARERR` reader - Masked UART Parity Error Interrupt."]
...
#[doc = "Field `BRKERR` reader - Masked UART Break Error Interrupt."]
...
#[doc = "Field `OVRERR` reader - Masked UART Receive Overrun Error Interrupt."]
...
#[doc = "Field `RXNE` reader - Masked Negative Edge on UARTxRXD Interrupt."]
...
#[doc = "Field `RXPE` reader - Masked Positive Edge on UARTxRXD Interrupt."]
...
#[doc = "Field `LINC0` reader - Masked LIN Capture 0 / Match Interrupt ."]
...
#[doc = "Field `LINC1` reader - Masked LIN Capture 1 Interrupt."]
...
#[doc = "Field `LINOVF` reader - Masked LIN Hardware Counter Overflow Interrupt."]
...
#[doc = "Field `ADDR_MATCH` reader - Masked Address Match Interrupt."]
...
#[doc = "Field `CTS` reader - Masked UART Clear to Send Modem Interrupt."]
...
#[doc = "Field `DMA_DONE_RX` reader - Masked DMA Done on RX Event Channel Interrupt"]
...
#[doc = "Field `DMA_DONE_TX` reader - Masked DMA Done on TX Event Channel Interrupt"]
...
#[doc = "Masked interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`uart1_int_event0_mis::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart1IntEvent0MisSpec;
impl crate::RegisterSpec for Uart1IntEvent0MisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart1_int_event0_mis::R`](R) reader structure"]
impl crate::Readable for Uart1IntEvent0MisSpec {}
#[doc = "`reset()` method sets UART1_INT_EVENT0_MIS to value 0"]
impl crate::Resettable for Uart1IntEvent0MisSpec {}
