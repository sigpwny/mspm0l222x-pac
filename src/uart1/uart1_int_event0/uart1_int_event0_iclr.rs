#[doc = "Register `UART1_INT_EVENT0_ICLR` writer"]
pub type W = crate::W<Uart1IntEvent0IclrSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn rtout(&mut self) -> RtoutW<'_, Uart1IntEvent0IclrSpec> {
        RtoutW::new(self, 0)
    }
    #[doc = "Bit 1 - Clear UART Framing Error Interrupt."]
    #[inline(always)]
    pub fn frmerr(&mut self) -> FrmerrW<'_, Uart1IntEvent0IclrSpec> {
        FrmerrW::new(self, 1)
    }
    #[doc = "Bit 2 - Clear UART Parity Error Interrupt."]
    #[inline(always)]
    pub fn parerr(&mut self) -> ParerrW<'_, Uart1IntEvent0IclrSpec> {
        ParerrW::new(self, 2)
    }
    #[doc = "Bit 3 - Clear UART Break Error Interrupt."]
    #[inline(always)]
    pub fn brkerr(&mut self) -> BrkerrW<'_, Uart1IntEvent0IclrSpec> {
        BrkerrW::new(self, 3)
    }
    #[doc = "Bit 4 - Clear UART Receive Overrun Error Interrupt."]
    #[inline(always)]
    pub fn ovrerr(&mut self) -> OvrerrW<'_, Uart1IntEvent0IclrSpec> {
        OvrerrW::new(self, 4)
    }
    #[doc = "Bit 5 - Clear Negative Edge on UARTxRXD Interrupt."]
    #[inline(always)]
    pub fn rxne(&mut self) -> RxneW<'_, Uart1IntEvent0IclrSpec> {
        RxneW::new(self, 5)
    }
    #[doc = "Bit 6 - Clear Positive Edge on UARTxRXD Interrupt."]
    #[inline(always)]
    pub fn rxpe(&mut self) -> RxpeW<'_, Uart1IntEvent0IclrSpec> {
        RxpeW::new(self, 6)
    }
    #[doc = "Bit 7 - Clear LIN Capture 0 / Match Interrupt ."]
    #[inline(always)]
    pub fn linc0(&mut self) -> Linc0W<'_, Uart1IntEvent0IclrSpec> {
        Linc0W::new(self, 7)
    }
    #[doc = "Bit 8 - Clear LIN Capture 1 Interrupt."]
    #[inline(always)]
    pub fn linc1(&mut self) -> Linc1W<'_, Uart1IntEvent0IclrSpec> {
        Linc1W::new(self, 8)
    }
    #[doc = "Bit 9 - Clear LIN Hardware Counter Overflow Interrupt."]
    #[inline(always)]
    pub fn linovf(&mut self) -> LinovfW<'_, Uart1IntEvent0IclrSpec> {
        LinovfW::new(self, 9)
    }
    #[doc = "Bit 10 - Clear UART Receive Interrupt."]
    #[inline(always)]
    pub fn rxint(&mut self) -> RxintW<'_, Uart1IntEvent0IclrSpec> {
        RxintW::new(self, 10)
    }
    #[doc = "Bit 11 - Clear UART Transmit Interrupt."]
    #[inline(always)]
    pub fn txint(&mut self) -> TxintW<'_, Uart1IntEvent0IclrSpec> {
        TxintW::new(self, 11)
    }
    ...
    #[inline(always)]
    pub fn eot(&mut self) -> EotW<'_, Uart1IntEvent0IclrSpec> {
        EotW::new(self, 12)
    }
    #[doc = "Bit 13 - Clear Address Match Interrupt."]
    #[inline(always)]
    pub fn addr_match(&mut self) -> AddrMatchW<'_, Uart1IntEvent0IclrSpec> {
        AddrMatchW::new(self, 13)
    }
    #[doc = "Bit 14 - Clear UART Clear to Send Modem Interrupt."]
    #[inline(always)]
    pub fn cts(&mut self) -> CtsW<'_, Uart1IntEvent0IclrSpec> {
        CtsW::new(self, 14)
    }
    #[doc = "Bit 15 - Clear DMA Done on RX Event Channel Interrupt"]
    #[inline(always)]
    pub fn dma_done_rx(&mut self) -> DmaDoneRxW<'_, Uart1IntEvent0IclrSpec> {
        DmaDoneRxW::new(self, 15)
    }
    #[doc = "Bit 16 - Clear DMA Done on TX Event Channel Interrupt"]
    #[inline(always)]
    pub fn dma_done_tx(&mut self) -> DmaDoneTxW<'_, Uart1IntEvent0IclrSpec> {
    ...
    #[inline(always)]
    pub fn nerr(&mut self) -> NerrW<'_, Uart1IntEvent0IclrSpec> {
        NerrW::new(self, 17)
    }
}
#[doc = "Interrupt clear\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uart1_int_event0_iclr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart1IntEvent0IclrSpec;
impl crate::RegisterSpec for Uart1IntEvent0IclrSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`uart1_int_event0_iclr::W`](W) writer structure"]
impl crate::Writable for Uart1IntEvent0IclrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UART1_INT_EVENT0_ICLR to value 0"]
impl crate::Resettable for Uart1IntEvent0IclrSpec {}
