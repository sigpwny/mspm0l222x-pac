#[doc = "Register `UART1_INT_EVENT0_ISET` writer"]
pub type W = crate::W<Uart1IntEvent0IsetSpec>;
...
#[doc = "Field `FRMERR` writer - Set UART Framing Error Interrupt."]
...
#[doc = "Field `PARERR` writer - Set UART Parity Error Interrupt."]
...
#[doc = "Field `BRKERR` writer - Set UART Break Error Interrupt."]
...
#[doc = "Field `OVRERR` writer - Set UART Receive Overrun Error Interrupt."]
...
#[doc = "Field `RXNE` writer - Set Negative Edge on UARTxRXD Interrupt."]
...
#[doc = "Field `RXPE` writer - Set Positive Edge on UARTxRXD Interrupt."]
...
#[doc = "Field `LINC0` writer - Set LIN Capture 0 / Match Interrupt ."]
...
#[doc = "Set LIN Capture 1 Interrupt.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Linc1 {
    #[doc = "0: Writing 0 has no effect"]
    NoEffect = 0,
...
#[doc = "Field `LINC1` writer - Set LIN Capture 1 Interrupt."]
...
#[doc = "Set LIN Hardware Counter Overflow Interrupt.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Linovf {
    #[doc = "0: Writing 0 has no effect"]
    NoEffect = 0,
...
#[doc = "Field `LINOVF` writer - Set LIN Hardware Counter Overflow Interrupt."]
...
#[doc = "Field `EOT` writer - Set UART End of Transmission Interrupt Indicates that the last bit of all transmitted data and flags has left the serializer and without any further Data in the TX Fifo or Buffer."]
...
#[doc = "Field `ADDR_MATCH` writer - Set Address Match Interrupt."]
...
#[doc = "Field `CTS` writer - Set UART Clear to Send Modem Interrupt."]
...
#[doc = "Field `DMA_DONE_RX` writer - Set DMA Done on RX Event Channel Interrupt"]
...
#[doc = "Field `DMA_DONE_TX` writer - Set DMA Done on TX Event Channel Interrupt"]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Nerr {
    #[doc = "0: Writing this has no effect"]
    NoEffect = 0,
    #[doc = "1: Set the interrupt"]
    Set = 1,
}
...
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Writing this has no effect"]
    #[inline(always)]
    pub fn no_effect(self) -> &'a mut crate::W<REG> {
        self.variant(Nerr::NoEffect)
    }
    #[doc = "Set the interrupt"]
    #[inline(always)]
    pub fn set_(self) -> &'a mut crate::W<REG> {
...
impl W {
    ...
    #[inline(always)]
    pub fn rtout(&mut self) -> RtoutW<'_, Uart1IntEvent0IsetSpec> {
        RtoutW::new(self, 0)
    }
    #[doc = "Bit 1 - Set UART Framing Error Interrupt."]
    #[inline(always)]
    pub fn frmerr(&mut self) -> FrmerrW<'_, Uart1IntEvent0IsetSpec> {
        FrmerrW::new(self, 1)
    }
    #[doc = "Bit 2 - Set UART Parity Error Interrupt."]
    #[inline(always)]
    pub fn parerr(&mut self) -> ParerrW<'_, Uart1IntEvent0IsetSpec> {
        ParerrW::new(self, 2)
    }
    #[doc = "Bit 3 - Set UART Break Error Interrupt."]
    #[inline(always)]
    pub fn brkerr(&mut self) -> BrkerrW<'_, Uart1IntEvent0IsetSpec> {
        BrkerrW::new(self, 3)
    }
    #[doc = "Bit 4 - Set UART Receive Overrun Error Interrupt."]
    #[inline(always)]
    pub fn ovrerr(&mut self) -> OvrerrW<'_, Uart1IntEvent0IsetSpec> {
        OvrerrW::new(self, 4)
    }
    #[doc = "Bit 5 - Set Negative Edge on UARTxRXD Interrupt."]
    #[inline(always)]
    pub fn rxne(&mut self) -> RxneW<'_, Uart1IntEvent0IsetSpec> {
        RxneW::new(self, 5)
    }
    #[doc = "Bit 6 - Set Positive Edge on UARTxRXD Interrupt."]
    #[inline(always)]
    pub fn rxpe(&mut self) -> RxpeW<'_, Uart1IntEvent0IsetSpec> {
        RxpeW::new(self, 6)
    }
    #[doc = "Bit 7 - Set LIN Capture 0 / Match Interrupt ."]
    #[inline(always)]
    pub fn linc0(&mut self) -> Linc0W<'_, Uart1IntEvent0IsetSpec> {
        Linc0W::new(self, 7)
    }
    #[doc = "Bit 8 - Set LIN Capture 1 Interrupt."]
    #[inline(always)]
    pub fn linc1(&mut self) -> Linc1W<'_, Uart1IntEvent0IsetSpec> {
        Linc1W::new(self, 8)
    }
    #[doc = "Bit 9 - Set LIN Hardware Counter Overflow Interrupt."]
    #[inline(always)]
    pub fn linovf(&mut self) -> LinovfW<'_, Uart1IntEvent0IsetSpec> {
        LinovfW::new(self, 9)
    }
    #[doc = "Bit 10 - Set UART Receive Interrupt."]
    #[inline(always)]
    pub fn rxint(&mut self) -> RxintW<'_, Uart1IntEvent0IsetSpec> {
        RxintW::new(self, 10)
    }
    #[doc = "Bit 11 - Set UART Transmit Interrupt."]
    #[inline(always)]
    pub fn txint(&mut self) -> TxintW<'_, Uart1IntEvent0IsetSpec> {
        TxintW::new(self, 11)
    }
    ...
    #[inline(always)]
    pub fn eot(&mut self) -> EotW<'_, Uart1IntEvent0IsetSpec> {
        EotW::new(self, 12)
    }
    #[doc = "Bit 13 - Set Address Match Interrupt."]
    #[inline(always)]
    pub fn addr_match(&mut self) -> AddrMatchW<'_, Uart1IntEvent0IsetSpec> {
        AddrMatchW::new(self, 13)
    }
    #[doc = "Bit 14 - Set UART Clear to Send Modem Interrupt."]
    #[inline(always)]
    pub fn cts(&mut self) -> CtsW<'_, Uart1IntEvent0IsetSpec> {
        CtsW::new(self, 14)
    }
    #[doc = "Bit 15 - Set DMA Done on RX Event Channel Interrupt"]
    #[inline(always)]
    pub fn dma_done_rx(&mut self) -> DmaDoneRxW<'_, Uart1IntEvent0IsetSpec> {
        DmaDoneRxW::new(self, 15)
    }
    #[doc = "Bit 16 - Set DMA Done on TX Event Channel Interrupt"]
    #[inline(always)]
    pub fn dma_done_tx(&mut self) -> DmaDoneTxW<'_, Uart1IntEvent0IsetSpec> {
    ...
    #[inline(always)]
    pub fn nerr(&mut self) -> NerrW<'_, Uart1IntEvent0IsetSpec> {
        NerrW::new(self, 17)
    }
}
#[doc = "Interrupt set\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uart1_int_event0_iset::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart1IntEvent0IsetSpec;
impl crate::RegisterSpec for Uart1IntEvent0IsetSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`uart1_int_event0_iset::W`](W) writer structure"]
impl crate::Writable for Uart1IntEvent0IsetSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UART1_INT_EVENT0_ISET to value 0"]
impl crate::Resettable for Uart1IntEvent0IsetSpec {}
