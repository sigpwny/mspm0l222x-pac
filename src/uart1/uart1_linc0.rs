#[doc = "Register `UART1_LINC0` reader"]
pub type R = crate::R<Uart1Linc0Spec>;
#[doc = "Register `UART1_LINC0` writer"]
pub type W = crate::W<Uart1Linc0Spec>;
...
impl W {
    #[doc = "Bits 0:15 - 16 Bit Capture / Compare Register Captures current LINCTR value on RXD falling edge and can generate a LINC0 interrupt when capture is enabled (LINC0CAP = 1). If compare mode is enabled (LINC0_MATCH = 1), a counter match can generate a LINC0 interrupt."]
    #[inline(always)]
    pub fn data(&mut self) -> DataW<'_, Uart1Linc0Spec> {
        DataW::new(self, 0)
    }
}
#[doc = "UART LIN Mode Capture 0 Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uart1_linc0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uart1_linc0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart1Linc0Spec;
impl crate::RegisterSpec for Uart1Linc0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart1_linc0::R`](R) reader structure"]
impl crate::Readable for Uart1Linc0Spec {}
#[doc = "`write(|w| ..)` method takes [`uart1_linc0::W`](W) writer structure"]
impl crate::Writable for Uart1Linc0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UART1_LINC0 to value 0"]
impl crate::Resettable for Uart1Linc0Spec {}
