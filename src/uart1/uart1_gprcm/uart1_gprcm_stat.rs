#[doc = "Register `UART1_GPRCM_STAT` reader"]
pub type R = crate::R<Uart1GprcmStatSpec>;
...
#[doc = "Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uart1_gprcm_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart1GprcmStatSpec;
impl crate::RegisterSpec for Uart1GprcmStatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart1_gprcm_stat::R`](R) reader structure"]
impl crate::Readable for Uart1GprcmStatSpec {}
#[doc = "`reset()` method sets UART1_GPRCM_STAT to value 0"]
impl crate::Resettable for Uart1GprcmStatSpec {}
