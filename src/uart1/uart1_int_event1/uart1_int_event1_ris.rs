#[doc = "Register `UART1_INT_EVENT1_RIS` reader"]
pub type R = crate::R<Uart1IntEvent1RisSpec>;
...
#[doc = "Raw interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`uart1_int_event1_ris::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart1IntEvent1RisSpec;
impl crate::RegisterSpec for Uart1IntEvent1RisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart1_int_event1_ris::R`](R) reader structure"]
impl crate::Readable for Uart1IntEvent1RisSpec {}
#[doc = "`reset()` method sets UART1_INT_EVENT1_RIS to value 0"]
impl crate::Resettable for Uart1IntEvent1RisSpec {}
