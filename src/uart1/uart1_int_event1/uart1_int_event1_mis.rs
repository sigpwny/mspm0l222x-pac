#[doc = "Register `UART1_INT_EVENT1_MIS` reader"]
pub type R = crate::R<Uart1IntEvent1MisSpec>;
...
#[doc = "Masked interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`uart1_int_event1_mis::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart1IntEvent1MisSpec;
impl crate::RegisterSpec for Uart1IntEvent1MisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart1_int_event1_mis::R`](R) reader structure"]
impl crate::Readable for Uart1IntEvent1MisSpec {}
#[doc = "`reset()` method sets UART1_INT_EVENT1_MIS to value 0"]
impl crate::Resettable for Uart1IntEvent1MisSpec {}
