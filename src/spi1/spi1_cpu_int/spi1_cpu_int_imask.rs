#[doc = "Register `SPI1_CPU_INT_IMASK` reader"]
pub type R = crate::R<Spi1CpuIntImaskSpec>;
#[doc = "Register `SPI1_CPU_INT_IMASK` writer"]
pub type W = crate::W<Spi1CpuIntImaskSpec>;
...
impl W {
    #[doc = "Bit 0 - RXFIFO overflow event mask."]
    #[inline(always)]
    pub fn rxfifo_ovf(&mut self) -> RxfifoOvfW<'_, Spi1CpuIntImaskSpec> {
        RxfifoOvfW::new(self, 0)
    }
    #[doc = "Bit 1 - Parity error event mask."]
    #[inline(always)]
    pub fn per(&mut self) -> PerW<'_, Spi1CpuIntImaskSpec> {
        PerW::new(self, 1)
    }
    #[doc = "Bit 2 - Enable SPI Receive Time-Out event mask."]
    #[inline(always)]
    pub fn rtout(&mut self) -> RtoutW<'_, Spi1CpuIntImaskSpec> {
        RtoutW::new(self, 2)
    }
    #[doc = "Bit 3 - Receive FIFO event.This interrupt is set if the selected Receive FIFO level has been reached"]
    #[inline(always)]
    pub fn rx(&mut self) -> RxW<'_, Spi1CpuIntImaskSpec> {
        RxW::new(self, 3)
    }
    #[doc = "Bit 4 - Transmit FIFO event mask."]
    #[inline(always)]
    pub fn tx(&mut self) -> TxW<'_, Spi1CpuIntImaskSpec> {
        TxW::new(self, 4)
    }
    #[doc = "Bit 5 - Transmit FIFO Empty event mask."]
    #[inline(always)]
    pub fn txempty(&mut self) -> TxemptyW<'_, Spi1CpuIntImaskSpec> {
        TxemptyW::new(self, 5)
    }
    #[doc = "Bit 6 - SPI Idle event mask."]
    #[inline(always)]
    pub fn idle(&mut self) -> IdleW<'_, Spi1CpuIntImaskSpec> {
        IdleW::new(self, 6)
    }
    #[doc = "Bit 7 - DMA Done 1 event for RX event mask."]
    #[inline(always)]
    pub fn dma_done_rx(&mut self) -> DmaDoneRxW<'_, Spi1CpuIntImaskSpec> {
        DmaDoneRxW::new(self, 7)
    }
    #[doc = "Bit 8 - DMA Done 1 event for TX event mask."]
    #[inline(always)]
    pub fn dma_done_tx(&mut self) -> DmaDoneTxW<'_, Spi1CpuIntImaskSpec> {
        DmaDoneTxW::new(self, 8)
    }
    #[doc = "Bit 9 - TX FIFO underflow interrupt mask"]
    #[inline(always)]
    pub fn txfifo_unf(&mut self) -> TxfifoUnfW<'_, Spi1CpuIntImaskSpec> {
        TxfifoUnfW::new(self, 9)
    }
    #[doc = "Bit 10 - RX FIFO Full Interrupt Mask"]
    #[inline(always)]
    pub fn rxfull(&mut self) -> RxfullW<'_, Spi1CpuIntImaskSpec> {
        RxfullW::new(self, 10)
    }
}
#[doc = "Interrupt mask\n\nYou can [`read`](crate::Reg::read) this register and get [`spi1_cpu_int_imask::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi1_cpu_int_imask::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi1CpuIntImaskSpec;
impl crate::RegisterSpec for Spi1CpuIntImaskSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi1_cpu_int_imask::R`](R) reader structure"]
impl crate::Readable for Spi1CpuIntImaskSpec {}
#[doc = "`write(|w| ..)` method takes [`spi1_cpu_int_imask::W`](W) writer structure"]
impl crate::Writable for Spi1CpuIntImaskSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPI1_CPU_INT_IMASK to value 0"]
impl crate::Resettable for Spi1CpuIntImaskSpec {}
