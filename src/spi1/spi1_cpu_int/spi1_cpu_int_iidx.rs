#[doc = "Register `SPI1_CPU_INT_IIDX` reader"]
pub type R = crate::R<Spi1CpuIntIidxSpec>;
...
#[doc = "Interrupt Index Register\n\nYou can [`read`](crate::Reg::read) this register and get [`spi1_cpu_int_iidx::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi1CpuIntIidxSpec;
impl crate::RegisterSpec for Spi1CpuIntIidxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi1_cpu_int_iidx::R`](R) reader structure"]
impl crate::Readable for Spi1CpuIntIidxSpec {}
#[doc = "`reset()` method sets SPI1_CPU_INT_IIDX to value 0"]
impl crate::Resettable for Spi1CpuIntIidxSpec {}
