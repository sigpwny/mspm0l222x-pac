#[doc = "Register `SPI1_IFLS` reader"]
pub type R = crate::R<Spi1IflsSpec>;
#[doc = "Register `SPI1_IFLS` writer"]
pub type W = crate::W<Spi1IflsSpec>;
...
impl W {
    #[doc = "Bits 0:2 - SPI Transmit Interrupt FIFO Level Select The trigger points for the transmit interrupt are as follows:"]
    #[inline(always)]
    pub fn txiflsel(&mut self) -> TxiflselW<'_, Spi1IflsSpec> {
        TxiflselW::new(self, 0)
    }
    #[doc = "Bits 3:5 - SPI Receive Interrupt FIFO Level Select The trigger points for the receive interrupt are as follows:"]
    #[inline(always)]
    pub fn rxiflsel(&mut self) -> RxiflselW<'_, Spi1IflsSpec> {
        RxiflselW::new(self, 3)
    }
}
#[doc = "Interrupt FIFO Level Select Register\n\nYou can [`read`](crate::Reg::read) this register and get [`spi1_ifls::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi1_ifls::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi1IflsSpec;
impl crate::RegisterSpec for Spi1IflsSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi1_ifls::R`](R) reader structure"]
impl crate::Readable for Spi1IflsSpec {}
#[doc = "`write(|w| ..)` method takes [`spi1_ifls::W`](W) writer structure"]
impl crate::Writable for Spi1IflsSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPI1_IFLS to value 0x12"]
impl crate::Resettable for Spi1IflsSpec {
