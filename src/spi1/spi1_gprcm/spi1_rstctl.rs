#[doc = "Register `SPI1_RSTCTL` writer"]
pub type W = crate::W<Spi1RstctlSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn resetassert(&mut self) -> ResetassertW<'_, Spi1RstctlSpec> {
        ResetassertW::new(self, 0)
    }
    #[doc = "Bit 1 - Clear the RESETSTKY bit in the STAT register"]
    #[inline(always)]
    pub fn resetstkyclr(&mut self) -> ResetstkyclrW<'_, Spi1RstctlSpec> {
        ResetstkyclrW::new(self, 1)
    }
}
#[doc = "Reset Control\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi1_rstctl::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi1RstctlSpec;
impl crate::RegisterSpec for Spi1RstctlSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`spi1_rstctl::W`](W) writer structure"]
impl crate::Writable for Spi1RstctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPI1_RSTCTL to value 0"]
impl crate::Resettable for Spi1RstctlSpec {}
