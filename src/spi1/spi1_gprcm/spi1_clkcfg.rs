#[doc = "Register `SPI1_CLKCFG` reader"]
pub type R = crate::R<Spi1ClkcfgSpec>;
#[doc = "Register `SPI1_CLKCFG` writer"]
pub type W = crate::W<Spi1ClkcfgSpec>;
...
impl W {
    #[doc = "Bit 8 - Async Clock Request is blocked from starting SYSOSC or forcing bus clock to 32MHz"]
    #[inline(always)]
    pub fn blockasync(&mut self) -> BlockasyncW<'_, Spi1ClkcfgSpec> {
        BlockasyncW::new(self, 8)
    }
}
#[doc = "Peripheral Clock Configuration Register\n\nYou can [`read`](crate::Reg::read) this register and get [`spi1_clkcfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi1_clkcfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi1ClkcfgSpec;
impl crate::RegisterSpec for Spi1ClkcfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi1_clkcfg::R`](R) reader structure"]
impl crate::Readable for Spi1ClkcfgSpec {}
#[doc = "`write(|w| ..)` method takes [`spi1_clkcfg::W`](W) writer structure"]
impl crate::Writable for Spi1ClkcfgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPI1_CLKCFG to value 0"]
impl crate::Resettable for Spi1ClkcfgSpec {}
