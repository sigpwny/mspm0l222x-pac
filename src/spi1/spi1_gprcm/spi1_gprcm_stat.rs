#[doc = "Register `SPI1_GPRCM_STAT` reader"]
pub type R = crate::R<Spi1GprcmStatSpec>;
...
#[doc = "Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`spi1_gprcm_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi1GprcmStatSpec;
impl crate::RegisterSpec for Spi1GprcmStatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi1_gprcm_stat::R`](R) reader structure"]
impl crate::Readable for Spi1GprcmStatSpec {}
#[doc = "`reset()` method sets SPI1_GPRCM_STAT to value 0"]
impl crate::Resettable for Spi1GprcmStatSpec {}
