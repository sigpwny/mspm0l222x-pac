#[doc = "Register `SPI1_CLKSEL` reader"]
pub type R = crate::R<Spi1ClkselSpec>;
#[doc = "Register `SPI1_CLKSEL` writer"]
pub type W = crate::W<Spi1ClkselSpec>;
...
impl W {
    #[doc = "Bit 1 - Selects LFCLK as clock source if enabled"]
    #[inline(always)]
    pub fn lfclk_sel(&mut self) -> LfclkSelW<'_, Spi1ClkselSpec> {
        LfclkSelW::new(self, 1)
    }
    #[doc = "Bit 2 - Selects MFCLK as clock source if enabled"]
    #[inline(always)]
    pub fn mfclk_sel(&mut self) -> MfclkSelW<'_, Spi1ClkselSpec> {
        MfclkSelW::new(self, 2)
    }
    #[doc = "Bit 3 - Selects SYSCLK as clock source if enabled"]
    #[inline(always)]
    pub fn sysclk_sel(&mut self) -> SysclkSelW<'_, Spi1ClkselSpec> {
        SysclkSelW::new(self, 3)
    }
}
#[doc = "Clock Select for Ultra Low Power peripherals\n\nYou can [`read`](crate::Reg::read) this register and get [`spi1_clksel::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi1_clksel::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi1ClkselSpec;
impl crate::RegisterSpec for Spi1ClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi1_clksel::R`](R) reader structure"]
impl crate::Readable for Spi1ClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`spi1_clksel::W`](W) writer structure"]
impl crate::Writable for Spi1ClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPI1_CLKSEL to value 0"]
impl crate::Resettable for Spi1ClkselSpec {}
