#[doc = "Register `SPI1_DMA_TRIG_RX_IIDX` reader"]
pub type R = crate::R<Spi1DmaTrigRxIidxSpec>;
...
#[doc = "Interrupt Index Register\n\nYou can [`read`](crate::Reg::read) this register and get [`spi1_dma_trig_rx_iidx::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi1DmaTrigRxIidxSpec;
impl crate::RegisterSpec for Spi1DmaTrigRxIidxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi1_dma_trig_rx_iidx::R`](R) reader structure"]
impl crate::Readable for Spi1DmaTrigRxIidxSpec {}
#[doc = "`reset()` method sets SPI1_DMA_TRIG_RX_IIDX to value 0"]
impl crate::Resettable for Spi1DmaTrigRxIidxSpec {}
