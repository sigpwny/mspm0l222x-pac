#[doc = "Register `SPI1_DMA_TRIG_TX_RIS` reader"]
pub type R = crate::R<Spi1DmaTrigTxRisSpec>;
...
#[doc = "Raw interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`spi1_dma_trig_tx_ris::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi1DmaTrigTxRisSpec;
impl crate::RegisterSpec for Spi1DmaTrigTxRisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi1_dma_trig_tx_ris::R`](R) reader structure"]
impl crate::Readable for Spi1DmaTrigTxRisSpec {}
#[doc = "`reset()` method sets SPI1_DMA_TRIG_TX_RIS to value 0"]
impl crate::Resettable for Spi1DmaTrigTxRisSpec {}
