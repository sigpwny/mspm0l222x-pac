#[doc = "Register `SPI1_PDBGCTL` reader"]
pub type R = crate::R<Spi1PdbgctlSpec>;
#[doc = "Register `SPI1_PDBGCTL` writer"]
pub type W = crate::W<Spi1PdbgctlSpec>;
...
impl W {
    #[doc = "Bit 0 - Free run control"]
    #[inline(always)]
    pub fn free(&mut self) -> FreeW<'_, Spi1PdbgctlSpec> {
        FreeW::new(self, 0)
    }
    #[doc = "Bit 1 - Soft halt boundary control. This function is only available, if \\[FREE\\] is set to 'STOP'"]
    #[inline(always)]
    pub fn soft(&mut self) -> SoftW<'_, Spi1PdbgctlSpec> {
        SoftW::new(self, 1)
    }
}
#[doc = "Peripheral Debug Control\n\nYou can [`read`](crate::Reg::read) this register and get [`spi1_pdbgctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi1_pdbgctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi1PdbgctlSpec;
impl crate::RegisterSpec for Spi1PdbgctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi1_pdbgctl::R`](R) reader structure"]
impl crate::Readable for Spi1PdbgctlSpec {}
#[doc = "`write(|w| ..)` method takes [`spi1_pdbgctl::W`](W) writer structure"]
impl crate::Writable for Spi1PdbgctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPI1_PDBGCTL to value 0"]
impl crate::Resettable for Spi1PdbgctlSpec {}
