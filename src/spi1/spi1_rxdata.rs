#[doc = "Register `SPI1_RXDATA` reader"]
pub type R = crate::R<Spi1RxdataSpec>;
...
#[doc = "RXDATA Register\n\nYou can [`read`](crate::Reg::read) this register and get [`spi1_rxdata::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi1RxdataSpec;
impl crate::RegisterSpec for Spi1RxdataSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi1_rxdata::R`](R) reader structure"]
impl crate::Readable for Spi1RxdataSpec {}
#[doc = "`reset()` method sets SPI1_RXDATA to value 0"]
impl crate::Resettable for Spi1RxdataSpec {}
