#[doc = "Register `SPI1_TXDATA` reader"]
pub type R = crate::R<Spi1TxdataSpec>;
#[doc = "Register `SPI1_TXDATA` writer"]
pub type W = crate::W<Spi1TxdataSpec>;
...
impl W {
    #[doc = "Bits 0:15 - Transmit Data When read, last written value will be returned. If the last write to this field was a 32-bit write (with PACKEN=1), 32-bits will be returned and if the last write was a 16-bit write (PACKEN=0), those 16-bits will be returned. When written, one or two FIFO entries will be written depending on PACKEN value. Data values are removed from the transmit FIFO one value at a time by the transmit logic. It is loaded into the transmit serial shifter, then serially shifted out onto the TXD output pin at the programmed bit rate. When a data size of less than 16 bits is selected, the user must right-justify data written to the transmit FIFO. The transmit logic ignores the unused bits."]
    #[inline(always)]
    pub fn data(&mut self) -> DataW<'_, Spi1TxdataSpec> {
        DataW::new(self, 0)
    }
}
#[doc = "TXDATA Register\n\nYou can [`read`](crate::Reg::read) this register and get [`spi1_txdata::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi1_txdata::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi1TxdataSpec;
impl crate::RegisterSpec for Spi1TxdataSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi1_txdata::R`](R) reader structure"]
impl crate::Readable for Spi1TxdataSpec {}
#[doc = "`write(|w| ..)` method takes [`spi1_txdata::W`](W) writer structure"]
impl crate::Writable for Spi1TxdataSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPI1_TXDATA to value 0"]
impl crate::Resettable for Spi1TxdataSpec {}
