#[doc = "Register `UART3_STAT` reader"]
pub type R = crate::R<Uart3StatSpec>;
...
#[doc = "UART Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uart3_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart3StatSpec;
impl crate::RegisterSpec for Uart3StatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart3_stat::R`](R) reader structure"]
impl crate::Readable for Uart3StatSpec {}
#[doc = "`reset()` method sets UART3_STAT to value 0"]
impl crate::Resettable for Uart3StatSpec {}
