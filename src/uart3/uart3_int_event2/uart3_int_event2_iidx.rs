#[doc = "Register `UART3_INT_EVENT2_IIDX` reader"]
pub type R = crate::R<Uart3IntEvent2IidxSpec>;
...
#[doc = "Interrupt index\n\nYou can [`read`](crate::Reg::read) this register and get [`uart3_int_event2_iidx::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart3IntEvent2IidxSpec;
impl crate::RegisterSpec for Uart3IntEvent2IidxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart3_int_event2_iidx::R`](R) reader structure"]
impl crate::Readable for Uart3IntEvent2IidxSpec {}
#[doc = "`reset()` method sets UART3_INT_EVENT2_IIDX to value 0"]
impl crate::Resettable for Uart3IntEvent2IidxSpec {}
