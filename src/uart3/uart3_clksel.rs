#[doc = "Register `UART3_CLKSEL` reader"]
pub type R = crate::R<Uart3ClkselSpec>;
#[doc = "Register `UART3_CLKSEL` writer"]
pub type W = crate::W<Uart3ClkselSpec>;
...
impl W {
    #[doc = "Bit 1 - Selects LFCLK as clock source if enabled"]
    #[inline(always)]
    pub fn lfclk_sel(&mut self) -> LfclkSelW<'_, Uart3ClkselSpec> {
        LfclkSelW::new(self, 1)
    }
    #[doc = "Bit 2 - Selects MFCLK as clock source if enabled"]
    #[inline(always)]
    pub fn mfclk_sel(&mut self) -> MfclkSelW<'_, Uart3ClkselSpec> {
        MfclkSelW::new(self, 2)
    }
    #[doc = "Bit 3 - Selects BUS CLK as clock source if enabled"]
    #[inline(always)]
    pub fn busclk_sel(&mut self) -> BusclkSelW<'_, Uart3ClkselSpec> {
        BusclkSelW::new(self, 3)
    }
}
#[doc = "Clock Select for Ultra Low Power peripherals\n\nYou can [`read`](crate::Reg::read) this register and get [`uart3_clksel::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uart3_clksel::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart3ClkselSpec;
impl crate::RegisterSpec for Uart3ClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart3_clksel::R`](R) reader structure"]
impl crate::Readable for Uart3ClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`uart3_clksel::W`](W) writer structure"]
impl crate::Writable for Uart3ClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UART3_CLKSEL to value 0"]
impl crate::Resettable for Uart3ClkselSpec {}
