#[doc = "Register `UART3_GFCTL` reader"]
pub type R = crate::R<Uart3GfctlSpec>;
#[doc = "Register `UART3_GFCTL` writer"]
pub type W = crate::W<Uart3GfctlSpec>;
...
impl W {
    #[doc = "Bit 8 - Analog Glitch Suppression Enable"]
    #[inline(always)]
    pub fn agfen(&mut self) -> AgfenW<'_, Uart3GfctlSpec> {
        AgfenW::new(self, 8)
    }
    #[doc = "Bits 9:10 - Analog Glitch Suppression Pulse Width This field controls the pulse width select for the analog glitch suppression on the RX line. See device datasheet for exact values."]
    #[inline(always)]
    pub fn agfsel(&mut self) -> AgfselW<'_, Uart3GfctlSpec> {
        AgfselW::new(self, 9)
    }
}
#[doc = "Glitch Filter Control\n\nYou can [`read`](crate::Reg::read) this register and get [`uart3_gfctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uart3_gfctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart3GfctlSpec;
impl crate::RegisterSpec for Uart3GfctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart3_gfctl::R`](R) reader structure"]
impl crate::Readable for Uart3GfctlSpec {}
#[doc = "`write(|w| ..)` method takes [`uart3_gfctl::W`](W) writer structure"]
impl crate::Writable for Uart3GfctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UART3_GFCTL to value 0"]
impl crate::Resettable for Uart3GfctlSpec {}
