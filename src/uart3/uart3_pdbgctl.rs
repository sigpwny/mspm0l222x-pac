#[doc = "Register `UART3_PDBGCTL` reader"]
pub type R = crate::R<Uart3PdbgctlSpec>;
#[doc = "Register `UART3_PDBGCTL` writer"]
pub type W = crate::W<Uart3PdbgctlSpec>;
...
impl W {
    #[doc = "Bit 0 - Free run control"]
    #[inline(always)]
    pub fn free(&mut self) -> FreeW<'_, Uart3PdbgctlSpec> {
        FreeW::new(self, 0)
    }
    #[doc = "Bit 1 - Soft halt boundary control. This function is only available, if \\[FREE\\] is set to 'STOP'"]
    #[inline(always)]
    pub fn soft(&mut self) -> SoftW<'_, Uart3PdbgctlSpec> {
        SoftW::new(self, 1)
    }
}
#[doc = "Peripheral Debug Control\n\nYou can [`read`](crate::Reg::read) this register and get [`uart3_pdbgctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uart3_pdbgctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart3PdbgctlSpec;
impl crate::RegisterSpec for Uart3PdbgctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart3_pdbgctl::R`](R) reader structure"]
impl crate::Readable for Uart3PdbgctlSpec {}
#[doc = "`write(|w| ..)` method takes [`uart3_pdbgctl::W`](W) writer structure"]
impl crate::Writable for Uart3PdbgctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UART3_PDBGCTL to value 0"]
impl crate::Resettable for Uart3PdbgctlSpec {}
