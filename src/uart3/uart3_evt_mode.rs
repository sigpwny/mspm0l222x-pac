#[doc = "Register `UART3_EVT_MODE` reader"]
pub type R = crate::R<Uart3EvtModeSpec>;
#[doc = "Register `UART3_EVT_MODE` writer"]
pub type W = crate::W<Uart3EvtModeSpec>;
...
impl W {}
#[doc = "Event Mode\n\nYou can [`read`](crate::Reg::read) this register and get [`uart3_evt_mode::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uart3_evt_mode::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart3EvtModeSpec;
impl crate::RegisterSpec for Uart3EvtModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart3_evt_mode::R`](R) reader structure"]
impl crate::Readable for Uart3EvtModeSpec {}
#[doc = "`write(|w| ..)` method takes [`uart3_evt_mode::W`](W) writer structure"]
impl crate::Writable for Uart3EvtModeSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UART3_EVT_MODE to value 0"]
impl crate::Resettable for Uart3EvtModeSpec {}
