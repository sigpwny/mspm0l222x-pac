#[doc = "Register `UART3_INT_EVENT0_IMASK` reader"]
pub type R = crate::R<Uart3IntEvent0ImaskSpec>;
#[doc = "Register `UART3_INT_EVENT0_IMASK` writer"]
pub type W = crate::W<Uart3IntEvent0ImaskSpec>;
...
impl W {
    #[doc = "Bit 0 - Enable UARTOUT Receive Time-Out Interrupt."]
    #[inline(always)]
    pub fn rtout(&mut self) -> RtoutW<'_, Uart3IntEvent0ImaskSpec> {
        RtoutW::new(self, 0)
    }
    #[doc = "Bit 1 - Enable UART Framing Error Interrupt."]
    #[inline(always)]
    pub fn frmerr(&mut self) -> FrmerrW<'_, Uart3IntEvent0ImaskSpec> {
        FrmerrW::new(self, 1)
    }
    #[doc = "Bit 2 - Enable UART Parity Error Interrupt."]
    #[inline(always)]
    pub fn parerr(&mut self) -> ParerrW<'_, Uart3IntEvent0ImaskSpec> {
        ParerrW::new(self, 2)
    }
    #[doc = "Bit 3 - Enable UART Break Error Interrupt."]
    #[inline(always)]
    pub fn brkerr(&mut self) -> BrkerrW<'_, Uart3IntEvent0ImaskSpec> {
        BrkerrW::new(self, 3)
    }
    #[doc = "Bit 4 - Enable UART Receive Overrun Error Interrupt."]
    #[inline(always)]
    pub fn ovrerr(&mut self) -> OvrerrW<'_, Uart3IntEvent0ImaskSpec> {
        OvrerrW::new(self, 4)
    }
    #[doc = "Bit 5 - Enable Negative Edge on UARTxRXD Interrupt."]
    #[inline(always)]
    pub fn rxne(&mut self) -> RxneW<'_, Uart3IntEvent0ImaskSpec> {
        RxneW::new(self, 5)
    }
    #[doc = "Bit 6 - Enable Positive Edge on UARTxRXD Interrupt."]
    #[inline(always)]
    pub fn rxpe(&mut self) -> RxpeW<'_, Uart3IntEvent0ImaskSpec> {
        RxpeW::new(self, 6)
    }
    #[doc = "Bit 10 - Enable UART Receive Interrupt."]
    #[inline(always)]
    pub fn rxint(&mut self) -> RxintW<'_, Uart3IntEvent0ImaskSpec> {
        RxintW::new(self, 10)
    }
    #[doc = "Bit 11 - Enable UART Transmit Interrupt."]
    #[inline(always)]
    pub fn txint(&mut self) -> TxintW<'_, Uart3IntEvent0ImaskSpec> {
        TxintW::new(self, 11)
    }
    #[doc = "Bit 12 - Enable UART End of Transmission Interrupt Indicates that the last bit of all transmitted data and flags has left the serializer and without any further Data in the TX Fifo or Buffer."]
    #[inline(always)]
    pub fn eot(&mut self) -> EotW<'_, Uart3IntEvent0ImaskSpec> {
        EotW::new(self, 12)
    }
    #[doc = "Bit 13 - Enable Address Match Interrupt."]
    #[inline(always)]
    pub fn addr_match(&mut self) -> AddrMatchW<'_, Uart3IntEvent0ImaskSpec> {
        AddrMatchW::new(self, 13)
    }
    #[doc = "Bit 14 - Enable UART Clear to Send Modem Interrupt."]
    #[inline(always)]
    pub fn cts(&mut self) -> CtsW<'_, Uart3IntEvent0ImaskSpec> {
        CtsW::new(self, 14)
    }
    #[doc = "Bit 15 - Enable DMA Done on RX Event Channel Interrupt"]
    #[inline(always)]
    pub fn dma_done_rx(&mut self) -> DmaDoneRxW<'_, Uart3IntEvent0ImaskSpec> {
        DmaDoneRxW::new(self, 15)
    }
    #[doc = "Bit 16 - Enable DMA Done on TX Event Channel Interrupt"]
    #[inline(always)]
    pub fn dma_done_tx(&mut self) -> DmaDoneTxW<'_, Uart3IntEvent0ImaskSpec> {
        DmaDoneTxW::new(self, 16)
    }
    #[doc = "Bit 17 - Noise Error on triple voting. Asserted when the 3 samples of majority voting are not equal"]
    #[inline(always)]
    pub fn nerr(&mut self) -> NerrW<'_, Uart3IntEvent0ImaskSpec> {
        NerrW::new(self, 17)
    }
}
#[doc = "Interrupt mask\n\nYou can [`read`](crate::Reg::read) this register and get [`uart3_int_event0_imask::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uart3_int_event0_imask::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart3IntEvent0ImaskSpec;
impl crate::RegisterSpec for Uart3IntEvent0ImaskSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart3_int_event0_imask::R`](R) reader structure"]
impl crate::Readable for Uart3IntEvent0ImaskSpec {}
#[doc = "`write(|w| ..)` method takes [`uart3_int_event0_imask::W`](W) writer structure"]
impl crate::Writable for Uart3IntEvent0ImaskSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UART3_INT_EVENT0_IMASK to value 0"]
impl crate::Resettable for Uart3IntEvent0ImaskSpec {}
