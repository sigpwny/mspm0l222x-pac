#[doc = "Register `UART3_INT_EVENT0_ISET` writer"]
pub type W = crate::W<Uart3IntEvent0IsetSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn rtout(&mut self) -> RtoutW<'_, Uart3IntEvent0IsetSpec> {
        RtoutW::new(self, 0)
    }
    #[doc = "Bit 1 - Set UART Framing Error Interrupt."]
    #[inline(always)]
    pub fn frmerr(&mut self) -> FrmerrW<'_, Uart3IntEvent0IsetSpec> {
        FrmerrW::new(self, 1)
    }
    #[doc = "Bit 2 - Set UART Parity Error Interrupt."]
    #[inline(always)]
    pub fn parerr(&mut self) -> ParerrW<'_, Uart3IntEvent0IsetSpec> {
        ParerrW::new(self, 2)
    }
    #[doc = "Bit 3 - Set UART Break Error Interrupt."]
    #[inline(always)]
    pub fn brkerr(&mut self) -> BrkerrW<'_, Uart3IntEvent0IsetSpec> {
        BrkerrW::new(self, 3)
    }
    #[doc = "Bit 4 - Set UART Receive Overrun Error Interrupt."]
    #[inline(always)]
    pub fn ovrerr(&mut self) -> OvrerrW<'_, Uart3IntEvent0IsetSpec> {
        OvrerrW::new(self, 4)
    }
    #[doc = "Bit 5 - Set Negative Edge on UARTxRXD Interrupt."]
    #[inline(always)]
    pub fn rxne(&mut self) -> RxneW<'_, Uart3IntEvent0IsetSpec> {
        RxneW::new(self, 5)
    }
    #[doc = "Bit 6 - Set Positive Edge on UARTxRXD Interrupt."]
    #[inline(always)]
    pub fn rxpe(&mut self) -> RxpeW<'_, Uart3IntEvent0IsetSpec> {
        RxpeW::new(self, 6)
    }
    #[doc = "Bit 10 - Set UART Receive Interrupt."]
    #[inline(always)]
    pub fn rxint(&mut self) -> RxintW<'_, Uart3IntEvent0IsetSpec> {
        RxintW::new(self, 10)
    }
    #[doc = "Bit 11 - Set UART Transmit Interrupt."]
    #[inline(always)]
    pub fn txint(&mut self) -> TxintW<'_, Uart3IntEvent0IsetSpec> {
        TxintW::new(self, 11)
    }
    ...
    #[inline(always)]
    pub fn eot(&mut self) -> EotW<'_, Uart3IntEvent0IsetSpec> {
        EotW::new(self, 12)
    }
    #[doc = "Bit 13 - Set Address Match Interrupt."]
    #[inline(always)]
    pub fn addr_match(&mut self) -> AddrMatchW<'_, Uart3IntEvent0IsetSpec> {
        AddrMatchW::new(self, 13)
    }
    #[doc = "Bit 14 - Set UART Clear to Send Modem Interrupt."]
    #[inline(always)]
    pub fn cts(&mut self) -> CtsW<'_, Uart3IntEvent0IsetSpec> {
        CtsW::new(self, 14)
    }
    #[doc = "Bit 15 - Set DMA Done on RX Event Channel Interrupt"]
    #[inline(always)]
    pub fn dma_done_rx(&mut self) -> DmaDoneRxW<'_, Uart3IntEvent0IsetSpec> {
        DmaDoneRxW::new(self, 15)
    }
    #[doc = "Bit 16 - Set DMA Done on TX Event Channel Interrupt"]
    #[inline(always)]
    pub fn dma_done_tx(&mut self) -> DmaDoneTxW<'_, Uart3IntEvent0IsetSpec> {
    ...
    #[inline(always)]
    pub fn nerr(&mut self) -> NerrW<'_, Uart3IntEvent0IsetSpec> {
        NerrW::new(self, 17)
    }
}
#[doc = "Interrupt set\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uart3_int_event0_iset::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart3IntEvent0IsetSpec;
impl crate::RegisterSpec for Uart3IntEvent0IsetSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`uart3_int_event0_iset::W`](W) writer structure"]
impl crate::Writable for Uart3IntEvent0IsetSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UART3_INT_EVENT0_ISET to value 0"]
impl crate::Resettable for Uart3IntEvent0IsetSpec {}
