#[doc = "Register `UART3_GPRCM_STAT` reader"]
pub type R = crate::R<Uart3GprcmStatSpec>;
...
#[doc = "Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uart3_gprcm_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart3GprcmStatSpec;
impl crate::RegisterSpec for Uart3GprcmStatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart3_gprcm_stat::R`](R) reader structure"]
impl crate::Readable for Uart3GprcmStatSpec {}
#[doc = "`reset()` method sets UART3_GPRCM_STAT to value 0"]
impl crate::Resettable for Uart3GprcmStatSpec {}
