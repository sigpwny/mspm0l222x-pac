#[doc = "Register `I2C0_CLKDIV` reader"]
pub type R = crate::R<I2c0ClkdivSpec>;
#[doc = "Register `I2C0_CLKDIV` writer"]
pub type W = crate::W<I2c0ClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Selects divide ratio of module clock"]
    #[inline(always)]
    pub fn ratio(&mut self) -> RatioW<'_, I2c0ClkdivSpec> {
        RatioW::new(self, 0)
    }
}
#[doc = "Clock Divider\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c0_clkdiv::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i2c0_clkdiv::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c0ClkdivSpec;
impl crate::RegisterSpec for I2c0ClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c0_clkdiv::R`](R) reader structure"]
impl crate::Readable for I2c0ClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`i2c0_clkdiv::W`](W) writer structure"]
impl crate::Writable for I2c0ClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I2C0_CLKDIV to value 0"]
impl crate::Resettable for I2c0ClkdivSpec {}
