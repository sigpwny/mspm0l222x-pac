#[doc = "Register `I2C0_TOAR2` reader"]
pub type R = crate::R<I2c0Toar2Spec>;
#[doc = "Register `I2C0_TOAR2` writer"]
pub type W = crate::W<I2c0Toar2Spec>;
...
impl W {
    #[doc = "Bits 0:6 - I2C Target Own Address 2 This field specifies the alternate OAR2 address."]
    #[inline(always)]
    pub fn oar2(&mut self) -> Oar2W<'_, I2c0Toar2Spec> {
        Oar2W::new(self, 0)
    }
    #[doc = "Bit 7 - I2C Target Own Address 2 Enable"]
    #[inline(always)]
    pub fn oar2en(&mut self) -> Oar2enW<'_, I2c0Toar2Spec> {
        Oar2enW::new(self, 7)
    }
    #[doc = "Bits 16:22 - I2C Target Own Address 2 Mask: This field specifies bits A6 through A0 of the Target address. The bits with value 1 in SOAR2.OAR2_MASK field will make the corresponding incoming address bits to match by default regardless of the value inside SOAR2.OAR2 i.e. corresponding SOAR2.OAR2 bit is a dont care."]
    #[inline(always)]
    pub fn oar2_mask(&mut self) -> Oar2MaskW<'_, I2c0Toar2Spec> {
        Oar2MaskW::new(self, 16)
    }
}
#[doc = "I2C Target Own Address 2\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c0_toar2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i2c0_toar2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c0Toar2Spec;
impl crate::RegisterSpec for I2c0Toar2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c0_toar2::R`](R) reader structure"]
impl crate::Readable for I2c0Toar2Spec {}
#[doc = "`write(|w| ..)` method takes [`i2c0_toar2::W`](W) writer structure"]
impl crate::Writable for I2c0Toar2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I2C0_TOAR2 to value 0"]
impl crate::Resettable for I2c0Toar2Spec {}
