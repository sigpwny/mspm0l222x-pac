#[doc = "Register `I2C0_TARGET_PECSR` reader"]
pub type R = crate::R<I2c0TargetPecsrSpec>;
...
#[doc = "I2C Target PEC status register\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c0_target_pecsr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c0TargetPecsrSpec;
impl crate::RegisterSpec for I2c0TargetPecsrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c0_target_pecsr::R`](R) reader structure"]
impl crate::Readable for I2c0TargetPecsrSpec {}
#[doc = "`reset()` method sets I2C0_TARGET_PECSR to value 0"]
impl crate::Resettable for I2c0TargetPecsrSpec {}
