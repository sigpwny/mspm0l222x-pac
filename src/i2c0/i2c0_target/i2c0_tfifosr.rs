#[doc = "Register `I2C0_TFIFOSR` reader"]
pub type R = crate::R<I2c0TfifosrSpec>;
...
#[doc = "I2C Target FIFO Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c0_tfifosr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c0TfifosrSpec;
impl crate::RegisterSpec for I2c0TfifosrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c0_tfifosr::R`](R) reader structure"]
impl crate::Readable for I2c0TfifosrSpec {}
#[doc = "`reset()` method sets I2C0_TFIFOSR to value 0x0800"]
impl crate::Resettable for I2c0TfifosrSpec {
