#[doc = "Register `I2C0_DMA_TRIG1_MIS` reader"]
pub type R = crate::R<I2c0DmaTrig1MisSpec>;
...
#[doc = "Masked interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c0_dma_trig1_mis::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c0DmaTrig1MisSpec;
impl crate::RegisterSpec for I2c0DmaTrig1MisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c0_dma_trig1_mis::R`](R) reader structure"]
impl crate::Readable for I2c0DmaTrig1MisSpec {}
#[doc = "`reset()` method sets I2C0_DMA_TRIG1_MIS to value 0"]
impl crate::Resettable for I2c0DmaTrig1MisSpec {}
