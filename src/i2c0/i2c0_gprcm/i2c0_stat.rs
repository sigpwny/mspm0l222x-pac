#[doc = "Register `I2C0_STAT` reader"]
pub type R = crate::R<I2c0StatSpec>;
...
#[doc = "Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c0_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c0StatSpec;
impl crate::RegisterSpec for I2c0StatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c0_stat::R`](R) reader structure"]
impl crate::Readable for I2c0StatSpec {}
#[doc = "`reset()` method sets I2C0_STAT to value 0"]
impl crate::Resettable for I2c0StatSpec {}
