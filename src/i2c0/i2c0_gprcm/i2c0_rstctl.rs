#[doc = "Register `I2C0_RSTCTL` writer"]
pub type W = crate::W<I2c0RstctlSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn resetassert(&mut self) -> ResetassertW<'_, I2c0RstctlSpec> {
...
pub struct I2c0RstctlSpec;
impl crate::RegisterSpec for I2c0RstctlSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`i2c0_rstctl::W`](W) writer structure"]
impl crate::Writable for I2c0RstctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I2C0_RSTCTL to value 0"]
impl crate::Resettable for I2c0RstctlSpec {}
