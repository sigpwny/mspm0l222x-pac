#[doc = "Register `I2C0_DESC` reader"]
pub type R = crate::R<I2c0DescSpec>;
...
#[doc = "Module Description\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c0_desc::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c0DescSpec;
impl crate::RegisterSpec for I2c0DescSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c0_desc::R`](R) reader structure"]
impl crate::Readable for I2c0DescSpec {}
#[doc = "`reset()` method sets I2C0_DESC to value 0"]
impl crate::Resettable for I2c0DescSpec {}
