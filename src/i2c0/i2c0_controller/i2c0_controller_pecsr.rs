#[doc = "Register `I2C0_CONTROLLER_PECSR` reader"]
pub type R = crate::R<I2c0ControllerPecsrSpec>;
...
#[doc = "I2C Controller PEC status register\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c0_controller_pecsr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c0ControllerPecsrSpec;
impl crate::RegisterSpec for I2c0ControllerPecsrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c0_controller_pecsr::R`](R) reader structure"]
impl crate::Readable for I2c0ControllerPecsrSpec {}
#[doc = "`reset()` method sets I2C0_CONTROLLER_PECSR to value 0"]
impl crate::Resettable for I2c0ControllerPecsrSpec {}
