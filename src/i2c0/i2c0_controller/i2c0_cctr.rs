#[doc = "Register `I2C0_CCTR` reader"]
pub type R = crate::R<I2c0CctrSpec>;
#[doc = "Register `I2C0_CCTR` writer"]
pub type W = crate::W<I2c0CctrSpec>;
...
impl W {
    #[doc = "Bit 0 - I2C Controller Enable and start transaction"]
    #[inline(always)]
    pub fn burstrun(&mut self) -> BurstrunW<'_, I2c0CctrSpec> {
        BurstrunW::new(self, 0)
    }
    #[doc = "Bit 1 - Generate START"]
    #[inline(always)]
    pub fn start(&mut self) -> StartW<'_, I2c0CctrSpec> {
        StartW::new(self, 1)
    }
    #[doc = "Bit 2 - Generate STOP"]
    #[inline(always)]
    pub fn stop(&mut self) -> StopW<'_, I2c0CctrSpec> {
        StopW::new(self, 2)
    }
    #[doc = "Bit 3 - Data Acknowledge Enable. Software needs to configure this bit to send the ACK or NACK."]
    #[inline(always)]
    pub fn ack(&mut self) -> AckW<'_, I2c0CctrSpec> {
        AckW::new(self, 3)
    }
    #[doc = "Bit 4 - Controller ACK overrride Enable"]
    #[inline(always)]
    pub fn cackoen(&mut self) -> CackoenW<'_, I2c0CctrSpec> {
        CackoenW::new(self, 4)
    }
    #[doc = "Bit 5 - Read on TX Empty"]
    #[inline(always)]
    pub fn rd_on_txempty(&mut self) -> RdOnTxemptyW<'_, I2c0CctrSpec> {
        RdOnTxemptyW::new(self, 5)
    }
    #[doc = "Bits 16:27 - I2C transaction length This field contains the programmed length of bytes of the Transaction."]
    #[inline(always)]
    pub fn cblen(&mut self) -> CblenW<'_, I2c0CctrSpec> {
        CblenW::new(self, 16)
    }
}
#[doc = "I2C Controller Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c0_cctr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i2c0_cctr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c0CctrSpec;
impl crate::RegisterSpec for I2c0CctrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c0_cctr::R`](R) reader structure"]
impl crate::Readable for I2c0CctrSpec {}
#[doc = "`write(|w| ..)` method takes [`i2c0_cctr::W`](W) writer structure"]
impl crate::Writable for I2c0CctrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I2C0_CCTR to value 0"]
impl crate::Resettable for I2c0CctrSpec {}
