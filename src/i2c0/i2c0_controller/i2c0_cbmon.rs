#[doc = "Register `I2C0_CBMON` reader"]
pub type R = crate::R<I2c0CbmonSpec>;
#[doc = "I2C SCL Status\n\nValue on reset: 1"]
...
#[doc = "I2C Controller Bus Monitor\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c0_cbmon::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c0CbmonSpec;
impl crate::RegisterSpec for I2c0CbmonSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c0_cbmon::R`](R) reader structure"]
impl crate::Readable for I2c0CbmonSpec {}
#[doc = "`reset()` method sets I2C0_CBMON to value 0x03"]
impl crate::Resettable for I2c0CbmonSpec {
