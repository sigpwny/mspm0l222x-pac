#[doc = "Register `GPIOC_POLARITY15_0` reader"]
pub type R = crate::R<GpiocPolarity15_0Spec>;
#[doc = "Register `GPIOC_POLARITY15_0` writer"]
pub type W = crate::W<GpiocPolarity15_0Spec>;
...
impl W {
    #[doc = "Bits 0:1 - Enables and configures edge detection polarity for DIO0."]
    #[inline(always)]
    pub fn dio0(&mut self) -> Dio0W<'_, GpiocPolarity15_0Spec> {
        Dio0W::new(self, 0)
    }
    #[doc = "Bits 2:3 - Enables and configures edge detection polarity for DIO1."]
    #[inline(always)]
    pub fn dio1(&mut self) -> Dio1W<'_, GpiocPolarity15_0Spec> {
        Dio1W::new(self, 2)
    }
    #[doc = "Bits 4:5 - Enables and configures edge detection polarity for DIO2."]
    #[inline(always)]
    pub fn dio2(&mut self) -> Dio2W<'_, GpiocPolarity15_0Spec> {
        Dio2W::new(self, 4)
    }
    #[doc = "Bits 6:7 - Enables and configures edge detection polarity for DIO3."]
    #[inline(always)]
    pub fn dio3(&mut self) -> Dio3W<'_, GpiocPolarity15_0Spec> {
        Dio3W::new(self, 6)
    }
    #[doc = "Bits 8:9 - Enables and configures edge detection polarity for DIO4."]
    #[inline(always)]
    pub fn dio4(&mut self) -> Dio4W<'_, GpiocPolarity15_0Spec> {
        Dio4W::new(self, 8)
    }
    #[doc = "Bits 10:11 - Enables and configures edge detection polarity for DIO5."]
    #[inline(always)]
    pub fn dio5(&mut self) -> Dio5W<'_, GpiocPolarity15_0Spec> {
        Dio5W::new(self, 10)
    }
    #[doc = "Bits 12:13 - Enables and configures edge detection polarity for DIO6."]
    #[inline(always)]
    pub fn dio6(&mut self) -> Dio6W<'_, GpiocPolarity15_0Spec> {
        Dio6W::new(self, 12)
    }
    #[doc = "Bits 14:15 - Enables and configures edge detection polarity for DIO7."]
    #[inline(always)]
    pub fn dio7(&mut self) -> Dio7W<'_, GpiocPolarity15_0Spec> {
        Dio7W::new(self, 14)
    }
    #[doc = "Bits 16:17 - Enables and configures edge detection polarity for DIO8."]
    #[inline(always)]
    pub fn dio8(&mut self) -> Dio8W<'_, GpiocPolarity15_0Spec> {
        Dio8W::new(self, 16)
    }
    #[doc = "Bits 18:19 - Enables and configures edge detection polarity for DIO9."]
    #[inline(always)]
    pub fn dio9(&mut self) -> Dio9W<'_, GpiocPolarity15_0Spec> {
        Dio9W::new(self, 18)
    }
    #[doc = "Bits 20:21 - Enables and configures edge detection polarity for DIO10."]
    #[inline(always)]
    pub fn dio10(&mut self) -> Dio10W<'_, GpiocPolarity15_0Spec> {
        Dio10W::new(self, 20)
    }
    #[doc = "Bits 22:23 - Enables and configures edge detection polarity for DIO11."]
    #[inline(always)]
    pub fn dio11(&mut self) -> Dio11W<'_, GpiocPolarity15_0Spec> {
        Dio11W::new(self, 22)
    }
    #[doc = "Bits 24:25 - Enables and configures edge detection polarity for DIO12."]
    #[inline(always)]
    pub fn dio12(&mut self) -> Dio12W<'_, GpiocPolarity15_0Spec> {
        Dio12W::new(self, 24)
    }
    #[doc = "Bits 26:27 - Enables and configures edge detection polarity for DIO13."]
    #[inline(always)]
    pub fn dio13(&mut self) -> Dio13W<'_, GpiocPolarity15_0Spec> {
        Dio13W::new(self, 26)
    }
    #[doc = "Bits 28:29 - Enables and configures edge detection polarity for DIO14."]
    #[inline(always)]
    pub fn dio14(&mut self) -> Dio14W<'_, GpiocPolarity15_0Spec> {
        Dio14W::new(self, 28)
    }
    #[doc = "Bits 30:31 - Enables and configures edge detection polarity for DIO15."]
    #[inline(always)]
    pub fn dio15(&mut self) -> Dio15W<'_, GpiocPolarity15_0Spec> {
        Dio15W::new(self, 30)
    }
}
#[doc = "Polarity 15 to 0\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioc_polarity15_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpioc_polarity15_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiocPolarity15_0Spec;
impl crate::RegisterSpec for GpiocPolarity15_0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioc_polarity15_0::R`](R) reader structure"]
impl crate::Readable for GpiocPolarity15_0Spec {}
#[doc = "`write(|w| ..)` method takes [`gpioc_polarity15_0::W`](W) writer structure"]
impl crate::Writable for GpiocPolarity15_0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIOC_POLARITY15_0 to value 0"]
impl crate::Resettable for GpiocPolarity15_0Spec {}
