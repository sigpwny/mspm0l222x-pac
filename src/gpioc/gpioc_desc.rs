#[doc = "Register `GPIOC_DESC` reader"]
pub type R = crate::R<GpiocDescSpec>;
...
#[doc = "Module Description\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioc_desc::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiocDescSpec;
impl crate::RegisterSpec for GpiocDescSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioc_desc::R`](R) reader structure"]
impl crate::Readable for GpiocDescSpec {}
#[doc = "`reset()` method sets GPIOC_DESC to value 0"]
impl crate::Resettable for GpiocDescSpec {}
