#[doc = "Register `GPIOC_DIN11_8` reader"]
pub type R = crate::R<GpiocDin11_8Spec>;
...
#[doc = "Data input 11 to 8\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioc_din11_8::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiocDin11_8Spec;
impl crate::RegisterSpec for GpiocDin11_8Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioc_din11_8::R`](R) reader structure"]
impl crate::Readable for GpiocDin11_8Spec {}
#[doc = "`reset()` method sets GPIOC_DIN11_8 to value 0"]
impl crate::Resettable for GpiocDin11_8Spec {}
