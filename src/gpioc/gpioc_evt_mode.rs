#[doc = "Register `GPIOC_EVT_MODE` reader"]
pub type R = crate::R<GpiocEvtModeSpec>;
#[doc = "Register `GPIOC_EVT_MODE` writer"]
pub type W = crate::W<GpiocEvtModeSpec>;
...
impl W {}
#[doc = "Event Mode\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioc_evt_mode::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpioc_evt_mode::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiocEvtModeSpec;
impl crate::RegisterSpec for GpiocEvtModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioc_evt_mode::R`](R) reader structure"]
impl crate::Readable for GpiocEvtModeSpec {}
#[doc = "`write(|w| ..)` method takes [`gpioc_evt_mode::W`](W) writer structure"]
impl crate::Writable for GpiocEvtModeSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIOC_EVT_MODE to value 0"]
impl crate::Resettable for GpiocEvtModeSpec {}
