#[doc = "Register `GPIOC_SUB0CFG` reader"]
pub type R = crate::R<GpiocSub0cfgSpec>;
#[doc = "Register `GPIOC_SUB0CFG` writer"]
pub type W = crate::W<GpiocSub0cfgSpec>;
...
impl W {
    #[doc = "Bit 0 - This bit is used to enable subscriber 0 event."]
    #[inline(always)]
    pub fn enable(&mut self) -> EnableW<'_, GpiocSub0cfgSpec> {
        EnableW::new(self, 0)
    }
    #[doc = "Bits 8:9 - These bits configure the output policy for subscriber 0 event."]
    #[inline(always)]
    pub fn outpolicy(&mut self) -> OutpolicyW<'_, GpiocSub0cfgSpec> {
        OutpolicyW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Indicates the specific bit among lower 16 bits that is targeted by the subscriber action"]
    #[inline(always)]
    pub fn index(&mut self) -> IndexW<'_, GpiocSub0cfgSpec> {
        IndexW::new(self, 16)
    }
}
#[doc = "Subscriber 0 configuration\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioc_sub0cfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpioc_sub0cfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiocSub0cfgSpec;
impl crate::RegisterSpec for GpiocSub0cfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioc_sub0cfg::R`](R) reader structure"]
impl crate::Readable for GpiocSub0cfgSpec {}
#[doc = "`write(|w| ..)` method takes [`gpioc_sub0cfg::W`](W) writer structure"]
impl crate::Writable for GpiocSub0cfgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIOC_SUB0CFG to value 0"]
impl crate::Resettable for GpiocSub0cfgSpec {}
