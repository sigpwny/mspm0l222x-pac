#[doc = "Register `GPIOC_GEN_EVENT0_IIDX` reader"]
pub type R = crate::R<GpiocGenEvent0IidxSpec>;
...
#[doc = "Interrupt index\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioc_gen_event0_iidx::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiocGenEvent0IidxSpec;
impl crate::RegisterSpec for GpiocGenEvent0IidxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioc_gen_event0_iidx::R`](R) reader structure"]
impl crate::Readable for GpiocGenEvent0IidxSpec {}
#[doc = "`reset()` method sets GPIOC_GEN_EVENT0_IIDX to value 0"]
impl crate::Resettable for GpiocGenEvent0IidxSpec {}
