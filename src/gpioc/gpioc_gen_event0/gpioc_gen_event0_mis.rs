#[doc = "Register `GPIOC_GEN_EVENT0_MIS` reader"]
pub type R = crate::R<GpiocGenEvent0MisSpec>;
#[doc = "DIO0 event\n\nValue on reset: 0"]
...
#[doc = "Masked interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioc_gen_event0_mis::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiocGenEvent0MisSpec;
impl crate::RegisterSpec for GpiocGenEvent0MisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioc_gen_event0_mis::R`](R) reader structure"]
impl crate::Readable for GpiocGenEvent0MisSpec {}
#[doc = "`reset()` method sets GPIOC_GEN_EVENT0_MIS to value 0"]
impl crate::Resettable for GpiocGenEvent0MisSpec {}
