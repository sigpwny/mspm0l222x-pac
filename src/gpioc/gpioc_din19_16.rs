#[doc = "Register `GPIOC_DIN19_16` reader"]
pub type R = crate::R<GpiocDin19_16Spec>;
...
#[doc = "Data input 19 to 16\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioc_din19_16::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiocDin19_16Spec;
impl crate::RegisterSpec for GpiocDin19_16Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioc_din19_16::R`](R) reader structure"]
impl crate::Readable for GpiocDin19_16Spec {}
#[doc = "`reset()` method sets GPIOC_DIN19_16 to value 0"]
impl crate::Resettable for GpiocDin19_16Spec {}
