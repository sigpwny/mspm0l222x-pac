#[doc = "Register `GPIOC_DOUT15_12` writer"]
pub type W = crate::W<GpiocDout15_12Spec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn dio12(&mut self) -> Dio12W<'_, GpiocDout15_12Spec> {
        Dio12W::new(self, 0)
    }
    #[doc = "Bit 8 - This bit sets the value of the pin configured as DIO13 when the output is enabled through DOE31_0 register."]
    #[inline(always)]
    pub fn dio13(&mut self) -> Dio13W<'_, GpiocDout15_12Spec> {
        Dio13W::new(self, 8)
    }
    #[doc = "Bit 16 - This bit sets the value of the pin configured as DIO14 when the output is enabled through DOE31_0 register."]
    #[inline(always)]
    pub fn dio14(&mut self) -> Dio14W<'_, GpiocDout15_12Spec> {
        Dio14W::new(self, 16)
    }
    #[doc = "Bit 24 - This bit sets the value of the pin configured as DIO15 when the output is enabled through DOE31_0 register."]
    #[inline(always)]
    pub fn dio15(&mut self) -> Dio15W<'_, GpiocDout15_12Spec> {
        Dio15W::new(self, 24)
    }
}
#[doc = "Data output 15 to 12\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpioc_dout15_12::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiocDout15_12Spec;
impl crate::RegisterSpec for GpiocDout15_12Spec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`gpioc_dout15_12::W`](W) writer structure"]
impl crate::Writable for GpiocDout15_12Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIOC_DOUT15_12 to value 0"]
impl crate::Resettable for GpiocDout15_12Spec {}
