#[doc = "Register `GPIOC_GEN_EVENT1_MIS` reader"]
pub type R = crate::R<GpiocGenEvent1MisSpec>;
#[doc = "DIO16 event\n\nValue on reset: 0"]
...
#[doc = "Masked interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioc_gen_event1_mis::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiocGenEvent1MisSpec;
impl crate::RegisterSpec for GpiocGenEvent1MisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioc_gen_event1_mis::R`](R) reader structure"]
impl crate::Readable for GpiocGenEvent1MisSpec {}
#[doc = "`reset()` method sets GPIOC_GEN_EVENT1_MIS to value 0"]
impl crate::Resettable for GpiocGenEvent1MisSpec {}
