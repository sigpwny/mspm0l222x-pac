#[doc = "Register `GPIOC_GEN_EVENT1_IIDX` reader"]
pub type R = crate::R<GpiocGenEvent1IidxSpec>;
...
#[doc = "Interrupt index\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioc_gen_event1_iidx::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiocGenEvent1IidxSpec;
impl crate::RegisterSpec for GpiocGenEvent1IidxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioc_gen_event1_iidx::R`](R) reader structure"]
impl crate::Readable for GpiocGenEvent1IidxSpec {}
#[doc = "`reset()` method sets GPIOC_GEN_EVENT1_IIDX to value 0"]
impl crate::Resettable for GpiocGenEvent1IidxSpec {}
