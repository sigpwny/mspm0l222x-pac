#[doc = "Register `GPIOC_GEN_EVENT1_RIS` reader"]
pub type R = crate::R<GpiocGenEvent1RisSpec>;
#[doc = "DIO16 event\n\nValue on reset: 0"]
...
#[doc = "Raw interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioc_gen_event1_ris::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiocGenEvent1RisSpec;
impl crate::RegisterSpec for GpiocGenEvent1RisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioc_gen_event1_ris::R`](R) reader structure"]
impl crate::Readable for GpiocGenEvent1RisSpec {}
#[doc = "`reset()` method sets GPIOC_GEN_EVENT1_RIS to value 0"]
impl crate::Resettable for GpiocGenEvent1RisSpec {}
