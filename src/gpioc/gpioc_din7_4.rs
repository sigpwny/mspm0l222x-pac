#[doc = "Register `GPIOC_DIN7_4` reader"]
pub type R = crate::R<GpiocDin7_4Spec>;
...
#[doc = "Data input 7 to 4\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioc_din7_4::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiocDin7_4Spec;
impl crate::RegisterSpec for GpiocDin7_4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioc_din7_4::R`](R) reader structure"]
impl crate::Readable for GpiocDin7_4Spec {}
#[doc = "`reset()` method sets GPIOC_DIN7_4 to value 0"]
impl crate::Resettable for GpiocDin7_4Spec {}
