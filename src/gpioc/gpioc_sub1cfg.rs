#[doc = "Register `GPIOC_SUB1CFG` reader"]
pub type R = crate::R<GpiocSub1cfgSpec>;
#[doc = "Register `GPIOC_SUB1CFG` writer"]
pub type W = crate::W<GpiocSub1cfgSpec>;
...
impl W {
    #[doc = "Bit 0 - This bit is used to enable subscriber 1 event."]
    #[inline(always)]
    pub fn enable(&mut self) -> EnableW<'_, GpiocSub1cfgSpec> {
        EnableW::new(self, 0)
    }
    #[doc = "Bits 8:9 - These bits configure the output policy for subscriber 1 event."]
    #[inline(always)]
    pub fn outpolicy(&mut self) -> OutpolicyW<'_, GpiocSub1cfgSpec> {
        OutpolicyW::new(self, 8)
    }
    #[doc = "Bits 16:19 - indicates the specific bit in the upper 16 bits that is targeted by the subscriber action"]
    #[inline(always)]
    pub fn index(&mut self) -> IndexW<'_, GpiocSub1cfgSpec> {
        IndexW::new(self, 16)
    }
}
#[doc = "Subscriber 1 configuration\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioc_sub1cfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpioc_sub1cfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiocSub1cfgSpec;
impl crate::RegisterSpec for GpiocSub1cfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioc_sub1cfg::R`](R) reader structure"]
impl crate::Readable for GpiocSub1cfgSpec {}
#[doc = "`write(|w| ..)` method takes [`gpioc_sub1cfg::W`](W) writer structure"]
impl crate::Writable for GpiocSub1cfgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIOC_SUB1CFG to value 0"]
impl crate::Resettable for GpiocSub1cfgSpec {}
