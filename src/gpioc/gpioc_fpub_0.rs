#[doc = "Register `GPIOC_FPUB_0` reader"]
pub type R = crate::R<GpiocFpub0Spec>;
#[doc = "Register `GPIOC_FPUB_0` writer"]
pub type W = crate::W<GpiocFpub0Spec>;
...
impl W {
    #[doc = "Bits 0:3 - 0 = disconnected. 1-15 = connected to channelID = CHANID."]
    #[inline(always)]
    pub fn chanid(&mut self) -> ChanidW<'_, GpiocFpub0Spec> {
        ChanidW::new(self, 0)
    }
}
#[doc = "Publisher Port 0\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioc_fpub_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpioc_fpub_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiocFpub0Spec;
impl crate::RegisterSpec for GpiocFpub0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioc_fpub_0::R`](R) reader structure"]
impl crate::Readable for GpiocFpub0Spec {}
#[doc = "`write(|w| ..)` method takes [`gpioc_fpub_0::W`](W) writer structure"]
impl crate::Writable for GpiocFpub0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIOC_FPUB_0 to value 0"]
impl crate::Resettable for GpiocFpub0Spec {}
