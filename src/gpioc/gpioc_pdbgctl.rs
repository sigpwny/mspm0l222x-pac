#[doc = "Register `GPIOC_PDBGCTL` reader"]
pub type R = crate::R<GpiocPdbgctlSpec>;
#[doc = "Register `GPIOC_PDBGCTL` writer"]
pub type W = crate::W<GpiocPdbgctlSpec>;
...
impl W {
    #[doc = "Bit 0 - Free run control"]
    #[inline(always)]
    pub fn free(&mut self) -> FreeW<'_, GpiocPdbgctlSpec> {
        FreeW::new(self, 0)
    }
}
#[doc = "Peripheral Debug Control\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioc_pdbgctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpioc_pdbgctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiocPdbgctlSpec;
impl crate::RegisterSpec for GpiocPdbgctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioc_pdbgctl::R`](R) reader structure"]
impl crate::Readable for GpiocPdbgctlSpec {}
#[doc = "`write(|w| ..)` method takes [`gpioc_pdbgctl::W`](W) writer structure"]
impl crate::Writable for GpiocPdbgctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIOC_PDBGCTL to value 0x01"]
impl crate::Resettable for GpiocPdbgctlSpec {
