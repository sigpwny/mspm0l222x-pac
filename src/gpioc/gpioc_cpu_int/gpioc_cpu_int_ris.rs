#[doc = "Register `GPIOC_CPU_INT_RIS` reader"]
pub type R = crate::R<GpiocCpuIntRisSpec>;
#[doc = "DIO0 event\n\nValue on reset: 0"]
...
#[doc = "Raw interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioc_cpu_int_ris::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiocCpuIntRisSpec;
impl crate::RegisterSpec for GpiocCpuIntRisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioc_cpu_int_ris::R`](R) reader structure"]
impl crate::Readable for GpiocCpuIntRisSpec {}
#[doc = "`reset()` method sets GPIOC_CPU_INT_RIS to value 0"]
impl crate::Resettable for GpiocCpuIntRisSpec {}
