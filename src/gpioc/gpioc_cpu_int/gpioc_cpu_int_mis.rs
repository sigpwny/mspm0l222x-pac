#[doc = "Register `GPIOC_CPU_INT_MIS` reader"]
pub type R = crate::R<GpiocCpuIntMisSpec>;
#[doc = "DIO0 event\n\nValue on reset: 0"]
...
#[doc = "Masked interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioc_cpu_int_mis::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiocCpuIntMisSpec;
impl crate::RegisterSpec for GpiocCpuIntMisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioc_cpu_int_mis::R`](R) reader structure"]
impl crate::Readable for GpiocCpuIntMisSpec {}
#[doc = "`reset()` method sets GPIOC_CPU_INT_MIS to value 0"]
impl crate::Resettable for GpiocCpuIntMisSpec {}
