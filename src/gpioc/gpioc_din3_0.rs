#[doc = "Register `GPIOC_DIN3_0` reader"]
pub type R = crate::R<GpiocDin3_0Spec>;
...
#[doc = "Data input 3 to 0\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioc_din3_0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiocDin3_0Spec;
impl crate::RegisterSpec for GpiocDin3_0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioc_din3_0::R`](R) reader structure"]
impl crate::Readable for GpiocDin3_0Spec {}
#[doc = "`reset()` method sets GPIOC_DIN3_0 to value 0"]
impl crate::Resettable for GpiocDin3_0Spec {}
