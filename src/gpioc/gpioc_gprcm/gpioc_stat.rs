#[doc = "Register `GPIOC_STAT` reader"]
pub type R = crate::R<GpiocStatSpec>;
...
#[doc = "Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioc_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiocStatSpec;
impl crate::RegisterSpec for GpiocStatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioc_stat::R`](R) reader structure"]
impl crate::Readable for GpiocStatSpec {}
#[doc = "`reset()` method sets GPIOC_STAT to value 0"]
impl crate::Resettable for GpiocStatSpec {}
