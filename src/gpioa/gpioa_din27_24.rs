#[doc = "Register `GPIOA_DIN27_24` reader"]
pub type R = crate::R<GpioaDin27_24Spec>;
...
#[doc = "Data input 27 to 24\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioa_din27_24::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpioaDin27_24Spec;
impl crate::RegisterSpec for GpioaDin27_24Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioa_din27_24::R`](R) reader structure"]
impl crate::Readable for GpioaDin27_24Spec {}
#[doc = "`reset()` method sets GPIOA_DIN27_24 to value 0"]
impl crate::Resettable for GpioaDin27_24Spec {}
