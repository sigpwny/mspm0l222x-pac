#[doc = "Register `GPIOA_DIN3_0` reader"]
pub type R = crate::R<GpioaDin3_0Spec>;
...
#[doc = "Data input 3 to 0\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioa_din3_0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpioaDin3_0Spec;
impl crate::RegisterSpec for GpioaDin3_0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioa_din3_0::R`](R) reader structure"]
impl crate::Readable for GpioaDin3_0Spec {}
#[doc = "`reset()` method sets GPIOA_DIN3_0 to value 0"]
impl crate::Resettable for GpioaDin3_0Spec {}
