#[doc = "Register `GPIOA_DIN31_0` reader"]
pub type R = crate::R<GpioaDin31_0Spec>;
...
#[doc = "Data input 31 to 0\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioa_din31_0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpioaDin31_0Spec;
impl crate::RegisterSpec for GpioaDin31_0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioa_din31_0::R`](R) reader structure"]
impl crate::Readable for GpioaDin31_0Spec {}
#[doc = "`reset()` method sets GPIOA_DIN31_0 to value 0"]
impl crate::Resettable for GpioaDin31_0Spec {}
