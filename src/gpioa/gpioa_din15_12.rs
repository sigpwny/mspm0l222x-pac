#[doc = "Register `GPIOA_DIN15_12` reader"]
pub type R = crate::R<GpioaDin15_12Spec>;
...
#[doc = "Data input 15 to 12\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioa_din15_12::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpioaDin15_12Spec;
impl crate::RegisterSpec for GpioaDin15_12Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioa_din15_12::R`](R) reader structure"]
impl crate::Readable for GpioaDin15_12Spec {}
#[doc = "`reset()` method sets GPIOA_DIN15_12 to value 0"]
impl crate::Resettable for GpioaDin15_12Spec {}
