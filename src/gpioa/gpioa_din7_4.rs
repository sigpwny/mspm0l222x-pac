#[doc = "Register `GPIOA_DIN7_4` reader"]
pub type R = crate::R<GpioaDin7_4Spec>;
...
#[doc = "Data input 7 to 4\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioa_din7_4::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpioaDin7_4Spec;
impl crate::RegisterSpec for GpioaDin7_4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioa_din7_4::R`](R) reader structure"]
impl crate::Readable for GpioaDin7_4Spec {}
#[doc = "`reset()` method sets GPIOA_DIN7_4 to value 0"]
impl crate::Resettable for GpioaDin7_4Spec {}
