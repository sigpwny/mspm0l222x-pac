#[doc = "Register `GPIOA_DIN31_28` reader"]
pub type R = crate::R<GpioaDin31_28Spec>;
...
#[doc = "Data input 31 to 28\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioa_din31_28::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpioaDin31_28Spec;
impl crate::RegisterSpec for GpioaDin31_28Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioa_din31_28::R`](R) reader structure"]
impl crate::Readable for GpioaDin31_28Spec {}
#[doc = "`reset()` method sets GPIOA_DIN31_28 to value 0"]
impl crate::Resettable for GpioaDin31_28Spec {}
