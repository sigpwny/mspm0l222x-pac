#[doc = "Register `GPIOA_SUB1CFG` reader"]
pub type R = crate::R<GpioaSub1cfgSpec>;
#[doc = "Register `GPIOA_SUB1CFG` writer"]
pub type W = crate::W<GpioaSub1cfgSpec>;
...
impl W {
    #[doc = "Bit 0 - This bit is used to enable subscriber 1 event."]
    #[inline(always)]
    pub fn enable(&mut self) -> EnableW<'_, GpioaSub1cfgSpec> {
        EnableW::new(self, 0)
    }
    #[doc = "Bits 8:9 - These bits configure the output policy for subscriber 1 event."]
    #[inline(always)]
    pub fn outpolicy(&mut self) -> OutpolicyW<'_, GpioaSub1cfgSpec> {
        OutpolicyW::new(self, 8)
    }
    #[doc = "Bits 16:19 - indicates the specific bit in the upper 16 bits that is targeted by the subscriber action"]
    #[inline(always)]
    pub fn index(&mut self) -> IndexW<'_, GpioaSub1cfgSpec> {
        IndexW::new(self, 16)
    }
}
#[doc = "Subscriber 1 configuration\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioa_sub1cfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpioa_sub1cfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpioaSub1cfgSpec;
impl crate::RegisterSpec for GpioaSub1cfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioa_sub1cfg::R`](R) reader structure"]
impl crate::Readable for GpioaSub1cfgSpec {}
#[doc = "`write(|w| ..)` method takes [`gpioa_sub1cfg::W`](W) writer structure"]
impl crate::Writable for GpioaSub1cfgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIOA_SUB1CFG to value 0"]
impl crate::Resettable for GpioaSub1cfgSpec {}
