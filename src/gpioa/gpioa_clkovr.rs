#[doc = "Register `GPIOA_CLKOVR` reader"]
pub type R = crate::R<GpioaClkovrSpec>;
#[doc = "Register `GPIOA_CLKOVR` writer"]
pub type W = crate::W<GpioaClkovrSpec>;
...
impl W {
    #[doc = "Bit 0 - Unlocks the functionality of \\[RUN_STOP\\] to override the automatic peripheral clock request"]
    #[inline(always)]
    pub fn override_(&mut self) -> OverrideW<'_, GpioaClkovrSpec> {
        OverrideW::new(self, 0)
    }
    #[doc = "Bit 1 - If \\[OVERRIDE\\] is enabled, this register is used to manually control the peripheral's clock request to the system"]
    #[inline(always)]
    pub fn run_stop(&mut self) -> RunStopW<'_, GpioaClkovrSpec> {
        RunStopW::new(self, 1)
    }
}
#[doc = "Clock Override\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioa_clkovr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpioa_clkovr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpioaClkovrSpec;
impl crate::RegisterSpec for GpioaClkovrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioa_clkovr::R`](R) reader structure"]
impl crate::Readable for GpioaClkovrSpec {}
#[doc = "`write(|w| ..)` method takes [`gpioa_clkovr::W`](W) writer structure"]
impl crate::Writable for GpioaClkovrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIOA_CLKOVR to value 0"]
impl crate::Resettable for GpioaClkovrSpec {}
