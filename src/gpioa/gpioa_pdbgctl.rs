#[doc = "Register `GPIOA_PDBGCTL` reader"]
pub type R = crate::R<GpioaPdbgctlSpec>;
#[doc = "Register `GPIOA_PDBGCTL` writer"]
pub type W = crate::W<GpioaPdbgctlSpec>;
...
impl W {
    #[doc = "Bit 0 - Free run control"]
    #[inline(always)]
    pub fn free(&mut self) -> FreeW<'_, GpioaPdbgctlSpec> {
        FreeW::new(self, 0)
    }
}
#[doc = "Peripheral Debug Control\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioa_pdbgctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpioa_pdbgctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpioaPdbgctlSpec;
impl crate::RegisterSpec for GpioaPdbgctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioa_pdbgctl::R`](R) reader structure"]
impl crate::Readable for GpioaPdbgctlSpec {}
#[doc = "`write(|w| ..)` method takes [`gpioa_pdbgctl::W`](W) writer structure"]
impl crate::Writable for GpioaPdbgctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIOA_PDBGCTL to value 0x01"]
impl crate::Resettable for GpioaPdbgctlSpec {
