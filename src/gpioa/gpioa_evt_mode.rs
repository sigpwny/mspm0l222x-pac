#[doc = "Register `GPIOA_EVT_MODE` reader"]
pub type R = crate::R<GpioaEvtModeSpec>;
#[doc = "Register `GPIOA_EVT_MODE` writer"]
pub type W = crate::W<GpioaEvtModeSpec>;
...
impl W {}
#[doc = "Event Mode\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioa_evt_mode::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpioa_evt_mode::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpioaEvtModeSpec;
impl crate::RegisterSpec for GpioaEvtModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioa_evt_mode::R`](R) reader structure"]
impl crate::Readable for GpioaEvtModeSpec {}
#[doc = "`write(|w| ..)` method takes [`gpioa_evt_mode::W`](W) writer structure"]
impl crate::Writable for GpioaEvtModeSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIOA_EVT_MODE to value 0"]
impl crate::Resettable for GpioaEvtModeSpec {}
