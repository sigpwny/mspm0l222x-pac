#[doc = "Register `GPIOA_RSTCTL` writer"]
pub type W = crate::W<GpioaRstctlSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn resetassert(&mut self) -> ResetassertW<'_, GpioaRstctlSpec> {
        ResetassertW::new(self, 0)
    }
    #[doc = "Bit 1 - Clear the RESETSTKY bit in the STAT register"]
    #[inline(always)]
    pub fn resetstkyclr(&mut self) -> ResetstkyclrW<'_, GpioaRstctlSpec> {
        ResetstkyclrW::new(self, 1)
    }
}
#[doc = "Reset Control\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpioa_rstctl::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpioaRstctlSpec;
impl crate::RegisterSpec for GpioaRstctlSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`gpioa_rstctl::W`](W) writer structure"]
impl crate::Writable for GpioaRstctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIOA_RSTCTL to value 0"]
impl crate::Resettable for GpioaRstctlSpec {}
