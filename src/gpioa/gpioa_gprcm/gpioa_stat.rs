#[doc = "Register `GPIOA_STAT` reader"]
pub type R = crate::R<GpioaStatSpec>;
...
#[doc = "Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioa_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpioaStatSpec;
impl crate::RegisterSpec for GpioaStatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioa_stat::R`](R) reader structure"]
impl crate::Readable for GpioaStatSpec {}
#[doc = "`reset()` method sets GPIOA_STAT to value 0"]
impl crate::Resettable for GpioaStatSpec {}
