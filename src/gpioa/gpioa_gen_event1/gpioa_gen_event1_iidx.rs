#[doc = "Register `GPIOA_GEN_EVENT1_IIDX` reader"]
pub type R = crate::R<GpioaGenEvent1IidxSpec>;
...
#[doc = "Interrupt index\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioa_gen_event1_iidx::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpioaGenEvent1IidxSpec;
impl crate::RegisterSpec for GpioaGenEvent1IidxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioa_gen_event1_iidx::R`](R) reader structure"]
impl crate::Readable for GpioaGenEvent1IidxSpec {}
#[doc = "`reset()` method sets GPIOA_GEN_EVENT1_IIDX to value 0"]
impl crate::Resettable for GpioaGenEvent1IidxSpec {}
