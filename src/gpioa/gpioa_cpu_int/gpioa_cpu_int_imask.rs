#[doc = "Register `GPIOA_CPU_INT_IMASK` reader"]
pub type R = crate::R<GpioaCpuIntImaskSpec>;
#[doc = "Register `GPIOA_CPU_INT_IMASK` writer"]
pub type W = crate::W<GpioaCpuIntImaskSpec>;
#[doc = "DIO0 event mask\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bit 0 - DIO0 event mask"]
    #[inline(always)]
    pub fn dio0(&mut self) -> Dio0W<'_, GpioaCpuIntImaskSpec> {
        Dio0W::new(self, 0)
    }
    #[doc = "Bit 1 - DIO1 event mask"]
    #[inline(always)]
    pub fn dio1(&mut self) -> Dio1W<'_, GpioaCpuIntImaskSpec> {
        Dio1W::new(self, 1)
    }
    #[doc = "Bit 2 - DIO2 event mask"]
    #[inline(always)]
    pub fn dio2(&mut self) -> Dio2W<'_, GpioaCpuIntImaskSpec> {
        Dio2W::new(self, 2)
    }
    #[doc = "Bit 3 - DIO3 event mask"]
    #[inline(always)]
    pub fn dio3(&mut self) -> Dio3W<'_, GpioaCpuIntImaskSpec> {
        Dio3W::new(self, 3)
    }
    #[doc = "Bit 4 - DIO4 event mask"]
    #[inline(always)]
    pub fn dio4(&mut self) -> Dio4W<'_, GpioaCpuIntImaskSpec> {
        Dio4W::new(self, 4)
    }
    #[doc = "Bit 5 - DIO5 event mask"]
    #[inline(always)]
    pub fn dio5(&mut self) -> Dio5W<'_, GpioaCpuIntImaskSpec> {
        Dio5W::new(self, 5)
    }
    #[doc = "Bit 6 - DIO6 event mask"]
    #[inline(always)]
    pub fn dio6(&mut self) -> Dio6W<'_, GpioaCpuIntImaskSpec> {
        Dio6W::new(self, 6)
    }
    #[doc = "Bit 7 - DIO7 event mask"]
    #[inline(always)]
    pub fn dio7(&mut self) -> Dio7W<'_, GpioaCpuIntImaskSpec> {
        Dio7W::new(self, 7)
    }
    #[doc = "Bit 8 - DIO8 event mask"]
    #[inline(always)]
    pub fn dio8(&mut self) -> Dio8W<'_, GpioaCpuIntImaskSpec> {
        Dio8W::new(self, 8)
    }
    #[doc = "Bit 9 - DIO9 event mask"]
    #[inline(always)]
    pub fn dio9(&mut self) -> Dio9W<'_, GpioaCpuIntImaskSpec> {
        Dio9W::new(self, 9)
    }
    #[doc = "Bit 10 - DIO10 event mask"]
    #[inline(always)]
    pub fn dio10(&mut self) -> Dio10W<'_, GpioaCpuIntImaskSpec> {
        Dio10W::new(self, 10)
    }
    #[doc = "Bit 11 - DIO11 event mask"]
    #[inline(always)]
    pub fn dio11(&mut self) -> Dio11W<'_, GpioaCpuIntImaskSpec> {
        Dio11W::new(self, 11)
    }
    #[doc = "Bit 12 - DIO12 event mask"]
    #[inline(always)]
    pub fn dio12(&mut self) -> Dio12W<'_, GpioaCpuIntImaskSpec> {
        Dio12W::new(self, 12)
    }
    #[doc = "Bit 13 - DIO13 event mask"]
    #[inline(always)]
    pub fn dio13(&mut self) -> Dio13W<'_, GpioaCpuIntImaskSpec> {
        Dio13W::new(self, 13)
    }
    #[doc = "Bit 14 - DIO14 event mask"]
    #[inline(always)]
    pub fn dio14(&mut self) -> Dio14W<'_, GpioaCpuIntImaskSpec> {
        Dio14W::new(self, 14)
    }
    #[doc = "Bit 15 - DIO15 event mask"]
    #[inline(always)]
    pub fn dio15(&mut self) -> Dio15W<'_, GpioaCpuIntImaskSpec> {
        Dio15W::new(self, 15)
    }
    #[doc = "Bit 16 - DIO16 event mask"]
    #[inline(always)]
    pub fn dio16(&mut self) -> Dio16W<'_, GpioaCpuIntImaskSpec> {
        Dio16W::new(self, 16)
    }
    #[doc = "Bit 17 - DIO17 event mask"]
    #[inline(always)]
    pub fn dio17(&mut self) -> Dio17W<'_, GpioaCpuIntImaskSpec> {
        Dio17W::new(self, 17)
    }
    #[doc = "Bit 18 - DIO18 event mask"]
    #[inline(always)]
    pub fn dio18(&mut self) -> Dio18W<'_, GpioaCpuIntImaskSpec> {
        Dio18W::new(self, 18)
    }
    #[doc = "Bit 19 - DIO19 event mask"]
    #[inline(always)]
    pub fn dio19(&mut self) -> Dio19W<'_, GpioaCpuIntImaskSpec> {
        Dio19W::new(self, 19)
    }
    #[doc = "Bit 20 - DIO20 event mask"]
    #[inline(always)]
    pub fn dio20(&mut self) -> Dio20W<'_, GpioaCpuIntImaskSpec> {
        Dio20W::new(self, 20)
    }
    #[doc = "Bit 21 - DIO21 event mask"]
    #[inline(always)]
    pub fn dio21(&mut self) -> Dio21W<'_, GpioaCpuIntImaskSpec> {
        Dio21W::new(self, 21)
    }
    #[doc = "Bit 22 - DIO22 event mask"]
    #[inline(always)]
    pub fn dio22(&mut self) -> Dio22W<'_, GpioaCpuIntImaskSpec> {
        Dio22W::new(self, 22)
    }
    #[doc = "Bit 23 - DIO23 event mask"]
    #[inline(always)]
    pub fn dio23(&mut self) -> Dio23W<'_, GpioaCpuIntImaskSpec> {
        Dio23W::new(self, 23)
    }
    #[doc = "Bit 24 - DIO24 event mask"]
    #[inline(always)]
    pub fn dio24(&mut self) -> Dio24W<'_, GpioaCpuIntImaskSpec> {
        Dio24W::new(self, 24)
    }
    #[doc = "Bit 25 - DIO25 event mask"]
    #[inline(always)]
    pub fn dio25(&mut self) -> Dio25W<'_, GpioaCpuIntImaskSpec> {
        Dio25W::new(self, 25)
    }
    #[doc = "Bit 26 - DIO26 event mask"]
    #[inline(always)]
    pub fn dio26(&mut self) -> Dio26W<'_, GpioaCpuIntImaskSpec> {
        Dio26W::new(self, 26)
    }
    #[doc = "Bit 27 - DIO27 event mask"]
    #[inline(always)]
    pub fn dio27(&mut self) -> Dio27W<'_, GpioaCpuIntImaskSpec> {
        Dio27W::new(self, 27)
    }
    #[doc = "Bit 28 - DIO28 event mask"]
    #[inline(always)]
    pub fn dio28(&mut self) -> Dio28W<'_, GpioaCpuIntImaskSpec> {
        Dio28W::new(self, 28)
    }
    #[doc = "Bit 29 - DIO29 event mask"]
    #[inline(always)]
    pub fn dio29(&mut self) -> Dio29W<'_, GpioaCpuIntImaskSpec> {
        Dio29W::new(self, 29)
    }
    #[doc = "Bit 30 - DIO30 event mask"]
    #[inline(always)]
    pub fn dio30(&mut self) -> Dio30W<'_, GpioaCpuIntImaskSpec> {
        Dio30W::new(self, 30)
    }
    #[doc = "Bit 31 - DIO31 event mask"]
    #[inline(always)]
    pub fn dio31(&mut self) -> Dio31W<'_, GpioaCpuIntImaskSpec> {
        Dio31W::new(self, 31)
    }
}
#[doc = "Interrupt mask\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioa_cpu_int_imask::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpioa_cpu_int_imask::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpioaCpuIntImaskSpec;
impl crate::RegisterSpec for GpioaCpuIntImaskSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioa_cpu_int_imask::R`](R) reader structure"]
impl crate::Readable for GpioaCpuIntImaskSpec {}
#[doc = "`write(|w| ..)` method takes [`gpioa_cpu_int_imask::W`](W) writer structure"]
impl crate::Writable for GpioaCpuIntImaskSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIOA_CPU_INT_IMASK to value 0"]
impl crate::Resettable for GpioaCpuIntImaskSpec {}
