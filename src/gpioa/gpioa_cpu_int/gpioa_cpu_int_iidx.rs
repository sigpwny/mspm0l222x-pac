#[doc = "Register `GPIOA_CPU_INT_IIDX` reader"]
pub type R = crate::R<GpioaCpuIntIidxSpec>;
...
#[doc = "Interrupt index\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioa_cpu_int_iidx::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpioaCpuIntIidxSpec;
impl crate::RegisterSpec for GpioaCpuIntIidxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioa_cpu_int_iidx::R`](R) reader structure"]
impl crate::Readable for GpioaCpuIntIidxSpec {}
#[doc = "`reset()` method sets GPIOA_CPU_INT_IIDX to value 0"]
impl crate::Resettable for GpioaCpuIntIidxSpec {}
