#[doc = "Register `GPIOA_CPU_INT_RIS` reader"]
pub type R = crate::R<GpioaCpuIntRisSpec>;
#[doc = "DIO0 event\n\nValue on reset: 0"]
...
#[doc = "Raw interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioa_cpu_int_ris::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpioaCpuIntRisSpec;
impl crate::RegisterSpec for GpioaCpuIntRisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioa_cpu_int_ris::R`](R) reader structure"]
impl crate::Readable for GpioaCpuIntRisSpec {}
#[doc = "`reset()` method sets GPIOA_CPU_INT_RIS to value 0"]
impl crate::Resettable for GpioaCpuIntRisSpec {}
