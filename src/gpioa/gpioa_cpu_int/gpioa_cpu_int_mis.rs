#[doc = "Register `GPIOA_CPU_INT_MIS` reader"]
pub type R = crate::R<GpioaCpuIntMisSpec>;
#[doc = "DIO0 event\n\nValue on reset: 0"]
...
#[doc = "Masked interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioa_cpu_int_mis::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpioaCpuIntMisSpec;
impl crate::RegisterSpec for GpioaCpuIntMisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioa_cpu_int_mis::R`](R) reader structure"]
impl crate::Readable for GpioaCpuIntMisSpec {}
#[doc = "`reset()` method sets GPIOA_CPU_INT_MIS to value 0"]
impl crate::Resettable for GpioaCpuIntMisSpec {}
