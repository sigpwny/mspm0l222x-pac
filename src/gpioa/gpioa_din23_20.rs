#[doc = "Register `GPIOA_DIN23_20` reader"]
pub type R = crate::R<GpioaDin23_20Spec>;
...
#[doc = "Data input 23 to 20\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioa_din23_20::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpioaDin23_20Spec;
impl crate::RegisterSpec for GpioaDin23_20Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioa_din23_20::R`](R) reader structure"]
impl crate::Readable for GpioaDin23_20Spec {}
#[doc = "`reset()` method sets GPIOA_DIN23_20 to value 0"]
impl crate::Resettable for GpioaDin23_20Spec {}
