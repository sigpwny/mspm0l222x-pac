#[doc = "Register `GPIOA_FILTEREN31_16` reader"]
pub type R = crate::R<GpioaFilteren31_16Spec>;
#[doc = "Register `GPIOA_FILTEREN31_16` writer"]
pub type W = crate::W<GpioaFilteren31_16Spec>;
...
impl W {
    #[doc = "Bits 0:1 - Programmable counter length of digital glitch filter for DIN16"]
    #[inline(always)]
    pub fn din16(&mut self) -> Din16W<'_, GpioaFilteren31_16Spec> {
        Din16W::new(self, 0)
    }
    #[doc = "Bits 2:3 - Programmable counter length of digital glitch filter for DIN17"]
    #[inline(always)]
    pub fn din17(&mut self) -> Din17W<'_, GpioaFilteren31_16Spec> {
        Din17W::new(self, 2)
    }
    #[doc = "Bits 4:5 - Programmable counter length of digital glitch filter for DIN18"]
    #[inline(always)]
    pub fn din18(&mut self) -> Din18W<'_, GpioaFilteren31_16Spec> {
        Din18W::new(self, 4)
    }
    #[doc = "Bits 6:7 - Programmable counter length of digital glitch filter for DIN19"]
    #[inline(always)]
    pub fn din19(&mut self) -> Din19W<'_, GpioaFilteren31_16Spec> {
        Din19W::new(self, 6)
    }
    #[doc = "Bits 8:9 - Programmable counter length of digital glitch filter for DIN20"]
    #[inline(always)]
    pub fn din20(&mut self) -> Din20W<'_, GpioaFilteren31_16Spec> {
        Din20W::new(self, 8)
    }
    #[doc = "Bits 10:11 - Programmable counter length of digital glitch filter for DIN21"]
    #[inline(always)]
    pub fn din21(&mut self) -> Din21W<'_, GpioaFilteren31_16Spec> {
        Din21W::new(self, 10)
    }
    #[doc = "Bits 12:13 - Programmable counter length of digital glitch filter for DIN22"]
    #[inline(always)]
    pub fn din22(&mut self) -> Din22W<'_, GpioaFilteren31_16Spec> {
        Din22W::new(self, 12)
    }
    #[doc = "Bits 14:15 - Programmable counter length of digital glitch filter for DIN23"]
    #[inline(always)]
    pub fn din23(&mut self) -> Din23W<'_, GpioaFilteren31_16Spec> {
        Din23W::new(self, 14)
    }
    #[doc = "Bits 16:17 - Programmable counter length of digital glitch filter for DIN24"]
    #[inline(always)]
    pub fn din24(&mut self) -> Din24W<'_, GpioaFilteren31_16Spec> {
        Din24W::new(self, 16)
    }
    #[doc = "Bits 18:19 - Programmable counter length of digital glitch filter for DIN25"]
    #[inline(always)]
    pub fn din25(&mut self) -> Din25W<'_, GpioaFilteren31_16Spec> {
        Din25W::new(self, 18)
    }
    #[doc = "Bits 20:21 - Programmable counter length of digital glitch filter for DIN26"]
    #[inline(always)]
    pub fn din26(&mut self) -> Din26W<'_, GpioaFilteren31_16Spec> {
        Din26W::new(self, 20)
    }
    #[doc = "Bits 22:23 - Programmable counter length of digital glitch filter for DIN27"]
    #[inline(always)]
    pub fn din27(&mut self) -> Din27W<'_, GpioaFilteren31_16Spec> {
        Din27W::new(self, 22)
    }
    #[doc = "Bits 24:25 - Programmable counter length of digital glitch filter for DIN28"]
    #[inline(always)]
    pub fn din28(&mut self) -> Din28W<'_, GpioaFilteren31_16Spec> {
        Din28W::new(self, 24)
    }
    #[doc = "Bits 26:27 - Programmable counter length of digital glitch filter for DIN29"]
    #[inline(always)]
    pub fn din29(&mut self) -> Din29W<'_, GpioaFilteren31_16Spec> {
        Din29W::new(self, 26)
    }
    #[doc = "Bits 28:29 - Programmable counter length of digital glitch filter for DIN30"]
    #[inline(always)]
    pub fn din30(&mut self) -> Din30W<'_, GpioaFilteren31_16Spec> {
        Din30W::new(self, 28)
    }
    #[doc = "Bits 30:31 - Programmable counter length of digital glitch filter for DIN31"]
    #[inline(always)]
    pub fn din31(&mut self) -> Din31W<'_, GpioaFilteren31_16Spec> {
        Din31W::new(self, 30)
    }
}
...
pub struct GpioaFilteren31_16Spec;
impl crate::RegisterSpec for GpioaFilteren31_16Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioa_filteren31_16::R`](R) reader structure"]
impl crate::Readable for GpioaFilteren31_16Spec {}
#[doc = "`write(|w| ..)` method takes [`gpioa_filteren31_16::W`](W) writer structure"]
impl crate::Writable for GpioaFilteren31_16Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIOA_FILTEREN31_16 to value 0"]
impl crate::Resettable for GpioaFilteren31_16Spec {}
