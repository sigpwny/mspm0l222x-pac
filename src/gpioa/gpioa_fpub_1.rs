#[doc = "Register `GPIOA_FPUB_1` reader"]
pub type R = crate::R<GpioaFpub1Spec>;
#[doc = "Register `GPIOA_FPUB_1` writer"]
pub type W = crate::W<GpioaFpub1Spec>;
...
impl W {
    #[doc = "Bits 0:3 - 0 = disconnected. 1-15 = connected to channelID = CHANID."]
    #[inline(always)]
    pub fn chanid(&mut self) -> ChanidW<'_, GpioaFpub1Spec> {
        ChanidW::new(self, 0)
    }
}
#[doc = "Publisher Port 1\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioa_fpub_1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpioa_fpub_1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpioaFpub1Spec;
impl crate::RegisterSpec for GpioaFpub1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioa_fpub_1::R`](R) reader structure"]
impl crate::Readable for GpioaFpub1Spec {}
#[doc = "`write(|w| ..)` method takes [`gpioa_fpub_1::W`](W) writer structure"]
impl crate::Writable for GpioaFpub1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIOA_FPUB_1 to value 0"]
impl crate::Resettable for GpioaFpub1Spec {}
