#[doc = "Register `GPIOA_DOUT19_16` writer"]
pub type W = crate::W<GpioaDout19_16Spec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn dio16(&mut self) -> Dio16W<'_, GpioaDout19_16Spec> {
        Dio16W::new(self, 0)
    }
    #[doc = "Bit 8 - This bit sets the value of the pin configured as DIO17 when the output is enabled through DOE31_0 register."]
    #[inline(always)]
    pub fn dio17(&mut self) -> Dio17W<'_, GpioaDout19_16Spec> {
        Dio17W::new(self, 8)
    }
    #[doc = "Bit 16 - This bit sets the value of the pin configured as DIO18 when the output is enabled through DOE31_0 register."]
    #[inline(always)]
    pub fn dio18(&mut self) -> Dio18W<'_, GpioaDout19_16Spec> {
        Dio18W::new(self, 16)
    }
    #[doc = "Bit 24 - This bit sets the value of the pin configured as DIO19 when the output is enabled through DOE31_0 register."]
    #[inline(always)]
    pub fn dio19(&mut self) -> Dio19W<'_, GpioaDout19_16Spec> {
        Dio19W::new(self, 24)
    }
}
#[doc = "Data output 19 to 16\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpioa_dout19_16::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpioaDout19_16Spec;
impl crate::RegisterSpec for GpioaDout19_16Spec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`gpioa_dout19_16::W`](W) writer structure"]
impl crate::Writable for GpioaDout19_16Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIOA_DOUT19_16 to value 0"]
impl crate::Resettable for GpioaDout19_16Spec {}
