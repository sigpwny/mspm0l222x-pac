#[doc = "Register `GPIOA_GEN_EVENT0_RIS` reader"]
pub type R = crate::R<GpioaGenEvent0RisSpec>;
#[doc = "DIO0 event\n\nValue on reset: 0"]
...
#[doc = "Raw interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`gpioa_gen_event0_ris::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpioaGenEvent0RisSpec;
impl crate::RegisterSpec for GpioaGenEvent0RisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioa_gen_event0_ris::R`](R) reader structure"]
impl crate::Readable for GpioaGenEvent0RisSpec {}
#[doc = "`reset()` method sets GPIOA_GEN_EVENT0_RIS to value 0"]
impl crate::Resettable for GpioaGenEvent0RisSpec {}
