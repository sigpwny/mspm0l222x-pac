#[doc = "Register `GPIOA_DOUT27_24` writer"]
pub type W = crate::W<GpioaDout27_24Spec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn dio24(&mut self) -> Dio24W<'_, GpioaDout27_24Spec> {
        Dio24W::new(self, 0)
    }
    #[doc = "Bit 8 - This bit sets the value of the pin configured as DIO25 when the output is enabled through DOE31_0 register."]
    #[inline(always)]
    pub fn dio25(&mut self) -> Dio25W<'_, GpioaDout27_24Spec> {
        Dio25W::new(self, 8)
    }
    #[doc = "Bit 16 - This bit sets the value of the pin configured as DIO26 when the output is enabled through DOE31_0 register."]
    #[inline(always)]
    pub fn dio26(&mut self) -> Dio26W<'_, GpioaDout27_24Spec> {
        Dio26W::new(self, 16)
    }
    #[doc = "Bit 24 - This bit sets the value of the pin configured as DIO27 when the output is enabled through DOE31_0 register."]
    #[inline(always)]
    pub fn dio27(&mut self) -> Dio27W<'_, GpioaDout27_24Spec> {
        Dio27W::new(self, 24)
    }
}
#[doc = "Data output 27 to 24\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpioa_dout27_24::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpioaDout27_24Spec;
impl crate::RegisterSpec for GpioaDout27_24Spec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`gpioa_dout27_24::W`](W) writer structure"]
impl crate::Writable for GpioaDout27_24Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIOA_DOUT27_24 to value 0"]
impl crate::Resettable for GpioaDout27_24Spec {}
