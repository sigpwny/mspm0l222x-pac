#[doc = "Register `TIMG5_ODIS` reader"]
pub type R = crate::R<Timg5OdisSpec>;
#[doc = "Register `TIMG5_ODIS` writer"]
pub type W = crate::W<Timg5OdisSpec>;
...
impl W {
    #[doc = "Bit 0 - Counter CCP0 Disable Mask Defines whether CCP0 of Counter n is forced low or not"]
    #[inline(always)]
    pub fn c0ccp0(&mut self) -> C0ccp0W<'_, Timg5OdisSpec> {
        C0ccp0W::new(self, 0)
    }
    #[doc = "Bit 1 - Counter CCP1 Disable Mask Defines whether CCP0 of Counter n is forced low or not"]
    #[inline(always)]
    pub fn c0ccp1(&mut self) -> C0ccp1W<'_, Timg5OdisSpec> {
        C0ccp1W::new(self, 1)
    }
}
#[doc = "Output Disable\n\nYou can [`read`](crate::Reg::read) this register and get [`timg5_odis::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timg5_odis::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg5OdisSpec;
impl crate::RegisterSpec for Timg5OdisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg5_odis::R`](R) reader structure"]
impl crate::Readable for Timg5OdisSpec {}
#[doc = "`write(|w| ..)` method takes [`timg5_odis::W`](W) writer structure"]
impl crate::Writable for Timg5OdisSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMG5_ODIS to value 0"]
impl crate::Resettable for Timg5OdisSpec {}
