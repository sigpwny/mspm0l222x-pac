#[doc = "Register `TIMG5_CTTRIG` writer"]
pub type W = crate::W<Timg5CttrigSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn trig(&mut self) -> TrigW<'_, Timg5CttrigSpec> {
        TrigW::new(self, 0)
    }
}
#[doc = "Timer Cross Trigger Register\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timg5_cttrig::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg5CttrigSpec;
impl crate::RegisterSpec for Timg5CttrigSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`timg5_cttrig::W`](W) writer structure"]
impl crate::Writable for Timg5CttrigSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMG5_CTTRIG to value 0"]
impl crate::Resettable for Timg5CttrigSpec {}
