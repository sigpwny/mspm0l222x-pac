#[doc = "Register `TIMG5_GCTL` reader"]
pub type R = crate::R<Timg5GctlSpec>;
#[doc = "Register `TIMG5_GCTL` writer"]
pub type W = crate::W<Timg5GctlSpec>;
...
impl W {
    #[doc = "Bit 0 - Enables shadow to active load of bufferred registers and register fields."]
    #[inline(always)]
    pub fn shdwlden(&mut self) -> ShdwldenW<'_, Timg5GctlSpec> {
        ShdwldenW::new(self, 0)
    }
}
#[doc = "Shadow to active load mask\n\nYou can [`read`](crate::Reg::read) this register and get [`timg5_gctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timg5_gctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg5GctlSpec;
impl crate::RegisterSpec for Timg5GctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg5_gctl::R`](R) reader structure"]
impl crate::Readable for Timg5GctlSpec {}
#[doc = "`write(|w| ..)` method takes [`timg5_gctl::W`](W) writer structure"]
impl crate::Writable for Timg5GctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMG5_GCTL to value 0"]
impl crate::Resettable for Timg5GctlSpec {}
