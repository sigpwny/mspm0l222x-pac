#[doc = "Register `TIMG5_IIDX` reader"]
pub type R = crate::R<Timg5IidxSpec>;
...
#[doc = "Interrupt index\n\nYou can [`read`](crate::Reg::read) this register and get [`timg5_iidx::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg5IidxSpec;
impl crate::RegisterSpec for Timg5IidxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg5_iidx::R`](R) reader structure"]
impl crate::Readable for Timg5IidxSpec {}
#[doc = "`reset()` method sets TIMG5_IIDX to value 0"]
impl crate::Resettable for Timg5IidxSpec {}
