#[doc = "Register `TIMG5_RIS` reader"]
pub type R = crate::R<Timg5RisSpec>;
...
#[doc = "Raw interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`timg5_ris::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg5RisSpec;
impl crate::RegisterSpec for Timg5RisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg5_ris::R`](R) reader structure"]
impl crate::Readable for Timg5RisSpec {}
#[doc = "`reset()` method sets TIMG5_RIS to value 0"]
impl crate::Resettable for Timg5RisSpec {}
