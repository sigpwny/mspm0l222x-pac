#[doc = "Register `TIMG5_MIS` reader"]
pub type R = crate::R<Timg5MisSpec>;
...
#[doc = "Masked interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`timg5_mis::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg5MisSpec;
impl crate::RegisterSpec for Timg5MisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg5_mis::R`](R) reader structure"]
impl crate::Readable for Timg5MisSpec {}
#[doc = "`reset()` method sets TIMG5_MIS to value 0"]
impl crate::Resettable for Timg5MisSpec {}
