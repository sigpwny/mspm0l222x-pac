#[doc = "Register `TIMG5_IMASK` reader"]
pub type R = crate::R<Timg5ImaskSpec>;
#[doc = "Register `TIMG5_IMASK` writer"]
pub type W = crate::W<Timg5ImaskSpec>;
#[doc = "Zero Event mask\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bit 0 - Zero Event mask"]
    #[inline(always)]
    pub fn z(&mut self) -> ZW<'_, Timg5ImaskSpec> {
        ZW::new(self, 0)
    }
    #[doc = "Bit 1 - Load Event mask"]
    #[inline(always)]
    pub fn l(&mut self) -> LW<'_, Timg5ImaskSpec> {
        LW::new(self, 1)
    }
    #[doc = "Bit 4 - Capture or Compare DN event mask CCP0"]
    #[inline(always)]
    pub fn ccd0(&mut self) -> Ccd0W<'_, Timg5ImaskSpec> {
        Ccd0W::new(self, 4)
    }
    #[doc = "Bit 5 - Capture or Compare DN event mask CCP1"]
    #[inline(always)]
    pub fn ccd1(&mut self) -> Ccd1W<'_, Timg5ImaskSpec> {
        Ccd1W::new(self, 5)
    }
    #[doc = "Bit 8 - Capture or Compare UP event mask CCP0"]
    #[inline(always)]
    pub fn ccu0(&mut self) -> Ccu0W<'_, Timg5ImaskSpec> {
        Ccu0W::new(self, 8)
    }
    #[doc = "Bit 9 - Capture or Compare UP event mask CCP1"]
    #[inline(always)]
    pub fn ccu1(&mut self) -> Ccu1W<'_, Timg5ImaskSpec> {
        Ccu1W::new(self, 9)
    }
    #[doc = "Bit 25 - Trigger Overflow Event mask"]
    #[inline(always)]
    pub fn tov(&mut self) -> TovW<'_, Timg5ImaskSpec> {
        TovW::new(self, 25)
    }
}
#[doc = "Interrupt mask\n\nYou can [`read`](crate::Reg::read) this register and get [`timg5_imask::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timg5_imask::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg5ImaskSpec;
impl crate::RegisterSpec for Timg5ImaskSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg5_imask::R`](R) reader structure"]
impl crate::Readable for Timg5ImaskSpec {}
#[doc = "`write(|w| ..)` method takes [`timg5_imask::W`](W) writer structure"]
impl crate::Writable for Timg5ImaskSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMG5_IMASK to value 0"]
impl crate::Resettable for Timg5ImaskSpec {}
