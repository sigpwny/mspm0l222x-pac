#[doc = "Register `TIMG5_CLKSEL` reader"]
pub type R = crate::R<Timg5ClkselSpec>;
#[doc = "Register `TIMG5_CLKSEL` writer"]
pub type W = crate::W<Timg5ClkselSpec>;
...
impl W {
    #[doc = "Bit 1 - Selects LFCLK as clock source if enabled"]
    #[inline(always)]
    pub fn lfclk_sel(&mut self) -> LfclkSelW<'_, Timg5ClkselSpec> {
        LfclkSelW::new(self, 1)
    }
    #[doc = "Bit 2 - Selects MFCLK as clock source if enabled"]
    #[inline(always)]
    pub fn mfclk_sel(&mut self) -> MfclkSelW<'_, Timg5ClkselSpec> {
        MfclkSelW::new(self, 2)
    }
    #[doc = "Bit 3 - Selects BUSCLK as clock source if enabled"]
    #[inline(always)]
    pub fn busclk_sel(&mut self) -> BusclkSelW<'_, Timg5ClkselSpec> {
        BusclkSelW::new(self, 3)
    }
}
#[doc = "Clock Select for Ultra Low Power peripherals\n\nYou can [`read`](crate::Reg::read) this register and get [`timg5_clksel::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timg5_clksel::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg5ClkselSpec;
impl crate::RegisterSpec for Timg5ClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg5_clksel::R`](R) reader structure"]
impl crate::Readable for Timg5ClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`timg5_clksel::W`](W) writer structure"]
impl crate::Writable for Timg5ClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMG5_CLKSEL to value 0"]
impl crate::Resettable for Timg5ClkselSpec {}
