#[doc = "Register `TIMG5_CCACT_01[%s]` reader"]
pub type R = crate::R<Timg5Ccact01Spec>;
#[doc = "Register `TIMG5_CCACT_01[%s]` writer"]
pub type W = crate::W<Timg5Ccact01Spec>;
...
impl W {
    #[doc = "Bits 0:1 - CCP Output Action on Zero Specifies what changes occur to CCP output as the result of a zero event."]
    #[inline(always)]
    pub fn zact(&mut self) -> ZactW<'_, Timg5Ccact01Spec> {
        ZactW::new(self, 0)
    }
    #[doc = "Bits 3:4 - CCP Output Action on Load Specifies what changes occur to CCP output as the result of a load event."]
    #[inline(always)]
    pub fn lact(&mut self) -> LactW<'_, Timg5Ccact01Spec> {
        LactW::new(self, 3)
    }
    #[doc = "Bits 6:7 - CCP Output Action on Compare (Down) This field describes the resulting action of the signal generator upon detecting a compare event while counting down."]
    #[inline(always)]
    pub fn cdact(&mut self) -> CdactW<'_, Timg5Ccact01Spec> {
        CdactW::new(self, 6)
    }
    #[doc = "Bits 9:10 - CCP Output Action on Compare (Up) This field describes the resulting action of the signal generator upon detecting a compare event while counting up."]
    #[inline(always)]
    pub fn cuact(&mut self) -> CuactW<'_, Timg5Ccact01Spec> {
        CuactW::new(self, 9)
    }
    #[doc = "Bits 12:13 - CCP Output Action on CC2D event."]
    #[inline(always)]
    pub fn cc2dact(&mut self) -> Cc2dactW<'_, Timg5Ccact01Spec> {
        Cc2dactW::new(self, 12)
    }
    #[doc = "Bits 15:16 - CCP Output Action on CC2U event."]
    #[inline(always)]
    pub fn cc2uact(&mut self) -> Cc2uactW<'_, Timg5Ccact01Spec> {
        Cc2uactW::new(self, 15)
    }
    #[doc = "Bits 28:29 - CCP Output Action on Software Force Output This field describes the resulting action of software force. This action has a shadow register, which will be updated under specific condition. So that this register cannot take into effect immediately."]
    #[inline(always)]
    pub fn swfrcact(&mut self) -> SwfrcactW<'_, Timg5Ccact01Spec> {
        SwfrcactW::new(self, 28)
    }
}
#[doc = "Capture or Compare Action Registers\n\nYou can [`read`](crate::Reg::read) this register and get [`timg5_ccact_01::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timg5_ccact_01::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg5Ccact01Spec;
impl crate::RegisterSpec for Timg5Ccact01Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg5_ccact_01::R`](R) reader structure"]
impl crate::Readable for Timg5Ccact01Spec {}
#[doc = "`write(|w| ..)` method takes [`timg5_ccact_01::W`](W) writer structure"]
impl crate::Writable for Timg5Ccact01Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMG5_CCACT_01[%s] to value 0"]
impl crate::Resettable for Timg5Ccact01Spec {}
