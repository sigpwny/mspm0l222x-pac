#[doc = "Register `TIMG5_PDBGCTL` reader"]
pub type R = crate::R<Timg5PdbgctlSpec>;
#[doc = "Register `TIMG5_PDBGCTL` writer"]
pub type W = crate::W<Timg5PdbgctlSpec>;
...
impl W {
    #[doc = "Bit 0 - Free run control"]
    #[inline(always)]
    pub fn free(&mut self) -> FreeW<'_, Timg5PdbgctlSpec> {
        FreeW::new(self, 0)
    }
    #[doc = "Bit 1 - Soft halt boundary control. This function is only available, if \\[FREE\\] is set to 'STOP'"]
    #[inline(always)]
    pub fn soft(&mut self) -> SoftW<'_, Timg5PdbgctlSpec> {
        SoftW::new(self, 1)
    }
}
#[doc = "Peripheral Debug Control\n\nYou can [`read`](crate::Reg::read) this register and get [`timg5_pdbgctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timg5_pdbgctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg5PdbgctlSpec;
impl crate::RegisterSpec for Timg5PdbgctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg5_pdbgctl::R`](R) reader structure"]
impl crate::Readable for Timg5PdbgctlSpec {}
#[doc = "`write(|w| ..)` method takes [`timg5_pdbgctl::W`](W) writer structure"]
impl crate::Writable for Timg5PdbgctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMG5_PDBGCTL to value 0"]
impl crate::Resettable for Timg5PdbgctlSpec {}
