#[doc = "Register `TIMG5_DESC` reader"]
pub type R = crate::R<Timg5DescSpec>;
...
#[doc = "Module Description\n\nYou can [`read`](crate::Reg::read) this register and get [`timg5_desc::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg5DescSpec;
impl crate::RegisterSpec for Timg5DescSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg5_desc::R`](R) reader structure"]
impl crate::Readable for Timg5DescSpec {}
#[doc = "`reset()` method sets TIMG5_DESC to value 0"]
impl crate::Resettable for Timg5DescSpec {}
