#[doc = "Register `TIMG5_STAT` reader"]
pub type R = crate::R<Timg5StatSpec>;
...
#[doc = "Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`timg5_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg5StatSpec;
impl crate::RegisterSpec for Timg5StatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg5_stat::R`](R) reader structure"]
impl crate::Readable for Timg5StatSpec {}
#[doc = "`reset()` method sets TIMG5_STAT to value 0"]
impl crate::Resettable for Timg5StatSpec {}
