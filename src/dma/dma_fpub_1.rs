#[doc = "Register `DMA_FPUB_1` reader"]
pub type R = crate::R<DmaFpub1Spec>;
#[doc = "Register `DMA_FPUB_1` writer"]
pub type W = crate::W<DmaFpub1Spec>;
...
impl W {
    #[doc = "Bits 0:3 - 0 = disconnected. 1-255 = connected to channelID = CHANID."]
    #[inline(always)]
    pub fn chanid(&mut self) -> ChanidW<'_, DmaFpub1Spec> {
        ChanidW::new(self, 0)
    }
}
#[doc = "Publisher Port 0\n\nYou can [`read`](crate::Reg::read) this register and get [`dma_fpub_1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dma_fpub_1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DmaFpub1Spec;
impl crate::RegisterSpec for DmaFpub1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dma_fpub_1::R`](R) reader structure"]
impl crate::Readable for DmaFpub1Spec {}
#[doc = "`write(|w| ..)` method takes [`dma_fpub_1::W`](W) writer structure"]
impl crate::Writable for DmaFpub1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DMA_FPUB_1 to value 0"]
impl crate::Resettable for DmaFpub1Spec {}
