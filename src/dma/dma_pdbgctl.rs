#[doc = "Register `DMA_PDBGCTL` reader"]
pub type R = crate::R<DmaPdbgctlSpec>;
#[doc = "Register `DMA_PDBGCTL` writer"]
pub type W = crate::W<DmaPdbgctlSpec>;
...
impl W {
    #[doc = "Bit 0 - Free run control"]
    #[inline(always)]
    pub fn free(&mut self) -> FreeW<'_, DmaPdbgctlSpec> {
        FreeW::new(self, 0)
    }
    #[doc = "Bit 1 - Soft halt boundary control. This function is only available, if \\[FREE\\] is set to 'STOP'"]
    #[inline(always)]
    pub fn soft(&mut self) -> SoftW<'_, DmaPdbgctlSpec> {
        SoftW::new(self, 1)
    }
}
#[doc = "Peripheral Debug Control\n\nYou can [`read`](crate::Reg::read) this register and get [`dma_pdbgctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dma_pdbgctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DmaPdbgctlSpec;
impl crate::RegisterSpec for DmaPdbgctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dma_pdbgctl::R`](R) reader structure"]
impl crate::Readable for DmaPdbgctlSpec {}
#[doc = "`write(|w| ..)` method takes [`dma_pdbgctl::W`](W) writer structure"]
impl crate::Writable for DmaPdbgctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DMA_PDBGCTL to value 0"]
impl crate::Resettable for DmaPdbgctlSpec {}
