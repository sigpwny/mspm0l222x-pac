#[doc = "Register `DMA_CPU_INT_MIS` reader"]
pub type R = crate::R<DmaCpuIntMisSpec>;
...
#[doc = "Masked interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`dma_cpu_int_mis::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DmaCpuIntMisSpec;
impl crate::RegisterSpec for DmaCpuIntMisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dma_cpu_int_mis::R`](R) reader structure"]
impl crate::Readable for DmaCpuIntMisSpec {}
#[doc = "`reset()` method sets DMA_CPU_INT_MIS to value 0"]
impl crate::Resettable for DmaCpuIntMisSpec {}
