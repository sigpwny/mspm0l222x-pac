#[doc = "Register `DMA_CPU_INT_ISET` writer"]
pub type W = crate::W<DmaCpuIntIsetSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn dmach0(&mut self) -> Dmach0W<'_, DmaCpuIntIsetSpec> {
        Dmach0W::new(self, 0)
    }
    #[doc = "Bit 1 - DMA Channel 1 interrupt signals that size counter reached zero (DMASZ=0)."]
    #[inline(always)]
    pub fn dmach1(&mut self) -> Dmach1W<'_, DmaCpuIntIsetSpec> {
        Dmach1W::new(self, 1)
    }
    #[doc = "Bit 2 - DMA Channel 2 interrupt signals that size counter reached zero (DMASZ=0)."]
    #[inline(always)]
    pub fn dmach2(&mut self) -> Dmach2W<'_, DmaCpuIntIsetSpec> {
        Dmach2W::new(self, 2)
    }
    #[doc = "Bit 3 - DMA Channel 3 interrupt signals that size counter reached zero (DMASZ=0)."]
    #[inline(always)]
    pub fn dmach3(&mut self) -> Dmach3W<'_, DmaCpuIntIsetSpec> {
        Dmach3W::new(self, 3)
    }
    #[doc = "Bit 4 - DMA Channel 4 interrupt signals that size counter reached zero (DMASZ=0)."]
    #[inline(always)]
    pub fn dmach4(&mut self) -> Dmach4W<'_, DmaCpuIntIsetSpec> {
        Dmach4W::new(self, 4)
    }
    #[doc = "Bit 5 - DMA Channel 5 interrupt signals that size counter reached zero (DMASZ=0)."]
    #[inline(always)]
    pub fn dmach5(&mut self) -> Dmach5W<'_, DmaCpuIntIsetSpec> {
        Dmach5W::new(self, 5)
    }
    #[doc = "Bit 6 - DMA Channel 6 interrupt signals that size counter reached zero (DMASZ=0)."]
    #[inline(always)]
    pub fn dmach6(&mut self) -> Dmach6W<'_, DmaCpuIntIsetSpec> {
        Dmach6W::new(self, 6)
    }
    #[doc = "Bit 16 - Pre-IRQ for Channel 0. Size counter reached Pre-IRQ threshold."]
    #[inline(always)]
    pub fn preirqch0(&mut self) -> Preirqch0W<'_, DmaCpuIntIsetSpec> {
        Preirqch0W::new(self, 16)
    }
    #[doc = "Bit 17 - Pre-IRQ for Channel 1. Size counter reached Pre-IRQ threshold."]
    #[inline(always)]
    pub fn preirqch1(&mut self) -> Preirqch1W<'_, DmaCpuIntIsetSpec> {
        Preirqch1W::new(self, 17)
    }
    #[doc = "Bit 18 - Pre-IRQ for Channel 2. Size counter reached Pre-IRQ threshold."]
    #[inline(always)]
    pub fn preirqch2(&mut self) -> Preirqch2W<'_, DmaCpuIntIsetSpec> {
        Preirqch2W::new(self, 18)
    }
    #[doc = "Bit 24 - DMA address error, SRC address not reachable."]
    #[inline(always)]
    pub fn addrerr(&mut self) -> AddrerrW<'_, DmaCpuIntIsetSpec> {
        AddrerrW::new(self, 24)
    }
    #[doc = "Bit 25 - DMA data error, SRC data might be corrupted (PAR or ECC error)."]
    #[inline(always)]
    pub fn dataerr(&mut self) -> DataerrW<'_, DmaCpuIntIsetSpec> {
        DataerrW::new(self, 25)
    }
}
#[doc = "Interrupt set\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dma_cpu_int_iset::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DmaCpuIntIsetSpec;
impl crate::RegisterSpec for DmaCpuIntIsetSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`dma_cpu_int_iset::W`](W) writer structure"]
impl crate::Writable for DmaCpuIntIsetSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DMA_CPU_INT_ISET to value 0"]
impl crate::Resettable for DmaCpuIntIsetSpec {}
