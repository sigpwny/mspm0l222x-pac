#[doc = "Register `DMA_CPU_INT_IIDX` reader"]
pub type R = crate::R<DmaCpuIntIidxSpec>;
...
#[doc = "Interrupt index\n\nYou can [`read`](crate::Reg::read) this register and get [`dma_cpu_int_iidx::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DmaCpuIntIidxSpec;
impl crate::RegisterSpec for DmaCpuIntIidxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dma_cpu_int_iidx::R`](R) reader structure"]
impl crate::Readable for DmaCpuIntIidxSpec {}
#[doc = "`reset()` method sets DMA_CPU_INT_IIDX to value 0"]
impl crate::Resettable for DmaCpuIntIidxSpec {}
