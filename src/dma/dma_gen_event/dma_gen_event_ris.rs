#[doc = "Register `DMA_GEN_EVENT_RIS` reader"]
pub type R = crate::R<DmaGenEventRisSpec>;
...
#[doc = "Raw interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`dma_gen_event_ris::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DmaGenEventRisSpec;
impl crate::RegisterSpec for DmaGenEventRisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dma_gen_event_ris::R`](R) reader structure"]
impl crate::Readable for DmaGenEventRisSpec {}
#[doc = "`reset()` method sets DMA_GEN_EVENT_RIS to value 0"]
impl crate::Resettable for DmaGenEventRisSpec {}
