#[doc = "Register `DMA_GEN_EVENT_MIS` reader"]
pub type R = crate::R<DmaGenEventMisSpec>;
...
#[doc = "Masked interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`dma_gen_event_mis::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DmaGenEventMisSpec;
impl crate::RegisterSpec for DmaGenEventMisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dma_gen_event_mis::R`](R) reader structure"]
impl crate::Readable for DmaGenEventMisSpec {}
#[doc = "`reset()` method sets DMA_GEN_EVENT_MIS to value 0"]
impl crate::Resettable for DmaGenEventMisSpec {}
