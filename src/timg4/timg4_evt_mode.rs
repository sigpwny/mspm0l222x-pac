#[doc = "Register `TIMG4_EVT_MODE` reader"]
pub type R = crate::R<Timg4EvtModeSpec>;
#[doc = "Register `TIMG4_EVT_MODE` writer"]
pub type W = crate::W<Timg4EvtModeSpec>;
...
impl W {}
#[doc = "Event Mode\n\nYou can [`read`](crate::Reg::read) this register and get [`timg4_evt_mode::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timg4_evt_mode::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg4EvtModeSpec;
impl crate::RegisterSpec for Timg4EvtModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg4_evt_mode::R`](R) reader structure"]
impl crate::Readable for Timg4EvtModeSpec {}
#[doc = "`write(|w| ..)` method takes [`timg4_evt_mode::W`](W) writer structure"]
impl crate::Writable for Timg4EvtModeSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMG4_EVT_MODE to value 0x29"]
impl crate::Resettable for Timg4EvtModeSpec {
