#[doc = "Register `TIMG4_STAT` reader"]
pub type R = crate::R<Timg4StatSpec>;
...
#[doc = "Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`timg4_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg4StatSpec;
impl crate::RegisterSpec for Timg4StatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg4_stat::R`](R) reader structure"]
impl crate::Readable for Timg4StatSpec {}
#[doc = "`reset()` method sets TIMG4_STAT to value 0"]
impl crate::Resettable for Timg4StatSpec {}
