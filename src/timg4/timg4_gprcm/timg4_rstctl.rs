#[doc = "Register `TIMG4_RSTCTL` writer"]
pub type W = crate::W<Timg4RstctlSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn resetassert(&mut self) -> ResetassertW<'_, Timg4RstctlSpec> {
        ResetassertW::new(self, 0)
    }
    #[doc = "Bit 1 - Clear the RESETSTKY bit in the STAT register"]
    #[inline(always)]
    pub fn resetstkyclr(&mut self) -> ResetstkyclrW<'_, Timg4RstctlSpec> {
        ResetstkyclrW::new(self, 1)
    }
}
#[doc = "Reset Control\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timg4_rstctl::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg4RstctlSpec;
impl crate::RegisterSpec for Timg4RstctlSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`timg4_rstctl::W`](W) writer structure"]
impl crate::Writable for Timg4RstctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMG4_RSTCTL to value 0"]
impl crate::Resettable for Timg4RstctlSpec {}
