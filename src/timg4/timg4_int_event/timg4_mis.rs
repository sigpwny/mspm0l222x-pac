#[doc = "Register `TIMG4_MIS` reader"]
pub type R = crate::R<Timg4MisSpec>;
...
#[doc = "Masked interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`timg4_mis::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg4MisSpec;
impl crate::RegisterSpec for Timg4MisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg4_mis::R`](R) reader structure"]
impl crate::Readable for Timg4MisSpec {}
#[doc = "`reset()` method sets TIMG4_MIS to value 0"]
impl crate::Resettable for Timg4MisSpec {}
