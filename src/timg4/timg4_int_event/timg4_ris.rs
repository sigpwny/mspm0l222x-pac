#[doc = "Register `TIMG4_RIS` reader"]
pub type R = crate::R<Timg4RisSpec>;
...
#[doc = "Raw interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`timg4_ris::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg4RisSpec;
impl crate::RegisterSpec for Timg4RisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg4_ris::R`](R) reader structure"]
impl crate::Readable for Timg4RisSpec {}
#[doc = "`reset()` method sets TIMG4_RIS to value 0"]
impl crate::Resettable for Timg4RisSpec {}
