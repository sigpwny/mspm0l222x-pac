#[doc = "Register `TIMG4_IIDX` reader"]
pub type R = crate::R<Timg4IidxSpec>;
...
#[doc = "Interrupt index\n\nYou can [`read`](crate::Reg::read) this register and get [`timg4_iidx::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg4IidxSpec;
impl crate::RegisterSpec for Timg4IidxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg4_iidx::R`](R) reader structure"]
impl crate::Readable for Timg4IidxSpec {}
#[doc = "`reset()` method sets TIMG4_IIDX to value 0"]
impl crate::Resettable for Timg4IidxSpec {}
