#[doc = "Register `TIMG4_DESC` reader"]
pub type R = crate::R<Timg4DescSpec>;
...
#[doc = "Module Description\n\nYou can [`read`](crate::Reg::read) this register and get [`timg4_desc::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg4DescSpec;
impl crate::RegisterSpec for Timg4DescSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg4_desc::R`](R) reader structure"]
impl crate::Readable for Timg4DescSpec {}
#[doc = "`reset()` method sets TIMG4_DESC to value 0"]
impl crate::Resettable for Timg4DescSpec {}
