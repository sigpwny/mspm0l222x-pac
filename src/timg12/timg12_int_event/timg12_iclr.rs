#[doc = "Register `TIMG12_ICLR` writer"]
pub type W = crate::W<Timg12IclrSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn z(&mut self) -> ZW<'_, Timg12IclrSpec> {
        ZW::new(self, 0)
    }
    #[doc = "Bit 1 - Load event CLEAR"]
    #[inline(always)]
    pub fn l(&mut self) -> LW<'_, Timg12IclrSpec> {
        LW::new(self, 1)
    }
    #[doc = "Bit 4 - Capture or compare down event CLEAR"]
    #[inline(always)]
    pub fn ccd0(&mut self) -> Ccd0W<'_, Timg12IclrSpec> {
        Ccd0W::new(self, 4)
    }
    #[doc = "Bit 5 - Capture or compare down event CLEAR"]
    #[inline(always)]
    pub fn ccd1(&mut self) -> Ccd1W<'_, Timg12IclrSpec> {
        Ccd1W::new(self, 5)
    }
    #[doc = "Bit 8 - Capture or compare up event CLEAR"]
    #[inline(always)]
    pub fn ccu0(&mut self) -> Ccu0W<'_, Timg12IclrSpec> {
        Ccu0W::new(self, 8)
    }
    #[doc = "Bit 9 - Capture or compare up event CLEAR"]
    #[inline(always)]
    pub fn ccu1(&mut self) -> Ccu1W<'_, Timg12IclrSpec> {
        Ccu1W::new(self, 9)
    }
    #[doc = "Bit 25 - Trigger Overflow event CLEAR"]
    #[inline(always)]
    pub fn tov(&mut self) -> TovW<'_, Timg12IclrSpec> {
        TovW::new(self, 25)
    }
}
#[doc = "Interrupt clear\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timg12_iclr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg12IclrSpec;
impl crate::RegisterSpec for Timg12IclrSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`timg12_iclr::W`](W) writer structure"]
impl crate::Writable for Timg12IclrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMG12_ICLR to value 0"]
impl crate::Resettable for Timg12IclrSpec {}
