#[doc = "Register `TIMG12_DESC` reader"]
pub type R = crate::R<Timg12DescSpec>;
...
#[doc = "Module Description\n\nYou can [`read`](crate::Reg::read) this register and get [`timg12_desc::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg12DescSpec;
impl crate::RegisterSpec for Timg12DescSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg12_desc::R`](R) reader structure"]
impl crate::Readable for Timg12DescSpec {}
#[doc = "`reset()` method sets TIMG12_DESC to value 0"]
impl crate::Resettable for Timg12DescSpec {}
