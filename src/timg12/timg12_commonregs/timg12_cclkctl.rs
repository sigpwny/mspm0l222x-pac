#[doc = "Register `TIMG12_CCLKCTL` reader"]
pub type R = crate::R<Timg12CclkctlSpec>;
#[doc = "Register `TIMG12_CCLKCTL` writer"]
pub type W = crate::W<Timg12CclkctlSpec>;
...
impl W {
    #[doc = "Bit 0 - Clock Enable Disables the clock gating to the module. SW has to explicitly program the value to 0 to gate the clock."]
    #[inline(always)]
    pub fn clken(&mut self) -> ClkenW<'_, Timg12CclkctlSpec> {
        ClkenW::new(self, 0)
    }
}
#[doc = "Counter Clock Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`timg12_cclkctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timg12_cclkctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg12CclkctlSpec;
impl crate::RegisterSpec for Timg12CclkctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg12_cclkctl::R`](R) reader structure"]
impl crate::Readable for Timg12CclkctlSpec {}
#[doc = "`write(|w| ..)` method takes [`timg12_cclkctl::W`](W) writer structure"]
impl crate::Writable for Timg12CclkctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMG12_CCLKCTL to value 0"]
impl crate::Resettable for Timg12CclkctlSpec {}
