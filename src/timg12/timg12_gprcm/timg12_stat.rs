#[doc = "Register `TIMG12_STAT` reader"]
pub type R = crate::R<Timg12StatSpec>;
...
#[doc = "Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`timg12_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg12StatSpec;
impl crate::RegisterSpec for Timg12StatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg12_stat::R`](R) reader structure"]
impl crate::Readable for Timg12StatSpec {}
#[doc = "`reset()` method sets TIMG12_STAT to value 0"]
impl crate::Resettable for Timg12StatSpec {}
