#[doc = "Register `TIMG12_RSTCTL` writer"]
pub type W = crate::W<Timg12RstctlSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn resetassert(&mut self) -> ResetassertW<'_, Timg12RstctlSpec> {
        ResetassertW::new(self, 0)
    }
    #[doc = "Bit 1 - Clear the RESETSTKY bit in the STAT register"]
    #[inline(always)]
    pub fn resetstkyclr(&mut self) -> ResetstkyclrW<'_, Timg12RstctlSpec> {
        ResetstkyclrW::new(self, 1)
    }
}
#[doc = "Reset Control\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timg12_rstctl::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg12RstctlSpec;
impl crate::RegisterSpec for Timg12RstctlSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`timg12_rstctl::W`](W) writer structure"]
impl crate::Writable for Timg12RstctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMG12_RSTCTL to value 0"]
impl crate::Resettable for Timg12RstctlSpec {}
