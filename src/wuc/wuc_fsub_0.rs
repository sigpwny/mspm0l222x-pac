#[doc = "Register `WUC_FSUB_0` reader"]
pub type R = crate::R<WucFsub0Spec>;
#[doc = "Register `WUC_FSUB_0` writer"]
pub type W = crate::W<WucFsub0Spec>;
...
impl W {
    #[doc = "Bits 0:3 - 0 = disconnected. 1-15 = connected to channelID = CHANID."]
    #[inline(always)]
    pub fn chanid(&mut self) -> ChanidW<'_, WucFsub0Spec> {
        ChanidW::new(self, 0)
    }
}
#[doc = "Subscriber Port 0\n\nYou can [`read`](crate::Reg::read) this register and get [`wuc_fsub_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`wuc_fsub_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct WucFsub0Spec;
impl crate::RegisterSpec for WucFsub0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`wuc_fsub_0::R`](R) reader structure"]
impl crate::Readable for WucFsub0Spec {}
#[doc = "`write(|w| ..)` method takes [`wuc_fsub_0::W`](W) writer structure"]
impl crate::Writable for WucFsub0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets WUC_FSUB_0 to value 0"]
impl crate::Resettable for WucFsub0Spec {}
