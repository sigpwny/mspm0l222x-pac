#[doc = "Register `WUC_FSUB_1` reader"]
pub type R = crate::R<WucFsub1Spec>;
#[doc = "Register `WUC_FSUB_1` writer"]
pub type W = crate::W<WucFsub1Spec>;
...
impl W {
    #[doc = "Bits 0:3 - 0 = disconnected. 1-15 = connected to channelID = CHANID."]
    #[inline(always)]
    pub fn chanid(&mut self) -> ChanidW<'_, WucFsub1Spec> {
        ChanidW::new(self, 0)
    }
}
#[doc = "Subscriber Port 1\n\nYou can [`read`](crate::Reg::read) this register and get [`wuc_fsub_1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`wuc_fsub_1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct WucFsub1Spec;
impl crate::RegisterSpec for WucFsub1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`wuc_fsub_1::R`](R) reader structure"]
impl crate::Readable for WucFsub1Spec {}
#[doc = "`write(|w| ..)` method takes [`wuc_fsub_1::W`](W) writer structure"]
impl crate::Writable for WucFsub1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets WUC_FSUB_1 to value 0"]
impl crate::Resettable for WucFsub1Spec {}
