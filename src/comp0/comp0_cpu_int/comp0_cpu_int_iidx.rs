#[doc = "Register `COMP0_CPU_INT_IIDX` reader"]
pub type R = crate::R<Comp0CpuIntIidxSpec>;
...
#[doc = "Interrupt index\n\nYou can [`read`](crate::Reg::read) this register and get [`comp0_cpu_int_iidx::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Comp0CpuIntIidxSpec;
impl crate::RegisterSpec for Comp0CpuIntIidxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`comp0_cpu_int_iidx::R`](R) reader structure"]
impl crate::Readable for Comp0CpuIntIidxSpec {}
#[doc = "`reset()` method sets COMP0_CPU_INT_IIDX to value 0"]
impl crate::Resettable for Comp0CpuIntIidxSpec {}
