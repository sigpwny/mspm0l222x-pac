#[doc = "Register `COMP0_FSUB_0` reader"]
pub type R = crate::R<Comp0Fsub0Spec>;
#[doc = "Register `COMP0_FSUB_0` writer"]
pub type W = crate::W<Comp0Fsub0Spec>;
...
impl W {
    #[doc = "Bits 0:3 - 0 = disconnected. 1-15 = connected to channelID = CHANID."]
    #[inline(always)]
    pub fn chanid(&mut self) -> ChanidW<'_, Comp0Fsub0Spec> {
        ChanidW::new(self, 0)
    }
}
#[doc = "Subscriber Port 0\n\nYou can [`read`](crate::Reg::read) this register and get [`comp0_fsub_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`comp0_fsub_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Comp0Fsub0Spec;
impl crate::RegisterSpec for Comp0Fsub0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`comp0_fsub_0::R`](R) reader structure"]
impl crate::Readable for Comp0Fsub0Spec {}
#[doc = "`write(|w| ..)` method takes [`comp0_fsub_0::W`](W) writer structure"]
impl crate::Writable for Comp0Fsub0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets COMP0_FSUB_0 to value 0"]
impl crate::Resettable for Comp0Fsub0Spec {}
