#[doc = "Register `COMP0_GEN_EVENT_IMASK` reader"]
pub type R = crate::R<Comp0GenEventImaskSpec>;
#[doc = "Register `COMP0_GEN_EVENT_IMASK` writer"]
pub type W = crate::W<Comp0GenEventImaskSpec>;
#[doc = "Masks COMPIFG\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bit 1 - Masks COMPIFG"]
    #[inline(always)]
    pub fn compifg(&mut self) -> CompifgW<'_, Comp0GenEventImaskSpec> {
        CompifgW::new(self, 1)
    }
    #[doc = "Bit 2 - Masks COMPINVIFG"]
    #[inline(always)]
    pub fn compinvifg(&mut self) -> CompinvifgW<'_, Comp0GenEventImaskSpec> {
        CompinvifgW::new(self, 2)
    }
    #[doc = "Bit 3 - Masks OUTRDYIFG"]
    #[inline(always)]
    pub fn outrdyifg(&mut self) -> OutrdyifgW<'_, Comp0GenEventImaskSpec> {
        OutrdyifgW::new(self, 3)
    }
}
#[doc = "Interrupt mask\n\nYou can [`read`](crate::Reg::read) this register and get [`comp0_gen_event_imask::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`comp0_gen_event_imask::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Comp0GenEventImaskSpec;
impl crate::RegisterSpec for Comp0GenEventImaskSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`comp0_gen_event_imask::R`](R) reader structure"]
impl crate::Readable for Comp0GenEventImaskSpec {}
#[doc = "`write(|w| ..)` method takes [`comp0_gen_event_imask::W`](W) writer structure"]
impl crate::Writable for Comp0GenEventImaskSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets COMP0_GEN_EVENT_IMASK to value 0"]
impl crate::Resettable for Comp0GenEventImaskSpec {}
