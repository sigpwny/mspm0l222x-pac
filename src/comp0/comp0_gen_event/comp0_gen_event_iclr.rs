#[doc = "Register `COMP0_GEN_EVENT_ICLR` writer"]
pub type W = crate::W<Comp0GenEventIclrSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn compifg(&mut self) -> CompifgW<'_, Comp0GenEventIclrSpec> {
        CompifgW::new(self, 1)
    }
    #[doc = "Bit 2 - Clears COMPINVIFG in RIS register"]
    #[inline(always)]
    pub fn compinvifg(&mut self) -> CompinvifgW<'_, Comp0GenEventIclrSpec> {
        CompinvifgW::new(self, 2)
    }
    #[doc = "Bit 3 - Clears OUTRDYIFG in RIS register"]
    #[inline(always)]
    pub fn outrdyifg(&mut self) -> OutrdyifgW<'_, Comp0GenEventIclrSpec> {
        OutrdyifgW::new(self, 3)
    }
}
#[doc = "Interrupt clear\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`comp0_gen_event_iclr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Comp0GenEventIclrSpec;
impl crate::RegisterSpec for Comp0GenEventIclrSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`comp0_gen_event_iclr::W`](W) writer structure"]
impl crate::Writable for Comp0GenEventIclrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets COMP0_GEN_EVENT_ICLR to value 0"]
impl crate::Resettable for Comp0GenEventIclrSpec {}
