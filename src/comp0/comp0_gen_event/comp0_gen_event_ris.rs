#[doc = "Register `COMP0_GEN_EVENT_RIS` reader"]
pub type R = crate::R<Comp0GenEventRisSpec>;
...
#[doc = "Raw interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`comp0_gen_event_ris::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Comp0GenEventRisSpec;
impl crate::RegisterSpec for Comp0GenEventRisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`comp0_gen_event_ris::R`](R) reader structure"]
impl crate::Readable for Comp0GenEventRisSpec {}
#[doc = "`reset()` method sets COMP0_GEN_EVENT_RIS to value 0"]
impl crate::Resettable for Comp0GenEventRisSpec {}
