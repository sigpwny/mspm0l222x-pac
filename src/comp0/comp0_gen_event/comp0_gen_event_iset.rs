#[doc = "Register `COMP0_GEN_EVENT_ISET` writer"]
pub type W = crate::W<Comp0GenEventIsetSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn compifg(&mut self) -> CompifgW<'_, Comp0GenEventIsetSpec> {
        CompifgW::new(self, 1)
    }
    #[doc = "Bit 2 - Sets COMPINVIFG in RIS register"]
    #[inline(always)]
    pub fn compinvifg(&mut self) -> CompinvifgW<'_, Comp0GenEventIsetSpec> {
        CompinvifgW::new(self, 2)
    }
    #[doc = "Bit 3 - Sets OUTRDYIFG in RIS register"]
    #[inline(always)]
    pub fn outrdyifg(&mut self) -> OutrdyifgW<'_, Comp0GenEventIsetSpec> {
        OutrdyifgW::new(self, 3)
    }
}
#[doc = "Interrupt set\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`comp0_gen_event_iset::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Comp0GenEventIsetSpec;
impl crate::RegisterSpec for Comp0GenEventIsetSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`comp0_gen_event_iset::W`](W) writer structure"]
impl crate::Writable for Comp0GenEventIsetSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets COMP0_GEN_EVENT_ISET to value 0"]
impl crate::Resettable for Comp0GenEventIsetSpec {}
