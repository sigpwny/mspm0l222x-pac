#[doc = "Register `COMP0_GEN_EVENT_MIS` reader"]
pub type R = crate::R<Comp0GenEventMisSpec>;
...
#[doc = "Masked interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`comp0_gen_event_mis::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Comp0GenEventMisSpec;
impl crate::RegisterSpec for Comp0GenEventMisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`comp0_gen_event_mis::R`](R) reader structure"]
impl crate::Readable for Comp0GenEventMisSpec {}
#[doc = "`reset()` method sets COMP0_GEN_EVENT_MIS to value 0"]
impl crate::Resettable for Comp0GenEventMisSpec {}
