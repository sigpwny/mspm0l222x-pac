#[doc = "Register `COMP0_GPRCM_STAT` reader"]
pub type R = crate::R<Comp0GprcmStatSpec>;
...
#[doc = "Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`comp0_gprcm_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Comp0GprcmStatSpec;
impl crate::RegisterSpec for Comp0GprcmStatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`comp0_gprcm_stat::R`](R) reader structure"]
impl crate::Readable for Comp0GprcmStatSpec {}
#[doc = "`reset()` method sets COMP0_GPRCM_STAT to value 0"]
impl crate::Resettable for Comp0GprcmStatSpec {}
