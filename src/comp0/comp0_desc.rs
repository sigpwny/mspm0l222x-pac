#[doc = "Register `COMP0_DESC` reader"]
pub type R = crate::R<Comp0DescSpec>;
...
#[doc = "Module Description\n\nYou can [`read`](crate::Reg::read) this register and get [`comp0_desc::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Comp0DescSpec;
impl crate::RegisterSpec for Comp0DescSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`comp0_desc::R`](R) reader structure"]
impl crate::Readable for Comp0DescSpec {}
#[doc = "`reset()` method sets COMP0_DESC to value 0"]
impl crate::Resettable for Comp0DescSpec {}
