#[doc = "Register `EVENTLP_PUBCFG_DESC` reader"]
pub type R = crate::R<EventlpPubcfgDescSpec>;
...
#[doc = "Module Description\n\nYou can [`read`](crate::Reg::read) this register and get [`eventlp_pubcfg_desc::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EventlpPubcfgDescSpec;
impl crate::RegisterSpec for EventlpPubcfgDescSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eventlp_pubcfg_desc::R`](R) reader structure"]
impl crate::Readable for EventlpPubcfgDescSpec {}
#[doc = "`reset()` method sets EVENTLP_PUBCFG_DESC to value 0"]
impl crate::Resettable for EventlpPubcfgDescSpec {}
