#[doc = "Register `EVENTLP_SECCFG_DESC_EX` reader"]
pub type R = crate::R<EventlpSeccfgDescExSpec>;
...
#[doc = "Extended Module Description\n\nYou can [`read`](crate::Reg::read) this register and get [`eventlp_seccfg_desc_ex::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EventlpSeccfgDescExSpec;
impl crate::RegisterSpec for EventlpSeccfgDescExSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eventlp_seccfg_desc_ex::R`](R) reader structure"]
impl crate::Readable for EventlpSeccfgDescExSpec {}
#[doc = "`reset()` method sets EVENTLP_SECCFG_DESC_EX to value 0"]
impl crate::Resettable for EventlpSeccfgDescExSpec {}
