#[doc = "Register `EVENTLP_SECCFG_DESC` reader"]
pub type R = crate::R<EventlpSeccfgDescSpec>;
...
#[doc = "Module Description\n\nYou can [`read`](crate::Reg::read) this register and get [`eventlp_seccfg_desc::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EventlpSeccfgDescSpec;
impl crate::RegisterSpec for EventlpSeccfgDescSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eventlp_seccfg_desc::R`](R) reader structure"]
impl crate::Readable for EventlpSeccfgDescSpec {}
#[doc = "`reset()` method sets EVENTLP_SECCFG_DESC to value 0"]
impl crate::Resettable for EventlpSeccfgDescSpec {}
