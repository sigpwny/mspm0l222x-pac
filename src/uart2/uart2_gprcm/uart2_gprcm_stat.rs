#[doc = "Register `UART2_GPRCM_STAT` reader"]
pub type R = crate::R<Uart2GprcmStatSpec>;
...
#[doc = "Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uart2_gprcm_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart2GprcmStatSpec;
impl crate::RegisterSpec for Uart2GprcmStatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart2_gprcm_stat::R`](R) reader structure"]
impl crate::Readable for Uart2GprcmStatSpec {}
#[doc = "`reset()` method sets UART2_GPRCM_STAT to value 0"]
impl crate::Resettable for Uart2GprcmStatSpec {}
