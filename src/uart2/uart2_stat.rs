#[doc = "Register `UART2_STAT` reader"]
pub type R = crate::R<Uart2StatSpec>;
...
#[doc = "UART Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uart2_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart2StatSpec;
impl crate::RegisterSpec for Uart2StatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart2_stat::R`](R) reader structure"]
impl crate::Readable for Uart2StatSpec {}
#[doc = "`reset()` method sets UART2_STAT to value 0"]
impl crate::Resettable for Uart2StatSpec {}
