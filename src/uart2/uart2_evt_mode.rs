#[doc = "Register `UART2_EVT_MODE` reader"]
pub type R = crate::R<Uart2EvtModeSpec>;
#[doc = "Register `UART2_EVT_MODE` writer"]
pub type W = crate::W<Uart2EvtModeSpec>;
...
impl W {}
#[doc = "Event Mode\n\nYou can [`read`](crate::Reg::read) this register and get [`uart2_evt_mode::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uart2_evt_mode::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart2EvtModeSpec;
impl crate::RegisterSpec for Uart2EvtModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart2_evt_mode::R`](R) reader structure"]
impl crate::Readable for Uart2EvtModeSpec {}
#[doc = "`write(|w| ..)` method takes [`uart2_evt_mode::W`](W) writer structure"]
impl crate::Writable for Uart2EvtModeSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UART2_EVT_MODE to value 0"]
impl crate::Resettable for Uart2EvtModeSpec {}
