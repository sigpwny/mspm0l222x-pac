#[doc = "Register `UART2_INT_EVENT1_IIDX` reader"]
pub type R = crate::R<Uart2IntEvent1IidxSpec>;
...
#[doc = "Interrupt index\n\nYou can [`read`](crate::Reg::read) this register and get [`uart2_int_event1_iidx::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart2IntEvent1IidxSpec;
impl crate::RegisterSpec for Uart2IntEvent1IidxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart2_int_event1_iidx::R`](R) reader structure"]
impl crate::Readable for Uart2IntEvent1IidxSpec {}
#[doc = "`reset()` method sets UART2_INT_EVENT1_IIDX to value 0"]
impl crate::Resettable for Uart2IntEvent1IidxSpec {}
