#[doc = "Register `UART2_INT_EVENT1_IMASK` reader"]
pub type R = crate::R<Uart2IntEvent1ImaskSpec>;
#[doc = "Register `UART2_INT_EVENT1_IMASK` writer"]
pub type W = crate::W<Uart2IntEvent1ImaskSpec>;
...
impl W {
    #[doc = "Bit 0 - Enable UARTOUT Receive Time-Out Interrupt."]
    #[inline(always)]
    pub fn rtout(&mut self) -> RtoutW<'_, Uart2IntEvent1ImaskSpec> {
        RtoutW::new(self, 0)
    }
    #[doc = "Bit 10 - Enable UART Receive Interrupt."]
    #[inline(always)]
    pub fn rxint(&mut self) -> RxintW<'_, Uart2IntEvent1ImaskSpec> {
        RxintW::new(self, 10)
    }
}
#[doc = "Interrupt mask\n\nYou can [`read`](crate::Reg::read) this register and get [`uart2_int_event1_imask::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uart2_int_event1_imask::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart2IntEvent1ImaskSpec;
impl crate::RegisterSpec for Uart2IntEvent1ImaskSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart2_int_event1_imask::R`](R) reader structure"]
impl crate::Readable for Uart2IntEvent1ImaskSpec {}
#[doc = "`write(|w| ..)` method takes [`uart2_int_event1_imask::W`](W) writer structure"]
impl crate::Writable for Uart2IntEvent1ImaskSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UART2_INT_EVENT1_IMASK to value 0"]
impl crate::Resettable for Uart2IntEvent1ImaskSpec {}
