#[doc = "Register `UART2_INT_EVENT0_MIS` reader"]
pub type R = crate::R<Uart2IntEvent0MisSpec>;
...
#[doc = "Masked interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`uart2_int_event0_mis::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart2IntEvent0MisSpec;
impl crate::RegisterSpec for Uart2IntEvent0MisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart2_int_event0_mis::R`](R) reader structure"]
impl crate::Readable for Uart2IntEvent0MisSpec {}
#[doc = "`reset()` method sets UART2_INT_EVENT0_MIS to value 0"]
impl crate::Resettable for Uart2IntEvent0MisSpec {}
