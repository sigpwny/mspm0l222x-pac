#[doc = "Register `UART2_RXDATA` reader"]
pub type R = crate::R<Uart2RxdataSpec>;
...
#[doc = "UART Receive Data Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uart2_rxdata::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart2RxdataSpec;
impl crate::RegisterSpec for Uart2RxdataSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart2_rxdata::R`](R) reader structure"]
impl crate::Readable for Uart2RxdataSpec {}
#[doc = "`reset()` method sets UART2_RXDATA to value 0"]
impl crate::Resettable for Uart2RxdataSpec {}
