#[doc = "Register `UART2_CLKSEL` reader"]
pub type R = crate::R<Uart2ClkselSpec>;
#[doc = "Register `UART2_CLKSEL` writer"]
pub type W = crate::W<Uart2ClkselSpec>;
...
impl W {
    #[doc = "Bit 1 - Selects LFCLK as clock source if enabled"]
    #[inline(always)]
    pub fn lfclk_sel(&mut self) -> LfclkSelW<'_, Uart2ClkselSpec> {
        LfclkSelW::new(self, 1)
    }
    #[doc = "Bit 2 - Selects MFCLK as clock source if enabled"]
    #[inline(always)]
    pub fn mfclk_sel(&mut self) -> MfclkSelW<'_, Uart2ClkselSpec> {
        MfclkSelW::new(self, 2)
    }
    #[doc = "Bit 3 - Selects BUS CLK as clock source if enabled"]
    #[inline(always)]
    pub fn busclk_sel(&mut self) -> BusclkSelW<'_, Uart2ClkselSpec> {
        BusclkSelW::new(self, 3)
    }
}
#[doc = "Clock Select for Ultra Low Power peripherals\n\nYou can [`read`](crate::Reg::read) this register and get [`uart2_clksel::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uart2_clksel::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart2ClkselSpec;
impl crate::RegisterSpec for Uart2ClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart2_clksel::R`](R) reader structure"]
impl crate::Readable for Uart2ClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`uart2_clksel::W`](W) writer structure"]
impl crate::Writable for Uart2ClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UART2_CLKSEL to value 0"]
impl crate::Resettable for Uart2ClkselSpec {}
