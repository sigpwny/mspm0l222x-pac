#[doc = "Register `LCD_EVT_MODE` reader"]
pub type R = crate::R<LcdEvtModeSpec>;
#[doc = "Register `LCD_EVT_MODE` writer"]
pub type W = crate::W<LcdEvtModeSpec>;
...
impl W {}
#[doc = "Event Mode\n\nYou can [`read`](crate::Reg::read) this register and get [`lcd_evt_mode::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lcd_evt_mode::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LcdEvtModeSpec;
impl crate::RegisterSpec for LcdEvtModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lcd_evt_mode::R`](R) reader structure"]
impl crate::Readable for LcdEvtModeSpec {}
#[doc = "`write(|w| ..)` method takes [`lcd_evt_mode::W`](W) writer structure"]
impl crate::Writable for LcdEvtModeSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LCD_EVT_MODE to value 0"]
impl crate::Resettable for LcdEvtModeSpec {}
