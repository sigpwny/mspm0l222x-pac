#[doc = "Register `LCD_STAT` reader"]
pub type R = crate::R<LcdStatSpec>;
...
#[doc = "Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`lcd_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LcdStatSpec;
impl crate::RegisterSpec for LcdStatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lcd_stat::R`](R) reader structure"]
impl crate::Readable for LcdStatSpec {}
#[doc = "`reset()` method sets LCD_STAT to value 0"]
impl crate::Resettable for LcdStatSpec {}
