#[doc = "Register `LCD_RSTCTL` writer"]
pub type W = crate::W<LcdRstctlSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn resetassert(&mut self) -> ResetassertW<'_, LcdRstctlSpec> {
        ResetassertW::new(self, 0)
    }
    #[doc = "Bit 1 - Clear the RESETSTKY bit in the STAT register"]
    #[inline(always)]
    pub fn resetstkyclr(&mut self) -> ResetstkyclrW<'_, LcdRstctlSpec> {
        ResetstkyclrW::new(self, 1)
    }
}
#[doc = "Reset Control\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lcd_rstctl::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LcdRstctlSpec;
impl crate::RegisterSpec for LcdRstctlSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`lcd_rstctl::W`](W) writer structure"]
impl crate::Writable for LcdRstctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LCD_RSTCTL to value 0"]
impl crate::Resettable for LcdRstctlSpec {}
