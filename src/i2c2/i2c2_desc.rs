#[doc = "Register `I2C2_DESC` reader"]
pub type R = crate::R<I2c2DescSpec>;
...
#[doc = "Module Description\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c2_desc::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c2DescSpec;
impl crate::RegisterSpec for I2c2DescSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c2_desc::R`](R) reader structure"]
impl crate::Readable for I2c2DescSpec {}
#[doc = "`reset()` method sets I2C2_DESC to value 0"]
impl crate::Resettable for I2c2DescSpec {}
