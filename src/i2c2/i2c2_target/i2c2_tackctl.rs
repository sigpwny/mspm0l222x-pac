#[doc = "Register `I2C2_TACKCTL` reader"]
pub type R = crate::R<I2c2TackctlSpec>;
#[doc = "Register `I2C2_TACKCTL` writer"]
pub type W = crate::W<I2c2TackctlSpec>;
...
impl W {
    #[doc = "Bit 0 - I2C Target ACK Override Enable"]
    #[inline(always)]
    pub fn ackoen(&mut self) -> AckoenW<'_, I2c2TackctlSpec> {
        AckoenW::new(self, 0)
    }
    #[doc = "Bit 1 - I2C Target ACK Override Value Note: for General Call this bit will be ignored if set to NACK and Target continues to receive data."]
    #[inline(always)]
    pub fn ackoval(&mut self) -> AckovalW<'_, I2c2TackctlSpec> {
        AckovalW::new(self, 1)
    }
    #[doc = "Bit 2 - When set this bit will automatically turn on the Target ACKOEN field following a Start Condition."]
    #[inline(always)]
    pub fn ackoen_on_start(&mut self) -> AckoenOnStartW<'_, I2c2TackctlSpec> {
        AckoenOnStartW::new(self, 2)
    }
    #[doc = "Bit 3 - When set this bit will automatically turn on the Target ACKOEN field following the ACK/NACK of the byte received just prior to the PEC byte. Note that when ACKOEN is set the PEC byte will not automatically be ACKed/NACKed by the State Machine and FW must perform this function by writing Target_SACKCTL."]
    #[inline(always)]
    pub fn ackoen_on_pecnext(&mut self) -> AckoenOnPecnextW<'_, I2c2TackctlSpec> {
        AckoenOnPecnextW::new(self, 3)
    }
    #[doc = "Bit 4 - When set this bit will automatically turn on the Target ACKOEN field following the ACK/NACK of the received PEC byte."]
    #[inline(always)]
    pub fn ackoen_on_pecdone(&mut self) -> AckoenOnPecdoneW<'_, I2c2TackctlSpec> {
        AckoenOnPecdoneW::new(self, 4)
    }
}
#[doc = "I2C Target ACK Control\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c2_tackctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i2c2_tackctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c2TackctlSpec;
impl crate::RegisterSpec for I2c2TackctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c2_tackctl::R`](R) reader structure"]
impl crate::Readable for I2c2TackctlSpec {}
#[doc = "`write(|w| ..)` method takes [`i2c2_tackctl::W`](W) writer structure"]
impl crate::Writable for I2c2TackctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I2C2_TACKCTL to value 0"]
impl crate::Resettable for I2c2TackctlSpec {}
