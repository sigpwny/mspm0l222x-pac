#[doc = "Register `I2C2_TSR` reader"]
pub type R = crate::R<I2c2TsrSpec>;
#[doc = "Receive Request\n\nValue on reset: 0"]
...
#[doc = "I2C Target Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c2_tsr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c2TsrSpec;
impl crate::RegisterSpec for I2c2TsrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c2_tsr::R`](R) reader structure"]
impl crate::Readable for I2c2TsrSpec {}
#[doc = "`reset()` method sets I2C2_TSR to value 0"]
impl crate::Resettable for I2c2TsrSpec {}
