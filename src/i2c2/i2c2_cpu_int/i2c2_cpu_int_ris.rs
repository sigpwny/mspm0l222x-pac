#[doc = "Register `I2C2_CPU_INT_RIS` reader"]
pub type R = crate::R<I2c2CpuIntRisSpec>;
...
#[doc = "Raw interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c2_cpu_int_ris::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c2CpuIntRisSpec;
impl crate::RegisterSpec for I2c2CpuIntRisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c2_cpu_int_ris::R`](R) reader structure"]
impl crate::Readable for I2c2CpuIntRisSpec {}
#[doc = "`reset()` method sets I2C2_CPU_INT_RIS to value 0"]
impl crate::Resettable for I2c2CpuIntRisSpec {}
