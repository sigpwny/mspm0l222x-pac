#[doc = "Register `I2C2_CPU_INT_IMASK` reader"]
pub type R = crate::R<I2c2CpuIntImaskSpec>;
#[doc = "Register `I2C2_CPU_INT_IMASK` writer"]
pub type W = crate::W<I2c2CpuIntImaskSpec>;
...
impl W {
    #[doc = "Bit 0 - Controller Receive Transaction completed Interrupt"]
    #[inline(always)]
    pub fn crxdone(&mut self) -> CrxdoneW<'_, I2c2CpuIntImaskSpec> {
        CrxdoneW::new(self, 0)
    }
    #[doc = "Bit 1 - Controller Transmit Transaction completed Interrupt"]
    #[inline(always)]
    pub fn ctxdone(&mut self) -> CtxdoneW<'_, I2c2CpuIntImaskSpec> {
        CtxdoneW::new(self, 1)
    }
    #[doc = "Bit 2 - Controller Receive FIFO Trigger Trigger when RX FIFO contains >= defined bytes"]
    #[inline(always)]
    pub fn crxfifotrg(&mut self) -> CrxfifotrgW<'_, I2c2CpuIntImaskSpec> {
        CrxfifotrgW::new(self, 2)
    }
    #[doc = "Bit 3 - Controller Transmit FIFO Trigger Trigger when Transmit FIFO contains <= defined bytes"]
    #[inline(always)]
    pub fn ctxfifotrg(&mut self) -> CtxfifotrgW<'_, I2c2CpuIntImaskSpec> {
        CtxfifotrgW::new(self, 3)
    }
    #[doc = "Bit 4 - RXFIFO full event. This interrupt is set if an RX FIFO is full."]
    #[inline(always)]
    pub fn crxfifofull(&mut self) -> CrxfifofullW<'_, I2c2CpuIntImaskSpec> {
        CrxfifofullW::new(self, 4)
    }
    #[doc = "Bit 5 - Transmit FIFO Empty interrupt mask. This interrupt is set if all data in the Transmit FIFO have been shifted out and the transmit goes into idle mode."]
    #[inline(always)]
    pub fn ctxempty(&mut self) -> CtxemptyW<'_, I2c2CpuIntImaskSpec> {
        CtxemptyW::new(self, 5)
    }
    #[doc = "Bit 7 - Address/Data NACK Interrupt"]
    #[inline(always)]
    pub fn cnack(&mut self) -> CnackW<'_, I2c2CpuIntImaskSpec> {
        CnackW::new(self, 7)
    }
    #[doc = "Bit 8 - START Detection Interrupt"]
    #[inline(always)]
    pub fn cstart(&mut self) -> CstartW<'_, I2c2CpuIntImaskSpec> {
        CstartW::new(self, 8)
    }
    #[doc = "Bit 9 - STOP Detection Interrupt"]
    #[inline(always)]
    pub fn cstop(&mut self) -> CstopW<'_, I2c2CpuIntImaskSpec> {
        CstopW::new(self, 9)
    }
    #[doc = "Bit 10 - Arbitration Lost Interrupt"]
    #[inline(always)]
    pub fn carblost(&mut self) -> CarblostW<'_, I2c2CpuIntImaskSpec> {
        CarblostW::new(self, 10)
    }
    #[doc = "Bit 11 - DMA Done on Event Channel TX"]
    #[inline(always)]
    pub fn cdma_done_tx(&mut self) -> CdmaDoneTxW<'_, I2c2CpuIntImaskSpec> {
        CdmaDoneTxW::new(self, 11)
    }
    #[doc = "Bit 12 - DMA Done on Event Channel RX"]
    #[inline(always)]
    pub fn cdma_done_rx(&mut self) -> CdmaDoneRxW<'_, I2c2CpuIntImaskSpec> {
        CdmaDoneRxW::new(self, 12)
    }
    #[doc = "Bit 13 - Controller RX Pec Error Interrupt"]
    #[inline(always)]
    pub fn cpec_rx_err(&mut self) -> CpecRxErrW<'_, I2c2CpuIntImaskSpec> {
        CpecRxErrW::new(self, 13)
    }
    #[doc = "Bit 14 - Timeout A Interrupt"]
    #[inline(always)]
    pub fn timeouta(&mut self) -> TimeoutaW<'_, I2c2CpuIntImaskSpec> {
        TimeoutaW::new(self, 14)
    }
    #[doc = "Bit 15 - Timeout B Interrupt"]
    #[inline(always)]
    pub fn timeoutb(&mut self) -> TimeoutbW<'_, I2c2CpuIntImaskSpec> {
        TimeoutbW::new(self, 15)
    }
    #[doc = "Bit 16 - Target Receive Data Interrupt Signals that a byte has been received"]
    #[inline(always)]
    pub fn trxdone(&mut self) -> TrxdoneW<'_, I2c2CpuIntImaskSpec> {
        TrxdoneW::new(self, 16)
    }
    #[doc = "Bit 17 - Target Transmit Transaction completed Interrupt"]
    #[inline(always)]
    pub fn ttxdone(&mut self) -> TtxdoneW<'_, I2c2CpuIntImaskSpec> {
        TtxdoneW::new(self, 17)
    }
    #[doc = "Bit 18 - Target Receive FIFO Trigger"]
    #[inline(always)]
    pub fn trxfifotrg(&mut self) -> TrxfifotrgW<'_, I2c2CpuIntImaskSpec> {
        TrxfifotrgW::new(self, 18)
    }
    #[doc = "Bit 19 - Target Transmit FIFO Trigger"]
    #[inline(always)]
    pub fn ttxfifotrg(&mut self) -> TtxfifotrgW<'_, I2c2CpuIntImaskSpec> {
        TtxfifotrgW::new(self, 19)
    }
    #[doc = "Bit 20 - RXFIFO full event. This interrupt is set if an Target RX FIFO is full."]
    #[inline(always)]
    pub fn trxfifofull(&mut self) -> TrxfifofullW<'_, I2c2CpuIntImaskSpec> {
        TrxfifofullW::new(self, 20)
    }
    #[doc = "Bit 21 - Target Transmit FIFO Empty interrupt mask. This interrupt is set if all data in the Transmit FIFO have been shifted out and the transmit goes into idle mode."]
    #[inline(always)]
    pub fn ttxempty(&mut self) -> TtxemptyW<'_, I2c2CpuIntImaskSpec> {
        TtxemptyW::new(self, 21)
    }
    #[doc = "Bit 22 - Start Condition Interrupt"]
    #[inline(always)]
    pub fn tstart(&mut self) -> TstartW<'_, I2c2CpuIntImaskSpec> {
        TstartW::new(self, 22)
    }
    #[doc = "Bit 23 - Stop Condition Interrupt"]
    #[inline(always)]
    pub fn tstop(&mut self) -> TstopW<'_, I2c2CpuIntImaskSpec> {
        TstopW::new(self, 23)
    }
    #[doc = "Bit 24 - General Call Interrupt"]
    #[inline(always)]
    pub fn tgencall(&mut self) -> TgencallW<'_, I2c2CpuIntImaskSpec> {
        TgencallW::new(self, 24)
    }
    #[doc = "Bit 25 - Target DMA Done on Event Channel TX"]
    #[inline(always)]
    pub fn tdma_done_tx(&mut self) -> TdmaDoneTxW<'_, I2c2CpuIntImaskSpec> {
        TdmaDoneTxW::new(self, 25)
    }
    #[doc = "Bit 26 - Target DMA Done on Event Channel RX"]
    #[inline(always)]
    pub fn tdma_done_rx(&mut self) -> TdmaDoneRxW<'_, I2c2CpuIntImaskSpec> {
        TdmaDoneRxW::new(self, 26)
    }
    #[doc = "Bit 27 - Target RX Pec Error Interrupt"]
    #[inline(always)]
    pub fn tpec_rx_err(&mut self) -> TpecRxErrW<'_, I2c2CpuIntImaskSpec> {
        TpecRxErrW::new(self, 27)
    }
    #[doc = "Bit 28 - Target TX FIFO underflow"]
    #[inline(always)]
    pub fn ttx_unfl(&mut self) -> TtxUnflW<'_, I2c2CpuIntImaskSpec> {
        TtxUnflW::new(self, 28)
    }
    #[doc = "Bit 29 - Target RX FIFO overflow"]
    #[inline(always)]
    pub fn trx_ovfl(&mut self) -> TrxOvflW<'_, I2c2CpuIntImaskSpec> {
        TrxOvflW::new(self, 29)
    }
    #[doc = "Bit 30 - Target Arbitration Lost"]
    #[inline(always)]
    pub fn tarblost(&mut self) -> TarblostW<'_, I2c2CpuIntImaskSpec> {
        TarblostW::new(self, 30)
    }
    #[doc = "Bit 31 - Interrupt Overflow Interrupt Mask"]
    #[inline(always)]
    pub fn intr_ovfl(&mut self) -> IntrOvflW<'_, I2c2CpuIntImaskSpec> {
        IntrOvflW::new(self, 31)
    }
}
#[doc = "Interrupt mask\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c2_cpu_int_imask::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i2c2_cpu_int_imask::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c2CpuIntImaskSpec;
impl crate::RegisterSpec for I2c2CpuIntImaskSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c2_cpu_int_imask::R`](R) reader structure"]
impl crate::Readable for I2c2CpuIntImaskSpec {}
#[doc = "`write(|w| ..)` method takes [`i2c2_cpu_int_imask::W`](W) writer structure"]
impl crate::Writable for I2c2CpuIntImaskSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I2C2_CPU_INT_IMASK to value 0"]
impl crate::Resettable for I2c2CpuIntImaskSpec {}
