#[doc = "Register `I2C2_CPU_INT_ICLR` writer"]
pub type W = crate::W<I2c2CpuIntIclrSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn ttxempty(&mut self) -> TtxemptyW<'_, I2c2CpuIntIclrSpec> {
        TtxemptyW::new(self, 21)
    }
    #[doc = "Bit 22 - Target START Detection Interrupt"]
    #[inline(always)]
    pub fn tstart(&mut self) -> TstartW<'_, I2c2CpuIntIclrSpec> {
        TstartW::new(self, 22)
    }
    #[doc = "Bit 23 - Target STOP Detection Interrupt"]
    #[inline(always)]
    pub fn tstop(&mut self) -> TstopW<'_, I2c2CpuIntIclrSpec> {
        TstopW::new(self, 23)
    }
    #[doc = "Bit 24 - General Call Interrupt"]
    #[inline(always)]
    pub fn tgencall(&mut self) -> TgencallW<'_, I2c2CpuIntIclrSpec> {
        TgencallW::new(self, 24)
    }
    #[doc = "Bit 25 - DMA Done on Event Channel TX"]
    #[inline(always)]
    pub fn tdma_done_tx(&mut self) -> TdmaDoneTxW<'_, I2c2CpuIntIclrSpec> {
        TdmaDoneTxW::new(self, 25)
    }
    #[doc = "Bit 26 - DMA Done on Event Channel RX"]
    #[inline(always)]
    pub fn tdma_done_rx(&mut self) -> TdmaDoneRxW<'_, I2c2CpuIntIclrSpec> {
        TdmaDoneRxW::new(self, 26)
    }
    #[doc = "Bit 27 - Target RX Pec Error Interrupt"]
    #[inline(always)]
    pub fn tpec_rx_err(&mut self) -> TpecRxErrW<'_, I2c2CpuIntIclrSpec> {
        TpecRxErrW::new(self, 27)
    }
    #[doc = "Bit 28 - Target TX FIFO underflow"]
    #[inline(always)]
    pub fn ttx_unfl(&mut self) -> TtxUnflW<'_, I2c2CpuIntIclrSpec> {
        TtxUnflW::new(self, 28)
    }
    #[doc = "Bit 29 - Target RX FIFO overflow"]
    #[inline(always)]
    pub fn trx_ovfl(&mut self) -> TrxOvflW<'_, I2c2CpuIntIclrSpec> {
        TrxOvflW::new(self, 29)
    }
    #[doc = "Bit 30 - Target Arbitration Lost"]
    #[inline(always)]
    pub fn tarblost(&mut self) -> TarblostW<'_, I2c2CpuIntIclrSpec> {
        TarblostW::new(self, 30)
    }
    #[doc = "Bit 31 - Interrupt overflow"]
    #[inline(always)]
    pub fn intr_ovfl(&mut self) -> IntrOvflW<'_, I2c2CpuIntIclrSpec> {
        IntrOvflW::new(self, 31)
    }
}
#[doc = "Interrupt clear\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i2c2_cpu_int_iclr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c2CpuIntIclrSpec;
impl crate::RegisterSpec for I2c2CpuIntIclrSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`i2c2_cpu_int_iclr::W`](W) writer structure"]
impl crate::Writable for I2c2CpuIntIclrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I2C2_CPU_INT_ICLR to value 0"]
impl crate::Resettable for I2c2CpuIntIclrSpec {}
