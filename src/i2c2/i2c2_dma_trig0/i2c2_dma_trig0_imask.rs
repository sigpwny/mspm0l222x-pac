#[doc = "Register `I2C2_DMA_TRIG0_IMASK` reader"]
pub type R = crate::R<I2c2DmaTrig0ImaskSpec>;
#[doc = "Register `I2C2_DMA_TRIG0_IMASK` writer"]
pub type W = crate::W<I2c2DmaTrig0ImaskSpec>;
...
impl W {
    #[doc = "Bit 0 - Controller Receive FIFO Trigger Trigger when RX FIFO contains >= defined bytes"]
    #[inline(always)]
    pub fn crxfifotrg(&mut self) -> CrxfifotrgW<'_, I2c2DmaTrig0ImaskSpec> {
        CrxfifotrgW::new(self, 0)
    }
    #[doc = "Bit 1 - Controller Transmit FIFO Trigger Trigger when Transmit FIFO contains <= defined bytes"]
    #[inline(always)]
    pub fn ctxfifotrg(&mut self) -> CtxfifotrgW<'_, I2c2DmaTrig0ImaskSpec> {
        CtxfifotrgW::new(self, 1)
    }
    #[doc = "Bit 2 - Target Receive FIFO Trigger"]
    #[inline(always)]
    pub fn trxfifotrg(&mut self) -> TrxfifotrgW<'_, I2c2DmaTrig0ImaskSpec> {
        TrxfifotrgW::new(self, 2)
    }
    #[doc = "Bit 3 - Target Transmit FIFO Trigger"]
    #[inline(always)]
    pub fn ttxfifotrg(&mut self) -> TtxfifotrgW<'_, I2c2DmaTrig0ImaskSpec> {
        TtxfifotrgW::new(self, 3)
    }
}
#[doc = "Interrupt mask\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c2_dma_trig0_imask::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i2c2_dma_trig0_imask::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c2DmaTrig0ImaskSpec;
impl crate::RegisterSpec for I2c2DmaTrig0ImaskSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c2_dma_trig0_imask::R`](R) reader structure"]
impl crate::Readable for I2c2DmaTrig0ImaskSpec {}
#[doc = "`write(|w| ..)` method takes [`i2c2_dma_trig0_imask::W`](W) writer structure"]
impl crate::Writable for I2c2DmaTrig0ImaskSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I2C2_DMA_TRIG0_IMASK to value 0"]
impl crate::Resettable for I2c2DmaTrig0ImaskSpec {}
