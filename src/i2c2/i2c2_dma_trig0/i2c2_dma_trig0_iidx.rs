#[doc = "Register `I2C2_DMA_TRIG0_IIDX` reader"]
pub type R = crate::R<I2c2DmaTrig0IidxSpec>;
...
#[doc = "Interrupt index\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c2_dma_trig0_iidx::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c2DmaTrig0IidxSpec;
impl crate::RegisterSpec for I2c2DmaTrig0IidxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c2_dma_trig0_iidx::R`](R) reader structure"]
impl crate::Readable for I2c2DmaTrig0IidxSpec {}
#[doc = "`reset()` method sets I2C2_DMA_TRIG0_IIDX to value 0"]
impl crate::Resettable for I2c2DmaTrig0IidxSpec {}
