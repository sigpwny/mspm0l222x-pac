#[doc = "Register `I2C2_RSTCTL` writer"]
pub type W = crate::W<I2c2RstctlSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn resetassert(&mut self) -> ResetassertW<'_, I2c2RstctlSpec> {
        ResetassertW::new(self, 0)
    }
    #[doc = "Bit 1 - Clear the RESETSTKY bit in the STAT register"]
    #[inline(always)]
    pub fn resetstkyclr(&mut self) -> ResetstkyclrW<'_, I2c2RstctlSpec> {
        ResetstkyclrW::new(self, 1)
    }
}
#[doc = "Reset Control\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i2c2_rstctl::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c2RstctlSpec;
impl crate::RegisterSpec for I2c2RstctlSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`i2c2_rstctl::W`](W) writer structure"]
impl crate::Writable for I2c2RstctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I2C2_RSTCTL to value 0"]
impl crate::Resettable for I2c2RstctlSpec {}
