#[doc = "Register `I2C2_GFCTL` reader"]
pub type R = crate::R<I2c2GfctlSpec>;
#[doc = "Register `I2C2_GFCTL` writer"]
pub type W = crate::W<I2c2GfctlSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Glitch Suppression Pulse Width This field controls the pulse width select for glitch suppression on the SCL and SDA lines. The following values are the glitch suppression values in terms of functional clocks. (Core Domain only)"]
    #[inline(always)]
    pub fn dgfsel(&mut self) -> DgfselW<'_, I2c2GfctlSpec> {
        DgfselW::new(self, 0)
    }
    #[doc = "Bit 8 - Analog Glitch Suppression Enable"]
    #[inline(always)]
    pub fn agfen(&mut self) -> AgfenW<'_, I2c2GfctlSpec> {
        AgfenW::new(self, 8)
    }
    #[doc = "Bits 9:10 - Analog Glitch Suppression Pulse Width This field controls the pulse width select for the analog glitch suppression on SCL and SDA lines. See device datasheet for exact values. (ULP I2C only)"]
    #[inline(always)]
    pub fn agfsel(&mut self) -> AgfselW<'_, I2c2GfctlSpec> {
        AgfselW::new(self, 9)
    }
    #[doc = "Bit 11 - Analog and digital noise filters chaining enable."]
    #[inline(always)]
    pub fn chain(&mut self) -> ChainW<'_, I2c2GfctlSpec> {
        ChainW::new(self, 11)
    }
}
#[doc = "I2C Glitch Filter Control\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c2_gfctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i2c2_gfctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c2GfctlSpec;
impl crate::RegisterSpec for I2c2GfctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c2_gfctl::R`](R) reader structure"]
impl crate::Readable for I2c2GfctlSpec {}
#[doc = "`write(|w| ..)` method takes [`i2c2_gfctl::W`](W) writer structure"]
impl crate::Writable for I2c2GfctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I2C2_GFCTL to value 0"]
impl crate::Resettable for I2c2GfctlSpec {}
