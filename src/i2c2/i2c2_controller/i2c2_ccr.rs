#[doc = "Register `I2C2_CCR` reader"]
pub type R = crate::R<I2c2CcrSpec>;
#[doc = "Register `I2C2_CCR` writer"]
pub type W = crate::W<I2c2CcrSpec>;
...
impl W {
    #[doc = "Bit 0 - Device Active After this bit has been set, it should not be set again unless it has been cleared by writing a 0 or by a reset, otherwise transfer failures may occur."]
    #[inline(always)]
    pub fn active(&mut self) -> ActiveW<'_, I2c2CcrSpec> {
        ActiveW::new(self, 0)
    }
    #[doc = "Bit 1 - MultiController mode. In MultiController mode the SCL high time counts once the SCL line has been detected high. If this is not enabled the high time counts as soon as the SCL line has been set high by the I2C controller."]
    #[inline(always)]
    pub fn mctl(&mut self) -> MctlW<'_, I2c2CcrSpec> {
        MctlW::new(self, 1)
    }
    #[doc = "Bit 2 - Clock Stretching. This bit controls the support for clock stretching of the I2C bus."]
    #[inline(always)]
    pub fn clkstretch(&mut self) -> ClkstretchW<'_, I2c2CcrSpec> {
        ClkstretchW::new(self, 2)
    }
    #[doc = "Bit 8 - I2C Loopback"]
    #[inline(always)]
    pub fn lpbk(&mut self) -> LpbkW<'_, I2c2CcrSpec> {
        LpbkW::new(self, 8)
    }
}
#[doc = "I2C Controller Configuration\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c2_ccr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i2c2_ccr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c2CcrSpec;
impl crate::RegisterSpec for I2c2CcrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c2_ccr::R`](R) reader structure"]
impl crate::Readable for I2c2CcrSpec {}
#[doc = "`write(|w| ..)` method takes [`i2c2_ccr::W`](W) writer structure"]
impl crate::Writable for I2c2CcrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I2C2_CCR to value 0"]
impl crate::Resettable for I2c2CcrSpec {}
