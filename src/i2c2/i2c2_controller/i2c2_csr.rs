#[doc = "Register `I2C2_CSR` reader"]
pub type R = crate::R<I2c2CsrSpec>;
...
#[doc = "I2C Controller Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c2_csr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c2CsrSpec;
impl crate::RegisterSpec for I2c2CsrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c2_csr::R`](R) reader structure"]
impl crate::Readable for I2c2CsrSpec {}
#[doc = "`reset()` method sets I2C2_CSR to value 0"]
impl crate::Resettable for I2c2CsrSpec {}
