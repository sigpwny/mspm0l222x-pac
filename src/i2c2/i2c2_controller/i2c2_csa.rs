#[doc = "Register `I2C2_CSA` reader"]
pub type R = crate::R<I2c2CsaSpec>;
#[doc = "Register `I2C2_CSA` writer"]
pub type W = crate::W<I2c2CsaSpec>;
...
impl W {
    #[doc = "Bit 0 - Receive/Send The DIR bit specifies if the next Controller operation is a Receive (High) or Transmit (Low). 0h = Transmit 1h = Receive"]
    #[inline(always)]
    pub fn dir(&mut self) -> DirW<'_, I2c2CsaSpec> {
        DirW::new(self, 0)
    }
    #[doc = "Bits 1:10 - I2C Target Address This field specifies bits A9 through A0 of the Target address. In 7-bit addressing mode as selected by MSA.MODE bit, the top 3 bits are don't care"]
    #[inline(always)]
    pub fn taddr(&mut self) -> TaddrW<'_, I2c2CsaSpec> {
        TaddrW::new(self, 1)
    }
    #[doc = "Bit 15 - This bit selects the adressing mode to be used in Controller mode When 0, 7-bit addressing is used. When 1, 10-bit addressing is used."]
    #[inline(always)]
    pub fn cmode(&mut self) -> CmodeW<'_, I2c2CsaSpec> {
        CmodeW::new(self, 15)
    }
}
#[doc = "I2C Controller Target Address Register\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c2_csa::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i2c2_csa::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c2CsaSpec;
impl crate::RegisterSpec for I2c2CsaSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c2_csa::R`](R) reader structure"]
impl crate::Readable for I2c2CsaSpec {}
#[doc = "`write(|w| ..)` method takes [`i2c2_csa::W`](W) writer structure"]
impl crate::Writable for I2c2CsaSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I2C2_CSA to value 0"]
impl crate::Resettable for I2c2CsaSpec {}
