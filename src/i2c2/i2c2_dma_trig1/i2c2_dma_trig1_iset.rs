#[doc = "Register `I2C2_DMA_TRIG1_ISET` writer"]
pub type W = crate::W<I2c2DmaTrig1IsetSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn crxfifotrg(&mut self) -> CrxfifotrgW<'_, I2c2DmaTrig1IsetSpec> {
        CrxfifotrgW::new(self, 0)
    }
    #[doc = "Bit 1 - Controller Transmit FIFO Trigger Trigger when Transmit FIFO contains <= defined bytes"]
    #[inline(always)]
    pub fn ctxfifotrg(&mut self) -> CtxfifotrgW<'_, I2c2DmaTrig1IsetSpec> {
        CtxfifotrgW::new(self, 1)
    }
    #[doc = "Bit 2 - Target Receive FIFO Trigger"]
    #[inline(always)]
    pub fn trxfifotrg(&mut self) -> TrxfifotrgW<'_, I2c2DmaTrig1IsetSpec> {
        TrxfifotrgW::new(self, 2)
    }
    #[doc = "Bit 3 - Target Transmit FIFO Trigger"]
    #[inline(always)]
    pub fn ttxfifotrg(&mut self) -> TtxfifotrgW<'_, I2c2DmaTrig1IsetSpec> {
        TtxfifotrgW::new(self, 3)
    }
}
#[doc = "Interrupt set\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i2c2_dma_trig1_iset::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c2DmaTrig1IsetSpec;
impl crate::RegisterSpec for I2c2DmaTrig1IsetSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`i2c2_dma_trig1_iset::W`](W) writer structure"]
impl crate::Writable for I2c2DmaTrig1IsetSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I2C2_DMA_TRIG1_ISET to value 0"]
impl crate::Resettable for I2c2DmaTrig1IsetSpec {}
