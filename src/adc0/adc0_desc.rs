#[doc = "Register `ADC0_DESC` reader"]
pub type R = crate::R<Adc0DescSpec>;
...
#[doc = "Module Description\n\nYou can [`read`](crate::Reg::read) this register and get [`adc0_desc::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Adc0DescSpec;
impl crate::RegisterSpec for Adc0DescSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adc0_desc::R`](R) reader structure"]
impl crate::Readable for Adc0DescSpec {}
#[doc = "`reset()` method sets ADC0_DESC to value 0"]
impl crate::Resettable for Adc0DescSpec {}
