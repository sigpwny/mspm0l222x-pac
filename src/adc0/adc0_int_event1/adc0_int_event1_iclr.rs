#[doc = "Register `ADC0_INT_EVENT1_ICLR` writer"]
pub type W = crate::W<Adc0IntEvent1IclrSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn highifg(&mut self) -> HighifgW<'_, Adc0IntEvent1IclrSpec> {
        HighifgW::new(self, 2)
    }
    ...
    #[inline(always)]
    pub fn lowifg(&mut self) -> LowifgW<'_, Adc0IntEvent1IclrSpec> {
        LowifgW::new(self, 3)
    }
    #[doc = "Bit 4 - Mask INIFG in MIS_EX register."]
    #[inline(always)]
    pub fn inifg(&mut self) -> InifgW<'_, Adc0IntEvent1IclrSpec> {
        InifgW::new(self, 4)
    }
    ...
    #[inline(always)]
    pub fn memresifg0(&mut self) -> Memresifg0W<'_, Adc0IntEvent1IclrSpec> {
        Memresifg0W::new(self, 8)
    }
}
#[doc = "Interrupt clear\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`adc0_int_event1_iclr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Adc0IntEvent1IclrSpec;
impl crate::RegisterSpec for Adc0IntEvent1IclrSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`adc0_int_event1_iclr::W`](W) writer structure"]
impl crate::Writable for Adc0IntEvent1IclrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ADC0_INT_EVENT1_ICLR to value 0"]
impl crate::Resettable for Adc0IntEvent1IclrSpec {}
