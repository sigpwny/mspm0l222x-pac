#[doc = "Register `ADC0_FPUB_1` reader"]
pub type R = crate::R<Adc0Fpub1Spec>;
#[doc = "Register `ADC0_FPUB_1` writer"]
pub type W = crate::W<Adc0Fpub1Spec>;
...
impl W {
    #[doc = "Bits 0:3 - 0 = disconnected. 1-15 = connected to channelID = CHANID."]
    #[inline(always)]
    pub fn chanid(&mut self) -> ChanidW<'_, Adc0Fpub1Spec> {
        ChanidW::new(self, 0)
    }
}
#[doc = "Publisher Configuration Register.\n\nYou can [`read`](crate::Reg::read) this register and get [`adc0_fpub_1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`adc0_fpub_1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Adc0Fpub1Spec;
impl crate::RegisterSpec for Adc0Fpub1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adc0_fpub_1::R`](R) reader structure"]
impl crate::Readable for Adc0Fpub1Spec {}
#[doc = "`write(|w| ..)` method takes [`adc0_fpub_1::W`](W) writer structure"]
impl crate::Writable for Adc0Fpub1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ADC0_FPUB_1 to value 0"]
impl crate::Resettable for Adc0Fpub1Spec {}
