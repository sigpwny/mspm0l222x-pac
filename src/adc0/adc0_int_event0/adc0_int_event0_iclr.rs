#[doc = "Register `ADC0_INT_EVENT0_ICLR` writer"]
pub type W = crate::W<Adc0IntEvent0IclrSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn ovifg(&mut self) -> OvifgW<'_, Adc0IntEvent0IclrSpec> {
        OvifgW::new(self, 0)
    }
    ...
    #[inline(always)]
    pub fn tovifg(&mut self) -> TovifgW<'_, Adc0IntEvent0IclrSpec> {
        TovifgW::new(self, 1)
    }
    ...
    #[inline(always)]
    pub fn highifg(&mut self) -> HighifgW<'_, Adc0IntEvent0IclrSpec> {
        HighifgW::new(self, 2)
    }
    ...
    #[inline(always)]
    pub fn lowifg(&mut self) -> LowifgW<'_, Adc0IntEvent0IclrSpec> {
        LowifgW::new(self, 3)
    }
    #[doc = "Bit 4 - Mask INIFG in MIS_EX register."]
    #[inline(always)]
    pub fn inifg(&mut self) -> InifgW<'_, Adc0IntEvent0IclrSpec> {
        InifgW::new(self, 4)
    }
    ...
    #[inline(always)]
    pub fn dmadone(&mut self) -> DmadoneW<'_, Adc0IntEvent0IclrSpec> {
        DmadoneW::new(self, 5)
    }
    ...
    #[inline(always)]
    pub fn uvifg(&mut self) -> UvifgW<'_, Adc0IntEvent0IclrSpec> {
        UvifgW::new(self, 6)
    }
    ...
    #[inline(always)]
    pub fn memresifg0(&mut self) -> Memresifg0W<'_, Adc0IntEvent0IclrSpec> {
    ...
    #[inline(always)]
    pub fn memresifg1(&mut self) -> Memresifg1W<'_, Adc0IntEvent0IclrSpec> {
    ...
    #[inline(always)]
    pub fn memresifg2(&mut self) -> Memresifg2W<'_, Adc0IntEvent0IclrSpec> {
    ...
    #[inline(always)]
    pub fn memresifg3(&mut self) -> Memresifg3W<'_, Adc0IntEvent0IclrSpec> {
    ...
    #[inline(always)]
    pub fn memresifg4(&mut self) -> Memresifg4W<'_, Adc0IntEvent0IclrSpec> {
    ...
    #[inline(always)]
    pub fn memresifg5(&mut self) -> Memresifg5W<'_, Adc0IntEvent0IclrSpec> {
    ...
    #[inline(always)]
    pub fn memresifg6(&mut self) -> Memresifg6W<'_, Adc0IntEvent0IclrSpec> {
    ...
    #[inline(always)]
    pub fn memresifg7(&mut self) -> Memresifg7W<'_, Adc0IntEvent0IclrSpec> {
    ...
    #[inline(always)]
    pub fn memresifg8(&mut self) -> Memresifg8W<'_, Adc0IntEvent0IclrSpec> {
    ...
    #[inline(always)]
    pub fn memresifg9(&mut self) -> Memresifg9W<'_, Adc0IntEvent0IclrSpec> {
    ...
    #[inline(always)]
    pub fn memresifg10(&mut self) -> Memresifg10W<'_, Adc0IntEvent0IclrSpec> {
    ...
    #[inline(always)]
    pub fn memresifg11(&mut self) -> Memresifg11W<'_, Adc0IntEvent0IclrSpec> {
        Memresifg11W::new(self, 19)
    }
}
#[doc = "Interrupt clear\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`adc0_int_event0_iclr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Adc0IntEvent0IclrSpec;
impl crate::RegisterSpec for Adc0IntEvent0IclrSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`adc0_int_event0_iclr::W`](W) writer structure"]
impl crate::Writable for Adc0IntEvent0IclrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ADC0_INT_EVENT0_ICLR to value 0"]
impl crate::Resettable for Adc0IntEvent0IclrSpec {}
