#[doc = "Register `ADC0_INT_EVENT0_IIDX` reader"]
pub type R = crate::R<Adc0IntEvent0IidxSpec>;
...
pub enum Stat {
    ...
    NoIntr = 0,
    #[doc = "1: MEMRESx overflow interrupt"]
    Ovifg = 1,
    #[doc = "2: Sequence Conversion time overflow interrupt"]
    Tovifg = 2,
    ...
    Inifg = 5,
    #[doc = "6: DMA done interrupt, generated on DMA transfer completion,"]
    Dmadone = 6,
    #[doc = "7: MEMRESx underflow interrupt"]
    Uvifg = 7,
...
impl StatR {
    ...
    #[inline(always)]
    pub fn is_ovifg(&self) -> bool {
        *self == Stat::Ovifg
    }
    #[doc = "Sequence Conversion time overflow interrupt"]
    #[inline(always)]
    pub fn is_tovifg(&self) -> bool {
        *self == Stat::Tovifg
    }
    ...
    #[inline(always)]
    pub fn is_dmadone(&self) -> bool {
        *self == Stat::Dmadone
    }
    #[doc = "MEMRESx underflow interrupt"]
    #[inline(always)]
    pub fn is_uvifg(&self) -> bool {
        *self == Stat::Uvifg
    }
...
#[doc = "Interrupt index\n\nYou can [`read`](crate::Reg::read) this register and get [`adc0_int_event0_iidx::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Adc0IntEvent0IidxSpec;
impl crate::RegisterSpec for Adc0IntEvent0IidxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adc0_int_event0_iidx::R`](R) reader structure"]
impl crate::Readable for Adc0IntEvent0IidxSpec {}
#[doc = "`reset()` method sets ADC0_INT_EVENT0_IIDX to value 0"]
impl crate::Resettable for Adc0IntEvent0IidxSpec {}
