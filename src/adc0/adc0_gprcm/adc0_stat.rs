#[doc = "Register `ADC0_STAT` reader"]
pub type R = crate::R<Adc0StatSpec>;
...
#[doc = "Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`adc0_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Adc0StatSpec;
impl crate::RegisterSpec for Adc0StatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adc0_stat::R`](R) reader structure"]
impl crate::Readable for Adc0StatSpec {}
#[doc = "`reset()` method sets ADC0_STAT to value 0"]
impl crate::Resettable for Adc0StatSpec {}
