#[doc = "Register `ADC0_INT_EVENT2_ICLR` writer"]
pub type W = crate::W<Adc0IntEvent2IclrSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn memresifg0(&mut self) -> Memresifg0W<'_, Adc0IntEvent2IclrSpec> {
    ...
    #[inline(always)]
    pub fn memresifg1(&mut self) -> Memresifg1W<'_, Adc0IntEvent2IclrSpec> {
    ...
    #[inline(always)]
    pub fn memresifg2(&mut self) -> Memresifg2W<'_, Adc0IntEvent2IclrSpec> {
    ...
    #[inline(always)]
    pub fn memresifg3(&mut self) -> Memresifg3W<'_, Adc0IntEvent2IclrSpec> {
    ...
    #[inline(always)]
    pub fn memresifg4(&mut self) -> Memresifg4W<'_, Adc0IntEvent2IclrSpec> {
    ...
    #[inline(always)]
    pub fn memresifg5(&mut self) -> Memresifg5W<'_, Adc0IntEvent2IclrSpec> {
    ...
    #[inline(always)]
    pub fn memresifg6(&mut self) -> Memresifg6W<'_, Adc0IntEvent2IclrSpec> {
    ...
    #[inline(always)]
    pub fn memresifg7(&mut self) -> Memresifg7W<'_, Adc0IntEvent2IclrSpec> {
    ...
    #[inline(always)]
    pub fn memresifg8(&mut self) -> Memresifg8W<'_, Adc0IntEvent2IclrSpec> {
    ...
    #[inline(always)]
    pub fn memresifg9(&mut self) -> Memresifg9W<'_, Adc0IntEvent2IclrSpec> {
    ...
    #[inline(always)]
    pub fn memresifg10(&mut self) -> Memresifg10W<'_, Adc0IntEvent2IclrSpec> {
    ...
    #[inline(always)]
    pub fn memresifg11(&mut self) -> Memresifg11W<'_, Adc0IntEvent2IclrSpec> {
        Memresifg11W::new(self, 19)
    }
}
#[doc = "Interrupt clear extension\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`adc0_int_event2_iclr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Adc0IntEvent2IclrSpec;
impl crate::RegisterSpec for Adc0IntEvent2IclrSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`adc0_int_event2_iclr::W`](W) writer structure"]
impl crate::Writable for Adc0IntEvent2IclrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ADC0_INT_EVENT2_ICLR to value 0"]
impl crate::Resettable for Adc0IntEvent2IclrSpec {}
