#[doc = "Register `ADC0_INT_EVENT2_RIS` reader"]
pub type R = crate::R<Adc0IntEvent2RisSpec>;
...
#[doc = "Raw interrupt status extension\n\nYou can [`read`](crate::Reg::read) this register and get [`adc0_int_event2_ris::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Adc0IntEvent2RisSpec;
impl crate::RegisterSpec for Adc0IntEvent2RisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adc0_int_event2_ris::R`](R) reader structure"]
impl crate::Readable for Adc0IntEvent2RisSpec {}
#[doc = "`reset()` method sets ADC0_INT_EVENT2_RIS to value 0"]
impl crate::Resettable for Adc0IntEvent2RisSpec {}
