#[doc = "Register `AESADV_EVT_MODE` reader"]
pub type R = crate::R<AesadvEvtModeSpec>;
#[doc = "Register `AESADV_EVT_MODE` writer"]
pub type W = crate::W<AesadvEvtModeSpec>;
...
#[doc = "Field `EVT2_CFG` reader - Event line mode select for event corresponding to \\[IPSTANDARD.INT_EVENT2\\]"]
...
impl W {}
#[doc = "Event Mode\n\nYou can [`read`](crate::Reg::read) this register and get [`aesadv_evt_mode::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`aesadv_evt_mode::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AesadvEvtModeSpec;
impl crate::RegisterSpec for AesadvEvtModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`aesadv_evt_mode::R`](R) reader structure"]
impl crate::Readable for AesadvEvtModeSpec {}
#[doc = "`write(|w| ..)` method takes [`aesadv_evt_mode::W`](W) writer structure"]
impl crate::Writable for AesadvEvtModeSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets AESADV_EVT_MODE to value 0"]
impl crate::Resettable for AesadvEvtModeSpec {}
