#[doc = "Register `AESADV_INT_EVENT0_ICLR` writer"]
pub type W = crate::W<AesadvIntEvent0IclrSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn outputrdy(&mut self) -> OutputrdyW<'_, AesadvIntEvent0IclrSpec> {
    ...
    #[inline(always)]
    pub fn inputrdy(&mut self) -> InputrdyW<'_, AesadvIntEvent0IclrSpec> {
    ...
    #[inline(always)]
    pub fn savedcntxtrdy(&mut self) -> SavedcntxtrdyW<'_, AesadvIntEvent0IclrSpec> {
    ...
    #[inline(always)]
    pub fn cntxtrdy(&mut self) -> CntxtrdyW<'_, AesadvIntEvent0IclrSpec> {
        CntxtrdyW::new(self, 3)
    }
}
#[doc = "Interrupt clear\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`aesadv_int_event0_iclr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AesadvIntEvent0IclrSpec;
impl crate::RegisterSpec for AesadvIntEvent0IclrSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`aesadv_int_event0_iclr::W`](W) writer structure"]
impl crate::Writable for AesadvIntEvent0IclrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets AESADV_INT_EVENT0_ICLR to value 0"]
impl crate::Resettable for AesadvIntEvent0IclrSpec {}
