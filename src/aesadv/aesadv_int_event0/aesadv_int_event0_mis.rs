#[doc = "Register `AESADV_INT_EVENT0_MIS` reader"]
pub type R = crate::R<AesadvIntEvent0MisSpec>;
...
#[doc = "Masked interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`aesadv_int_event0_mis::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AesadvIntEvent0MisSpec;
impl crate::RegisterSpec for AesadvIntEvent0MisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`aesadv_int_event0_mis::R`](R) reader structure"]
impl crate::Readable for AesadvIntEvent0MisSpec {}
#[doc = "`reset()` method sets AESADV_INT_EVENT0_MIS to value 0"]
impl crate::Resettable for AesadvIntEvent0MisSpec {}
