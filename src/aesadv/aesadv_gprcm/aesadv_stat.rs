#[doc = "Register `AESADV_STAT` reader"]
pub type R = crate::R<AesadvStatSpec>;
...
#[doc = "Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`aesadv_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AesadvStatSpec;
impl crate::RegisterSpec for AesadvStatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`aesadv_stat::R`](R) reader structure"]
impl crate::Readable for AesadvStatSpec {}
#[doc = "`reset()` method sets AESADV_STAT to value 0"]
impl crate::Resettable for AesadvStatSpec {}
