#[doc = "Register `VREF_STAT` reader"]
pub type R = crate::R<VrefStatSpec>;
...
#[doc = "Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`vref_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct VrefStatSpec;
impl crate::RegisterSpec for VrefStatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`vref_stat::R`](R) reader structure"]
impl crate::Readable for VrefStatSpec {}
#[doc = "`reset()` method sets VREF_STAT to value 0"]
impl crate::Resettable for VrefStatSpec {}
