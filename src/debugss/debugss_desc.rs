#[doc = "Register `DEBUGSS_DESC` reader"]
pub type R = crate::R<DebugssDescSpec>;
...
#[doc = "Module Description\n\nYou can [`read`](crate::Reg::read) this register and get [`debugss_desc::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DebugssDescSpec;
impl crate::RegisterSpec for DebugssDescSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`debugss_desc::R`](R) reader structure"]
impl crate::Readable for DebugssDescSpec {}
#[doc = "`reset()` method sets DEBUGSS_DESC to value 0"]
impl crate::Resettable for DebugssDescSpec {}
