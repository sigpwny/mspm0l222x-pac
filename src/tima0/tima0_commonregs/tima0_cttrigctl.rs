#[doc = "Register `TIMA0_CTTRIGCTL` reader"]
pub type R = crate::R<Tima0CttrigctlSpec>;
#[doc = "Register `TIMA0_CTTRIGCTL` writer"]
pub type W = crate::W<Tima0CttrigctlSpec>;
...
impl W {
    #[doc = "Bit 0 - Timer Cross trigger enable. This field is used to enable whether the SW or HW logic can generate a timer cross trigger event in the system. These cross triggers are connected to the respective timer trigger in of the other timer IPs in the SOC power domain. The timer cross trigger is essentially the combined logic of the HW and SW conditions controlling EN bit in the CTRCTL register."]
    #[inline(always)]
    pub fn cten(&mut self) -> CtenW<'_, Tima0CttrigctlSpec> {
        CtenW::new(self, 0)
    }
    #[doc = "Bit 1 - Enable the Input Trigger Conditions to the Timer module as a condition for Cross Triggers. Refer Figure 8 Cross Trigger Generation Path"]
    #[inline(always)]
    pub fn evtcten(&mut self) -> EvtctenW<'_, Tima0CttrigctlSpec> {
        EvtctenW::new(self, 1)
    }
    #[doc = "Bits 16:19 - Used to Select the subscriber port that should be used for input cross trigger. Refer Figure 8 Cross Trigger Generation Path"]
    #[inline(always)]
    pub fn evtcttrigsel(&mut self) -> EvtcttrigselW<'_, Tima0CttrigctlSpec> {
        EvtcttrigselW::new(self, 16)
    }
}
#[doc = "Timer Cross Trigger Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`tima0_cttrigctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tima0_cttrigctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Tima0CttrigctlSpec;
impl crate::RegisterSpec for Tima0CttrigctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tima0_cttrigctl::R`](R) reader structure"]
impl crate::Readable for Tima0CttrigctlSpec {}
#[doc = "`write(|w| ..)` method takes [`tima0_cttrigctl::W`](W) writer structure"]
impl crate::Writable for Tima0CttrigctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMA0_CTTRIGCTL to value 0"]
impl crate::Resettable for Tima0CttrigctlSpec {}
