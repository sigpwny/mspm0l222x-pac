#[doc = "Register `TIMA0_GCTL` reader"]
pub type R = crate::R<Tima0GctlSpec>;
#[doc = "Register `TIMA0_GCTL` writer"]
pub type W = crate::W<Tima0GctlSpec>;
...
impl W {
    #[doc = "Bit 0 - Enables shadow to active load of bufferred registers and register fields."]
    #[inline(always)]
    pub fn shdwlden(&mut self) -> ShdwldenW<'_, Tima0GctlSpec> {
        ShdwldenW::new(self, 0)
    }
}
#[doc = "Shadow to active load mask\n\nYou can [`read`](crate::Reg::read) this register and get [`tima0_gctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tima0_gctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Tima0GctlSpec;
impl crate::RegisterSpec for Tima0GctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tima0_gctl::R`](R) reader structure"]
impl crate::Readable for Tima0GctlSpec {}
#[doc = "`write(|w| ..)` method takes [`tima0_gctl::W`](W) writer structure"]
impl crate::Writable for Tima0GctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMA0_GCTL to value 0"]
impl crate::Resettable for Tima0GctlSpec {}
