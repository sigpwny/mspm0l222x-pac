#[doc = "Register `TIMA0_CCACT_23[%s]` reader"]
pub type R = crate::R<Tima0Ccact23Spec>;
#[doc = "Register `TIMA0_CCACT_23[%s]` writer"]
pub type W = crate::W<Tima0Ccact23Spec>;
...
impl W {
    #[doc = "Bits 0:1 - CCP Output Action on Zero Specifies what changes occur to CCP output as the result of a zero event."]
    #[inline(always)]
    pub fn zact(&mut self) -> ZactW<'_, Tima0Ccact23Spec> {
        ZactW::new(self, 0)
    }
    #[doc = "Bits 3:4 - CCP Output Action on Load Specifies what changes occur to CCP output as the result of a load event."]
    #[inline(always)]
    pub fn lact(&mut self) -> LactW<'_, Tima0Ccact23Spec> {
        LactW::new(self, 3)
    }
    #[doc = "Bits 6:7 - CCP Output Action on Compare (Down) This field describes the resulting action of the signal generator upon detecting a compare event while counting down."]
    #[inline(always)]
    pub fn cdact(&mut self) -> CdactW<'_, Tima0Ccact23Spec> {
        CdactW::new(self, 6)
    }
    #[doc = "Bits 9:10 - CCP Output Action on Compare (Up) This field describes the resulting action of the signal generator upon detecting a compare event while counting up."]
    #[inline(always)]
    pub fn cuact(&mut self) -> CuactW<'_, Tima0Ccact23Spec> {
        CuactW::new(self, 9)
    }
    #[doc = "Bits 12:13 - CCP Output Action on CC2D event."]
    #[inline(always)]
    pub fn cc2dact(&mut self) -> Cc2dactW<'_, Tima0Ccact23Spec> {
        Cc2dactW::new(self, 12)
    }
    #[doc = "Bits 15:16 - CCP Output Action on CC2U event."]
    #[inline(always)]
    pub fn cc2uact(&mut self) -> Cc2uactW<'_, Tima0Ccact23Spec> {
        Cc2uactW::new(self, 15)
    }
    #[doc = "Bits 22:24 - CCP Output Action on Fault Entry This field describes the resulting action of the signal generator upon detecting a fault."]
    #[inline(always)]
    pub fn fenact(&mut self) -> FenactW<'_, Tima0Ccact23Spec> {
        FenactW::new(self, 22)
    }
    #[doc = "Bits 25:27 - CCP Output Action on Fault Exit This field describes the resulting action of the signal generator upon exiting the fault condition."]
    #[inline(always)]
    pub fn fexact(&mut self) -> FexactW<'_, Tima0Ccact23Spec> {
        FexactW::new(self, 25)
    }
    #[doc = "Bits 28:29 - CCP Output Action on Software Force Output This field describes the resulting action of software force. This action has a shadow register, which will be updated under specific condition. So that this register cannot take into effect immediately."]
    #[inline(always)]
    pub fn swfrcact(&mut self) -> SwfrcactW<'_, Tima0Ccact23Spec> {
        SwfrcactW::new(self, 28)
    }
    #[doc = "Bits 30:31 - CCP_CMPL Output Action on Software Force Output This field describes the resulting action of software force. This action has a shadow register, which will be updated under specific condition. So that this register cannot take into effect immediately."]
    #[inline(always)]
    pub fn swfrcact_cmpl(&mut self) -> SwfrcactCmplW<'_, Tima0Ccact23Spec> {
        SwfrcactCmplW::new(self, 30)
    }
}
#[doc = "Capture or Compare Action Registers\n\nYou can [`read`](crate::Reg::read) this register and get [`tima0_ccact_23::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tima0_ccact_23::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Tima0Ccact23Spec;
impl crate::RegisterSpec for Tima0Ccact23Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tima0_ccact_23::R`](R) reader structure"]
impl crate::Readable for Tima0Ccact23Spec {}
#[doc = "`write(|w| ..)` method takes [`tima0_ccact_23::W`](W) writer structure"]
impl crate::Writable for Tima0Ccact23Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMA0_CCACT_23[%s] to value 0"]
impl crate::Resettable for Tima0Ccact23Spec {}
