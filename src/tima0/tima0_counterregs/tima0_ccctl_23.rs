#[doc = "Register `TIMA0_CCCTL_23[%s]` reader"]
pub type R = crate::R<Tima0Ccctl23Spec>;
#[doc = "Register `TIMA0_CCCTL_23[%s]` writer"]
pub type W = crate::W<Tima0Ccctl23Spec>;
...
#[doc = "Field `SCERCNEZ` reader - Suppress Compare Event if Repeat Counter is Not Equal to Zero This bit suppresses the generation of the compare (CCD, CCU and RC) events from the counter when the repeat counter (RCn) value is not 0."]
...
#[doc = "Field `SCERCNEZ` writer - Suppress Compare Event if Repeat Counter is Not Equal to Zero This bit suppresses the generation of the compare (CCD, CCU and RC) events from the counter when the repeat counter (RCn) value is not 0."]
...
#[repr(u8)]
pub enum Ccactupd {
    #[doc = "0: Value written to the CCACTx_y register has immediate effect."]
    Immediately = 0,
...
impl CcactupdR {
    ...
    #[doc = "Value written to the CCACTx_y register has immediate effect."]
    #[inline(always)]
    pub fn is_immediately(&self) -> bool {
...
impl W {
    #[doc = "Bits 0:2 - Capture Condition. #br# Specifies the condition that generates a capture pulse. 4h-Fh = Reserved"]
    #[inline(always)]
    pub fn ccond(&mut self) -> CcondW<'_, Tima0Ccctl23Spec> {
        CcondW::new(self, 0)
    }
    #[doc = "Bits 4:6 - Advance Condition. #br# Specifies the condition that generates an advance pulse. 6h-Fh = Reserved"]
    #[inline(always)]
    pub fn acond(&mut self) -> AcondW<'_, Tima0Ccctl23Spec> {
        AcondW::new(self, 4)
    }
    #[doc = "Bits 8:10 - Load Condition. #br# Specifies the condition that generates a load pulse. 4h-Fh = Reserved"]
    #[inline(always)]
    pub fn lcond(&mut self) -> LcondW<'_, Tima0Ccctl23Spec> {
        LcondW::new(self, 8)
    }
    #[doc = "Bits 12:14 - Zero Condition. #br# This field specifies the condition that generates a zero pulse. 4h-Fh = Reserved"]
    #[inline(always)]
    pub fn zcond(&mut self) -> ZcondW<'_, Tima0Ccctl23Spec> {
        ZcondW::new(self, 12)
    }
    #[doc = "Bit 17 - Capture or Compare. #br# Specifies whether the corresponding CC register is used as a capture register or a compare register (never both)."]
    #[inline(always)]
    pub fn coc(&mut self) -> CocW<'_, Tima0Ccctl23Spec> {
        CocW::new(self, 17)
    }
    #[doc = "Bits 18:20 - Capture and Compare Update Method This field controls how updates to the pipelined capture and compare register are performed (when operating in compare mode, COC=0)."]
    #[inline(always)]
    pub fn ccupd(&mut self) -> CcupdW<'_, Tima0Ccctl23Spec> {
        CcupdW::new(self, 18)
    }
    #[doc = "Bits 22:24 - Selects the source second CCU event."]
    #[inline(always)]
    pub fn cc2selu(&mut self) -> Cc2seluW<'_, Tima0Ccctl23Spec> {
        Cc2seluW::new(self, 22)
    }
    #[doc = "Bit 25 - Suppress Compare Event if Repeat Counter is Not Equal to Zero This bit suppresses the generation of the compare (CCD, CCU and RC) events from the counter when the repeat counter (RCn) value is not 0."]
    #[inline(always)]
    pub fn scercnez(&mut self) -> ScercnezW<'_, Tima0Ccctl23Spec> {
        ScercnezW::new(self, 25)
    }
    #[doc = "Bits 26:28 - CCACT shadow register Update Method This field controls how updates to the CCCACT shadow register are performed"]
    #[inline(always)]
    pub fn ccactupd(&mut self) -> CcactupdW<'_, Tima0Ccctl23Spec> {
        CcactupdW::new(self, 26)
    }
    #[doc = "Bits 29:31 - Selects the source second CCD event."]
    #[inline(always)]
    pub fn cc2seld(&mut self) -> Cc2seldW<'_, Tima0Ccctl23Spec> {
        Cc2seldW::new(self, 29)
    }
}
#[doc = "Capture or Compare Control Registers\n\nYou can [`read`](crate::Reg::read) this register and get [`tima0_ccctl_23::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tima0_ccctl_23::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Tima0Ccctl23Spec;
impl crate::RegisterSpec for Tima0Ccctl23Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tima0_ccctl_23::R`](R) reader structure"]
impl crate::Readable for Tima0Ccctl23Spec {}
#[doc = "`write(|w| ..)` method takes [`tima0_ccctl_23::W`](W) writer structure"]
impl crate::Writable for Tima0Ccctl23Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMA0_CCCTL_23[%s] to value 0"]
impl crate::Resettable for Tima0Ccctl23Spec {}
