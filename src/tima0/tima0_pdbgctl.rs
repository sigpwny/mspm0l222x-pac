#[doc = "Register `TIMA0_PDBGCTL` reader"]
pub type R = crate::R<Tima0PdbgctlSpec>;
#[doc = "Register `TIMA0_PDBGCTL` writer"]
pub type W = crate::W<Tima0PdbgctlSpec>;
...
impl W {
    #[doc = "Bit 0 - Free run control"]
    #[inline(always)]
    pub fn free(&mut self) -> FreeW<'_, Tima0PdbgctlSpec> {
        FreeW::new(self, 0)
    }
    #[doc = "Bit 1 - Soft halt boundary control. This function is only available, if \\[FREE\\] is set to 'STOP'"]
    #[inline(always)]
    pub fn soft(&mut self) -> SoftW<'_, Tima0PdbgctlSpec> {
        SoftW::new(self, 1)
    }
}
#[doc = "Peripheral Debug Control\n\nYou can [`read`](crate::Reg::read) this register and get [`tima0_pdbgctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tima0_pdbgctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Tima0PdbgctlSpec;
impl crate::RegisterSpec for Tima0PdbgctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tima0_pdbgctl::R`](R) reader structure"]
impl crate::Readable for Tima0PdbgctlSpec {}
#[doc = "`write(|w| ..)` method takes [`tima0_pdbgctl::W`](W) writer structure"]
impl crate::Writable for Tima0PdbgctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMA0_PDBGCTL to value 0"]
impl crate::Resettable for Tima0PdbgctlSpec {}
