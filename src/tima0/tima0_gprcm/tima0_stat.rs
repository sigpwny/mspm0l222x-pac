#[doc = "Register `TIMA0_STAT` reader"]
pub type R = crate::R<Tima0StatSpec>;
...
#[doc = "Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`tima0_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Tima0StatSpec;
impl crate::RegisterSpec for Tima0StatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tima0_stat::R`](R) reader structure"]
impl crate::Readable for Tima0StatSpec {}
#[doc = "`reset()` method sets TIMA0_STAT to value 0"]
impl crate::Resettable for Tima0StatSpec {}
