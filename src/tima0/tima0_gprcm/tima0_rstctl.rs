#[doc = "Register `TIMA0_RSTCTL` writer"]
pub type W = crate::W<Tima0RstctlSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn resetassert(&mut self) -> ResetassertW<'_, Tima0RstctlSpec> {
        ResetassertW::new(self, 0)
    }
    #[doc = "Bit 1 - Clear the RESETSTKY bit in the STAT register"]
    #[inline(always)]
    pub fn resetstkyclr(&mut self) -> ResetstkyclrW<'_, Tima0RstctlSpec> {
        ResetstkyclrW::new(self, 1)
    }
}
#[doc = "Reset Control\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tima0_rstctl::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Tima0RstctlSpec;
impl crate::RegisterSpec for Tima0RstctlSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`tima0_rstctl::W`](W) writer structure"]
impl crate::Writable for Tima0RstctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMA0_RSTCTL to value 0"]
impl crate::Resettable for Tima0RstctlSpec {}
