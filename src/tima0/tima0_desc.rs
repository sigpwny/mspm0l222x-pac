#[doc = "Register `TIMA0_DESC` reader"]
pub type R = crate::R<Tima0DescSpec>;
...
#[doc = "Module Description\n\nYou can [`read`](crate::Reg::read) this register and get [`tima0_desc::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Tima0DescSpec;
impl crate::RegisterSpec for Tima0DescSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tima0_desc::R`](R) reader structure"]
impl crate::Readable for Tima0DescSpec {}
#[doc = "`reset()` method sets TIMA0_DESC to value 0"]
impl crate::Resettable for Tima0DescSpec {}
