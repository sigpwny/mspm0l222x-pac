#[doc = "Register `TIMA0_EVT_MODE` reader"]
pub type R = crate::R<Tima0EvtModeSpec>;
#[doc = "Register `TIMA0_EVT_MODE` writer"]
pub type W = crate::W<Tima0EvtModeSpec>;
...
impl W {}
#[doc = "Event Mode\n\nYou can [`read`](crate::Reg::read) this register and get [`tima0_evt_mode::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tima0_evt_mode::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Tima0EvtModeSpec;
impl crate::RegisterSpec for Tima0EvtModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tima0_evt_mode::R`](R) reader structure"]
impl crate::Readable for Tima0EvtModeSpec {}
#[doc = "`write(|w| ..)` method takes [`tima0_evt_mode::W`](W) writer structure"]
impl crate::Writable for Tima0EvtModeSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMA0_EVT_MODE to value 0x29"]
impl crate::Resettable for Tima0EvtModeSpec {
