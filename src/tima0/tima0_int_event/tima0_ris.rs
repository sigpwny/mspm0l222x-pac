#[doc = "Register `TIMA0_RIS` reader"]
pub type R = crate::R<Tima0RisSpec>;
...
#[doc = "Field `CCD4` reader - Compare down event generated an interrupt CCD4"]
...
#[doc = "Field `CCD5` reader - Compare down event generated an interrupt CCD5"]
...
#[doc = "Field `CCU4` reader - Compare up event generated an interrupt CCU4"]
...
#[doc = "Raw interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`tima0_ris::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Tima0RisSpec;
impl crate::RegisterSpec for Tima0RisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tima0_ris::R`](R) reader structure"]
impl crate::Readable for Tima0RisSpec {}
#[doc = "`reset()` method sets TIMA0_RIS to value 0"]
impl crate::Resettable for Tima0RisSpec {}
