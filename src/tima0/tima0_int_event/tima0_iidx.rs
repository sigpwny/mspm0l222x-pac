#[doc = "Register `TIMA0_IIDX` reader"]
pub type R = crate::R<Tima0IidxSpec>;
...
#[doc = "Interrupt index\n\nYou can [`read`](crate::Reg::read) this register and get [`tima0_iidx::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Tima0IidxSpec;
impl crate::RegisterSpec for Tima0IidxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tima0_iidx::R`](R) reader structure"]
impl crate::Readable for Tima0IidxSpec {}
#[doc = "`reset()` method sets TIMA0_IIDX to value 0"]
impl crate::Resettable for Tima0IidxSpec {}
