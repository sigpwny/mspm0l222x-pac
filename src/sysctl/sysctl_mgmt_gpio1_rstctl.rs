#[doc = "Register `SYSCTL_MGMT_GPIO1_RSTCTL` writer"]
pub type W = crate::W<SysctlMgmtGpio1RstctlSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn resetassert(&mut self) -> ResetassertW<'_, SysctlMgmtGpio1RstctlSpec> {
        ResetassertW::new(self, 0)
    }
    #[doc = "Bit 1 - Clear the RESET STICKY Bit"]
    #[inline(always)]
    pub fn resetstkyclr(&mut self) -> ResetstkyclrW<'_, SysctlMgmtGpio1RstctlSpec> {
        ResetstkyclrW::new(self, 1)
    }
}
#[doc = "Power Control Register - Write Only Register, Always Read as 0\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sysctl_mgmt_gpio1_rstctl::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SysctlMgmtGpio1RstctlSpec;
impl crate::RegisterSpec for SysctlMgmtGpio1RstctlSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`sysctl_mgmt_gpio1_rstctl::W`](W) writer structure"]
impl crate::Writable for SysctlMgmtGpio1RstctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SYSCTL_MGMT_GPIO1_RSTCTL to value 0"]
impl crate::Resettable for SysctlMgmtGpio1RstctlSpec {}
