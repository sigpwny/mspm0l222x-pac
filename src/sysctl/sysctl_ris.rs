#[doc = "Register `SYSCTL_RIS` reader"]
pub type R = crate::R<SysctlRisSpec>;
...
#[doc = "Field `LFOSCGOOD` reader - Raw status of the LFOSCGOOD interrupt."]
...
#[doc = "SYSCTL raw interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`sysctl_ris::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SysctlRisSpec;
impl crate::RegisterSpec for SysctlRisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sysctl_ris::R`](R) reader structure"]
impl crate::Readable for SysctlRisSpec {}
#[doc = "`reset()` method sets SYSCTL_RIS to value 0"]
impl crate::Resettable for SysctlRisSpec {}
