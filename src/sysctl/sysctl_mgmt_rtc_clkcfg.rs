#[doc = "Register `SYSCTL_MGMT_RTC_CLKCFG` reader"]
pub type R = crate::R<SysctlMgmtRtcClkcfgSpec>;
#[doc = "Register `SYSCTL_MGMT_RTC_CLKCFG` writer"]
pub type W = crate::W<SysctlMgmtRtcClkcfgSpec>;
...
impl W {
    #[doc = "Bit 8 - Async Clock Request is blocked from starting SYSOSC or forcing bus clock to 32MHz"]
    #[inline(always)]
    pub fn blockasync(&mut self) -> BlockasyncW<'_, SysctlMgmtRtcClkcfgSpec> {
        BlockasyncW::new(self, 8)
    }
}
#[doc = "IP Clock Configuration Register\n\nYou can [`read`](crate::Reg::read) this register and get [`sysctl_mgmt_rtc_clkcfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sysctl_mgmt_rtc_clkcfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SysctlMgmtRtcClkcfgSpec;
impl crate::RegisterSpec for SysctlMgmtRtcClkcfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sysctl_mgmt_rtc_clkcfg::R`](R) reader structure"]
impl crate::Readable for SysctlMgmtRtcClkcfgSpec {}
#[doc = "`write(|w| ..)` method takes [`sysctl_mgmt_rtc_clkcfg::W`](W) writer structure"]
impl crate::Writable for SysctlMgmtRtcClkcfgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SYSCTL_MGMT_RTC_CLKCFG to value 0"]
impl crate::Resettable for SysctlMgmtRtcClkcfgSpec {}
