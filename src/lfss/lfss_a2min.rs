#[doc = "Register `LFSS_A2MIN` reader"]
pub type R = crate::R<LfssA2minSpec>;
#[doc = "Register `LFSS_A2MIN` writer"]
pub type W = crate::W<LfssA2minSpec>;
...
impl W {
    #[doc = "Bits 0:5 - Alarm Minutes Binary (0 to 59). If RTCBCD=1 write to these bits will be ignored and read give the value 0."]
    #[inline(always)]
    pub fn aminbin(&mut self) -> AminbinW<'_, LfssA2minSpec> {
        AminbinW::new(self, 0)
    }
    #[doc = "Bit 7 - Alarm Minutes Binary enable. If RTCBCD=1 this bit is always 0. Write to this bit will be ignored. 0x0= Alarm disabled. 0x1= Alarm enabled."]
    #[inline(always)]
    pub fn aminaebin(&mut self) -> AminaebinW<'_, LfssA2minSpec> {
        AminaebinW::new(self, 7)
    }
    #[doc = "Bits 8:11 - Alarm Minutes BCD low digit (0 to 9). If RTCBCD=0 write to these bits will be ignored and read give the value 0."]
    #[inline(always)]
    pub fn aminlowbcd(&mut self) -> AminlowbcdW<'_, LfssA2minSpec> {
        AminlowbcdW::new(self, 8)
    }
    #[doc = "Bits 12:14 - Alarm Minutes BCD high digit (0 to 5). If RTCBCD=0 write to these bits will be ignored and read give the value 0."]
    #[inline(always)]
    pub fn aminhighbcd(&mut self) -> AminhighbcdW<'_, LfssA2minSpec> {
        AminhighbcdW::new(self, 12)
    }
    #[doc = "Bit 15 - Alarm Minutes BCD enable. If RTCBCD=0 this bit is always 0. Write to this bit will be ignored. 0x0= Alarm disabled. 0x1= Alarm enabled."]
    #[inline(always)]
    pub fn aminaebcd(&mut self) -> AminaebcdW<'_, LfssA2minSpec> {
        AminaebcdW::new(self, 15)
    }
}
#[doc = "RTC Minute Alarm Register - Calendar Mode With Binary / BCD Format\n\nYou can [`read`](crate::Reg::read) this register and get [`lfss_a2min::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lfss_a2min::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LfssA2minSpec;
impl crate::RegisterSpec for LfssA2minSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lfss_a2min::R`](R) reader structure"]
impl crate::Readable for LfssA2minSpec {}
#[doc = "`write(|w| ..)` method takes [`lfss_a2min::W`](W) writer structure"]
impl crate::Writable for LfssA2minSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LFSS_A2MIN to value 0"]
impl crate::Resettable for LfssA2minSpec {}
