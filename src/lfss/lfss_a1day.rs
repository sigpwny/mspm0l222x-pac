#[doc = "Register `LFSS_A1DAY` reader"]
pub type R = crate::R<LfssA1daySpec>;
#[doc = "Register `LFSS_A1DAY` writer"]
pub type W = crate::W<LfssA1daySpec>;
...
impl W {
    #[doc = "Bits 0:2 - Alarm Day of week (0 to 6). These bits are valid if RTCBCD=1 or RTCBCD=0."]
    #[inline(always)]
    pub fn adow(&mut self) -> AdowW<'_, LfssA1daySpec> {
        AdowW::new(self, 0)
    }
    #[doc = "Bit 7 - Alarm Day of week enable. This bit are valid if RTCBCD=1 or RTCBCD=0."]
    #[inline(always)]
    pub fn adowae(&mut self) -> AdowaeW<'_, LfssA1daySpec> {
        AdowaeW::new(self, 7)
    }
    #[doc = "Bits 8:12 - Alarm Day of month Binary (1 to 28, 29, 30, 31) If RTCBCD=1 write to these bits will be ignored and read give the value 0."]
    #[inline(always)]
    pub fn adombin(&mut self) -> AdombinW<'_, LfssA1daySpec> {
        AdombinW::new(self, 8)
    }
    #[doc = "Bit 15 - Alarm Day of month Binary enable. If RTCBCD=1 this bit is always 0. Write to this bit will be ignored. 0x0= Alarm disabled. 0x1= Alarm enabled."]
    #[inline(always)]
    pub fn adomaebin(&mut self) -> AdomaebinW<'_, LfssA1daySpec> {
        AdomaebinW::new(self, 15)
    }
    #[doc = "Bits 16:19 - Alarm Day of month BCD low digit (0 to 9). If RTCBCD=0 write to these bits will be ignored and read give the value 0."]
    #[inline(always)]
    pub fn adomlowbcd(&mut self) -> AdomlowbcdW<'_, LfssA1daySpec> {
        AdomlowbcdW::new(self, 16)
    }
    #[doc = "Bits 20:21 - Alarm Day of month BCD high digit (0 to 3). If RTCBCD=0 write to these bits will be ignored and read give the value 0."]
    #[inline(always)]
    pub fn adomhighbcd(&mut self) -> AdomhighbcdW<'_, LfssA1daySpec> {
        AdomhighbcdW::new(self, 20)
    }
    #[doc = "Bit 23 - Alarm Day of month BCD enable. If RTCBCD=0 this bit is always 0. Write to this bit will be ignored. 0x0= Alarm disabled. 0x1= Alarm enabled."]
    #[inline(always)]
    pub fn adomaebcd(&mut self) -> AdomaebcdW<'_, LfssA1daySpec> {
        AdomaebcdW::new(self, 23)
    }
}
#[doc = "RTC Alarm Day Of Week / Month Register - Calendar Mode With Binary / BCD Format\n\nYou can [`read`](crate::Reg::read) this register and get [`lfss_a1day::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lfss_a1day::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LfssA1daySpec;
impl crate::RegisterSpec for LfssA1daySpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lfss_a1day::R`](R) reader structure"]
impl crate::Readable for LfssA1daySpec {}
#[doc = "`write(|w| ..)` method takes [`lfss_a1day::W`](W) writer structure"]
impl crate::Writable for LfssA1daySpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LFSS_A1DAY to value 0"]
impl crate::Resettable for LfssA1daySpec {}
