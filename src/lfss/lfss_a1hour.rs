#[doc = "Register `LFSS_A1HOUR` reader"]
pub type R = crate::R<LfssA1hourSpec>;
#[doc = "Register `LFSS_A1HOUR` writer"]
pub type W = crate::W<LfssA1hourSpec>;
...
impl W {
    #[doc = "Bits 0:4 - Alarm Hours Binary (0 to 23). If RTCBCD=1 write to these bits will be ignored and read give the value 0."]
    #[inline(always)]
    pub fn ahourbin(&mut self) -> AhourbinW<'_, LfssA1hourSpec> {
        AhourbinW::new(self, 0)
    }
    #[doc = "Bit 7 - Alarm Hours Binary enable. If RTCBCD=1 this bit is always 0. Write to this bit will be ignored. 0x0= Alarm disabled. 0x1= Alarm enabled."]
    #[inline(always)]
    pub fn ahouraebin(&mut self) -> AhouraebinW<'_, LfssA1hourSpec> {
        AhouraebinW::new(self, 7)
    }
    #[doc = "Bits 8:11 - Alarm Hours BCD low digit (0 to 9). If RTCBCD=0 write to these bits will be ignored and read give the value 0."]
    #[inline(always)]
    pub fn ahourlowbcd(&mut self) -> AhourlowbcdW<'_, LfssA1hourSpec> {
        AhourlowbcdW::new(self, 8)
    }
    #[doc = "Bits 12:13 - Alarm Hours BCD high digit (0 to 2). If RTCBCD=0 write to these bits will be ignored and read give the value 0.."]
    #[inline(always)]
    pub fn ahourhighbcd(&mut self) -> AhourhighbcdW<'_, LfssA1hourSpec> {
        AhourhighbcdW::new(self, 12)
    }
    #[doc = "Bit 15 - Alarm Hours BCD enable. If RTCBCD=0 this bit is always 0. Write to this bit will be ignored. 0x0= Alarm disabled. 0x1= Alarm enabled."]
    #[inline(always)]
    pub fn ahouraebcd(&mut self) -> AhouraebcdW<'_, LfssA1hourSpec> {
        AhouraebcdW::new(self, 15)
    }
}
#[doc = "RTC Hours Alarm Register - Calendar Mode With Binary / BCD Format\n\nYou can [`read`](crate::Reg::read) this register and get [`lfss_a1hour::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lfss_a1hour::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LfssA1hourSpec;
impl crate::RegisterSpec for LfssA1hourSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lfss_a1hour::R`](R) reader structure"]
impl crate::Readable for LfssA1hourSpec {}
#[doc = "`write(|w| ..)` method takes [`lfss_a1hour::W`](W) writer structure"]
impl crate::Writable for LfssA1hourSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LFSS_A1HOUR to value 0"]
impl crate::Resettable for LfssA1hourSpec {}
