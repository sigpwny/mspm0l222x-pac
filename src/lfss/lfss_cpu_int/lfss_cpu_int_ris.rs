#[doc = "Register `LFSS_CPU_INT_RIS` reader"]
pub type R = crate::R<LfssCpuIntRisSpec>;
#[doc = "RTC ready\n\nValue on reset: 0"]
...
#[doc = "Raw interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`lfss_cpu_int_ris::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LfssCpuIntRisSpec;
impl crate::RegisterSpec for LfssCpuIntRisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lfss_cpu_int_ris::R`](R) reader structure"]
impl crate::Readable for LfssCpuIntRisSpec {}
#[doc = "`reset()` method sets LFSS_CPU_INT_RIS to value 0"]
impl crate::Resettable for LfssCpuIntRisSpec {}
