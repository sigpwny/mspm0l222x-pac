#[doc = "Register `LFSS_CPU_INT_MIS` reader"]
pub type R = crate::R<LfssCpuIntMisSpec>;
#[doc = "RTC ready\n\nValue on reset: 0"]
...
#[doc = "Masked interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`lfss_cpu_int_mis::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LfssCpuIntMisSpec;
impl crate::RegisterSpec for LfssCpuIntMisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lfss_cpu_int_mis::R`](R) reader structure"]
impl crate::Readable for LfssCpuIntMisSpec {}
#[doc = "`reset()` method sets LFSS_CPU_INT_MIS to value 0"]
impl crate::Resettable for LfssCpuIntMisSpec {}
