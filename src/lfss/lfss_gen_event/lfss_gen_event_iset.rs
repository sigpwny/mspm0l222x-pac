#[doc = "Register `LFSS_GEN_EVENT_ISET` writer"]
pub type W = crate::W<LfssGenEventIsetSpec>;
#[doc = "RTC ready\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bit 0 - RTC ready"]
    #[inline(always)]
    pub fn rtcrdy(&mut self) -> RtcrdyW<'_, LfssGenEventIsetSpec> {
        RtcrdyW::new(self, 0)
    }
    #[doc = "Bit 1 - RTC time event"]
    #[inline(always)]
    pub fn rtctev(&mut self) -> RtctevW<'_, LfssGenEventIsetSpec> {
        RtctevW::new(self, 1)
    }
    #[doc = "Bit 2 - RTC alarm 1"]
    #[inline(always)]
    pub fn rtca1(&mut self) -> Rtca1W<'_, LfssGenEventIsetSpec> {
        Rtca1W::new(self, 2)
    }
    #[doc = "Bit 3 - RTC alarm 2"]
    #[inline(always)]
    pub fn rtca2(&mut self) -> Rtca2W<'_, LfssGenEventIsetSpec> {
        Rtca2W::new(self, 3)
    }
    #[doc = "Bit 4 - RTC prescale timer 0"]
    #[inline(always)]
    pub fn rt0ps(&mut self) -> Rt0psW<'_, LfssGenEventIsetSpec> {
        Rt0psW::new(self, 4)
    }
    #[doc = "Bit 5 - RTC prescale timer 1"]
    #[inline(always)]
    pub fn rt1ps(&mut self) -> Rt1psW<'_, LfssGenEventIsetSpec> {
        Rt1psW::new(self, 5)
    }
    #[doc = "Bit 6 - RTC prescale timer 2"]
    #[inline(always)]
    pub fn rt2ps(&mut self) -> Rt2psW<'_, LfssGenEventIsetSpec> {
        Rt2psW::new(self, 6)
    }
    #[doc = "Bit 7 - Time stamp event"]
    #[inline(always)]
    pub fn tsevt(&mut self) -> TsevtW<'_, LfssGenEventIsetSpec> {
        TsevtW::new(self, 7)
    }
    #[doc = "Bit 8 - Tamper I/O 0 event"]
    #[inline(always)]
    pub fn tio0(&mut self) -> Tio0W<'_, LfssGenEventIsetSpec> {
        Tio0W::new(self, 8)
    }
    #[doc = "Bit 9 - Tamper I/O 1 event"]
    #[inline(always)]
    pub fn tio1(&mut self) -> Tio1W<'_, LfssGenEventIsetSpec> {
        Tio1W::new(self, 9)
    }
    #[doc = "Bit 10 - Tamper I/O 2 event"]
    #[inline(always)]
    pub fn tio2(&mut self) -> Tio2W<'_, LfssGenEventIsetSpec> {
        Tio2W::new(self, 10)
    }
    #[doc = "Bit 11 - Tamper I/O 3 event"]
    #[inline(always)]
    pub fn tio3(&mut self) -> Tio3W<'_, LfssGenEventIsetSpec> {
        Tio3W::new(self, 11)
    }
    #[doc = "Bit 12 - Tamper I/O 4 event"]
    #[inline(always)]
    pub fn tio4(&mut self) -> Tio4W<'_, LfssGenEventIsetSpec> {
        Tio4W::new(self, 12)
    }
    #[doc = "Bit 13 - Tamper I/O 5 event"]
    #[inline(always)]
    pub fn tio5(&mut self) -> Tio5W<'_, LfssGenEventIsetSpec> {
        Tio5W::new(self, 13)
    }
    #[doc = "Bit 14 - Tamper I/O 6 event"]
    #[inline(always)]
    pub fn tio6(&mut self) -> Tio6W<'_, LfssGenEventIsetSpec> {
        Tio6W::new(self, 14)
    }
    #[doc = "Bit 15 - Tamper I/O 7 event"]
    #[inline(always)]
    pub fn tio7(&mut self) -> Tio7W<'_, LfssGenEventIsetSpec> {
        Tio7W::new(self, 15)
    }
    #[doc = "Bit 16 - Tamper I/O 8 event"]
    #[inline(always)]
    pub fn tio8(&mut self) -> Tio8W<'_, LfssGenEventIsetSpec> {
        Tio8W::new(self, 16)
    }
    #[doc = "Bit 17 - Tamper I/O 9 event"]
    #[inline(always)]
    pub fn tio9(&mut self) -> Tio9W<'_, LfssGenEventIsetSpec> {
        Tio9W::new(self, 17)
    }
    #[doc = "Bit 18 - Tamper I/O 10 event"]
    #[inline(always)]
    pub fn tio10(&mut self) -> Tio10W<'_, LfssGenEventIsetSpec> {
        Tio10W::new(self, 18)
    }
    #[doc = "Bit 19 - Tamper I/O 11 event"]
    #[inline(always)]
    pub fn tio11(&mut self) -> Tio11W<'_, LfssGenEventIsetSpec> {
        Tio11W::new(self, 19)
    }
    #[doc = "Bit 20 - Tamper I/O 12 event"]
    #[inline(always)]
    pub fn tio12(&mut self) -> Tio12W<'_, LfssGenEventIsetSpec> {
        Tio12W::new(self, 20)
    }
    #[doc = "Bit 21 - Tamper I/O 13 event"]
    #[inline(always)]
    pub fn tio13(&mut self) -> Tio13W<'_, LfssGenEventIsetSpec> {
        Tio13W::new(self, 21)
    }
    #[doc = "Bit 22 - Tamper I/O 14 event"]
    #[inline(always)]
    pub fn tio14(&mut self) -> Tio14W<'_, LfssGenEventIsetSpec> {
        Tio14W::new(self, 22)
    }
    #[doc = "Bit 23 - Tamper I/O 15 event"]
    #[inline(always)]
    pub fn tio15(&mut self) -> Tio15W<'_, LfssGenEventIsetSpec> {
        Tio15W::new(self, 23)
    }
}
#[doc = "Interrupt set\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lfss_gen_event_iset::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LfssGenEventIsetSpec;
impl crate::RegisterSpec for LfssGenEventIsetSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`lfss_gen_event_iset::W`](W) writer structure"]
impl crate::Writable for LfssGenEventIsetSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LFSS_GEN_EVENT_ISET to value 0"]
impl crate::Resettable for LfssGenEventIsetSpec {}
