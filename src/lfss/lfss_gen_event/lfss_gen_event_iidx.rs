#[doc = "Register `LFSS_GEN_EVENT_IIDX` reader"]
pub type R = crate::R<LfssGenEventIidxSpec>;
...
#[doc = "Interrupt Index Register\n\nYou can [`read`](crate::Reg::read) this register and get [`lfss_gen_event_iidx::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LfssGenEventIidxSpec;
impl crate::RegisterSpec for LfssGenEventIidxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lfss_gen_event_iidx::R`](R) reader structure"]
impl crate::Readable for LfssGenEventIidxSpec {}
#[doc = "`reset()` method sets LFSS_GEN_EVENT_IIDX to value 0"]
impl crate::Resettable for LfssGenEventIidxSpec {}
