#[doc = "Register `LFSS_GEN_EVENT_RIS` reader"]
pub type R = crate::R<LfssGenEventRisSpec>;
#[doc = "RTC ready\n\nValue on reset: 0"]
...
#[doc = "Raw interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`lfss_gen_event_ris::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LfssGenEventRisSpec;
impl crate::RegisterSpec for LfssGenEventRisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lfss_gen_event_ris::R`](R) reader structure"]
impl crate::Readable for LfssGenEventRisSpec {}
#[doc = "`reset()` method sets LFSS_GEN_EVENT_RIS to value 0"]
impl crate::Resettable for LfssGenEventRisSpec {}
