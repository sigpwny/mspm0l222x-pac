#[doc = "Register `UART4_INT_EVENT1_MIS` reader"]
pub type R = crate::R<Uart4IntEvent1MisSpec>;
...
#[doc = "Masked interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`uart4_int_event1_mis::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart4IntEvent1MisSpec;
impl crate::RegisterSpec for Uart4IntEvent1MisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart4_int_event1_mis::R`](R) reader structure"]
impl crate::Readable for Uart4IntEvent1MisSpec {}
#[doc = "`reset()` method sets UART4_INT_EVENT1_MIS to value 0"]
impl crate::Resettable for Uart4IntEvent1MisSpec {}
