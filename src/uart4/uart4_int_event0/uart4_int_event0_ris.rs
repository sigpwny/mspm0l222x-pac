#[doc = "Register `UART4_INT_EVENT0_RIS` reader"]
pub type R = crate::R<Uart4IntEvent0RisSpec>;
...
#[doc = "Raw interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`uart4_int_event0_ris::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart4IntEvent0RisSpec;
impl crate::RegisterSpec for Uart4IntEvent0RisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart4_int_event0_ris::R`](R) reader structure"]
impl crate::Readable for Uart4IntEvent0RisSpec {}
#[doc = "`reset()` method sets UART4_INT_EVENT0_RIS to value 0"]
impl crate::Resettable for Uart4IntEvent0RisSpec {}
