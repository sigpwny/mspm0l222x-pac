#[doc = "Register `UART4_INT_EVENT0_IIDX` reader"]
pub type R = crate::R<Uart4IntEvent0IidxSpec>;
...
#[doc = "Interrupt index\n\nYou can [`read`](crate::Reg::read) this register and get [`uart4_int_event0_iidx::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart4IntEvent0IidxSpec;
impl crate::RegisterSpec for Uart4IntEvent0IidxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart4_int_event0_iidx::R`](R) reader structure"]
impl crate::Readable for Uart4IntEvent0IidxSpec {}
#[doc = "`reset()` method sets UART4_INT_EVENT0_IIDX to value 0"]
impl crate::Resettable for Uart4IntEvent0IidxSpec {}
