#[doc = "Register `UART4_RXDATA` reader"]
pub type R = crate::R<Uart4RxdataSpec>;
...
#[doc = "UART Receive Data Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uart4_rxdata::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart4RxdataSpec;
impl crate::RegisterSpec for Uart4RxdataSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart4_rxdata::R`](R) reader structure"]
impl crate::Readable for Uart4RxdataSpec {}
#[doc = "`reset()` method sets UART4_RXDATA to value 0"]
impl crate::Resettable for Uart4RxdataSpec {}
