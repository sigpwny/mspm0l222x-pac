#[doc = "Register `UART4_GFCTL` reader"]
pub type R = crate::R<Uart4GfctlSpec>;
#[doc = "Register `UART4_GFCTL` writer"]
pub type W = crate::W<Uart4GfctlSpec>;
...
impl W {
    #[doc = "Bit 8 - Analog Glitch Suppression Enable"]
    #[inline(always)]
    pub fn agfen(&mut self) -> AgfenW<'_, Uart4GfctlSpec> {
        AgfenW::new(self, 8)
    }
    #[doc = "Bits 9:10 - Analog Glitch Suppression Pulse Width This field controls the pulse width select for the analog glitch suppression on the RX line. See device datasheet for exact values."]
    #[inline(always)]
    pub fn agfsel(&mut self) -> AgfselW<'_, Uart4GfctlSpec> {
        AgfselW::new(self, 9)
    }
}
#[doc = "Glitch Filter Control\n\nYou can [`read`](crate::Reg::read) this register and get [`uart4_gfctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uart4_gfctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart4GfctlSpec;
impl crate::RegisterSpec for Uart4GfctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart4_gfctl::R`](R) reader structure"]
impl crate::Readable for Uart4GfctlSpec {}
#[doc = "`write(|w| ..)` method takes [`uart4_gfctl::W`](W) writer structure"]
impl crate::Writable for Uart4GfctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UART4_GFCTL to value 0"]
impl crate::Resettable for Uart4GfctlSpec {}
