#[doc = "Register `UART4_RSTCTL` writer"]
pub type W = crate::W<Uart4RstctlSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn resetassert(&mut self) -> ResetassertW<'_, Uart4RstctlSpec> {
        ResetassertW::new(self, 0)
    }
    #[doc = "Bit 1 - Clear the RESETSTKY bit in the STAT register"]
    #[inline(always)]
    pub fn resetstkyclr(&mut self) -> ResetstkyclrW<'_, Uart4RstctlSpec> {
        ResetstkyclrW::new(self, 1)
    }
}
#[doc = "Reset Control\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uart4_rstctl::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart4RstctlSpec;
impl crate::RegisterSpec for Uart4RstctlSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`uart4_rstctl::W`](W) writer structure"]
impl crate::Writable for Uart4RstctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UART4_RSTCTL to value 0"]
impl crate::Resettable for Uart4RstctlSpec {}
