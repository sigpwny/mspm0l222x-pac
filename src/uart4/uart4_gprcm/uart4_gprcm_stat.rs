#[doc = "Register `UART4_GPRCM_STAT` reader"]
pub type R = crate::R<Uart4GprcmStatSpec>;
...
#[doc = "Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uart4_gprcm_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart4GprcmStatSpec;
impl crate::RegisterSpec for Uart4GprcmStatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart4_gprcm_stat::R`](R) reader structure"]
impl crate::Readable for Uart4GprcmStatSpec {}
#[doc = "`reset()` method sets UART4_GPRCM_STAT to value 0"]
impl crate::Resettable for Uart4GprcmStatSpec {}
