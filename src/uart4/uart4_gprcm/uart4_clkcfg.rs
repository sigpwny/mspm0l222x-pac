#[doc = "Register `UART4_CLKCFG` reader"]
pub type R = crate::R<Uart4ClkcfgSpec>;
#[doc = "Register `UART4_CLKCFG` writer"]
pub type W = crate::W<Uart4ClkcfgSpec>;
...
impl W {
    #[doc = "Bit 8 - Async Clock Request is blocked from starting SYSOSC or forcing bus clock to 32MHz"]
    #[inline(always)]
    pub fn blockasync(&mut self) -> BlockasyncW<'_, Uart4ClkcfgSpec> {
        BlockasyncW::new(self, 8)
    }
}
#[doc = "Peripheral Clock Configuration Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uart4_clkcfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uart4_clkcfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart4ClkcfgSpec;
impl crate::RegisterSpec for Uart4ClkcfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart4_clkcfg::R`](R) reader structure"]
impl crate::Readable for Uart4ClkcfgSpec {}
#[doc = "`write(|w| ..)` method takes [`uart4_clkcfg::W`](W) writer structure"]
impl crate::Writable for Uart4ClkcfgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UART4_CLKCFG to value 0"]
impl crate::Resettable for Uart4ClkcfgSpec {}
