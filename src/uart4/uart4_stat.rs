#[doc = "Register `UART4_STAT` reader"]
pub type R = crate::R<Uart4StatSpec>;
...
#[doc = "UART Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uart4_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart4StatSpec;
impl crate::RegisterSpec for Uart4StatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart4_stat::R`](R) reader structure"]
impl crate::Readable for Uart4StatSpec {}
#[doc = "`reset()` method sets UART4_STAT to value 0"]
impl crate::Resettable for Uart4StatSpec {}
