#[doc = "Register `UART4_IFLS` reader"]
pub type R = crate::R<Uart4IflsSpec>;
#[doc = "Register `UART4_IFLS` writer"]
pub type W = crate::W<Uart4IflsSpec>;
...
impl W {
    #[doc = "Bits 0:2 - UART Transmit Interrupt FIFO Level Select The trigger points for the transmit interrupt are as follows: Note: for undefined settings the default configuration is used."]
    #[inline(always)]
    pub fn txiflsel(&mut self) -> TxiflselW<'_, Uart4IflsSpec> {
        TxiflselW::new(self, 0)
    }
    #[doc = "Bits 4:6 - UART Receive Interrupt FIFO Level Select The trigger points for the receive interrupt are as follows: Note: In ULP domain the trigger levels are used for: 0: LVL_1_4 4: LVL_FULL For undefined settings the default configuration is used."]
    #[inline(always)]
    pub fn rxiflsel(&mut self) -> RxiflselW<'_, Uart4IflsSpec> {
        RxiflselW::new(self, 4)
    }
    #[doc = "Bits 8:11 - UART Receive Interrupt Timeout Select. When receiving no start edge for an additional character within the set bittimes a RX interrupt is set even if the FIFO level is not reached. A value of 0 disables this function."]
    #[inline(always)]
    pub fn rxtosel(&mut self) -> RxtoselW<'_, Uart4IflsSpec> {
        RxtoselW::new(self, 8)
    }
}
#[doc = "UART Interrupt FIFO Level Select Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uart4_ifls::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uart4_ifls::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart4IflsSpec;
impl crate::RegisterSpec for Uart4IflsSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart4_ifls::R`](R) reader structure"]
impl crate::Readable for Uart4IflsSpec {}
#[doc = "`write(|w| ..)` method takes [`uart4_ifls::W`](W) writer structure"]
impl crate::Writable for Uart4IflsSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UART4_IFLS to value 0x22"]
impl crate::Resettable for Uart4IflsSpec {
