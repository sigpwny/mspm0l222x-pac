#[doc = "Register `UART4_INT_EVENT2_IIDX` reader"]
pub type R = crate::R<Uart4IntEvent2IidxSpec>;
...
#[doc = "Interrupt index\n\nYou can [`read`](crate::Reg::read) this register and get [`uart4_int_event2_iidx::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart4IntEvent2IidxSpec;
impl crate::RegisterSpec for Uart4IntEvent2IidxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart4_int_event2_iidx::R`](R) reader structure"]
impl crate::Readable for Uart4IntEvent2IidxSpec {}
#[doc = "`reset()` method sets UART4_INT_EVENT2_IIDX to value 0"]
impl crate::Resettable for Uart4IntEvent2IidxSpec {}
