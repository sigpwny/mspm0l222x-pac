#[doc = "Register `TIMG0_RIS` reader"]
pub type R = crate::R<Timg0RisSpec>;
...
#[doc = "Raw interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`timg0_ris::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg0RisSpec;
impl crate::RegisterSpec for Timg0RisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg0_ris::R`](R) reader structure"]
impl crate::Readable for Timg0RisSpec {}
#[doc = "`reset()` method sets TIMG0_RIS to value 0"]
impl crate::Resettable for Timg0RisSpec {}
