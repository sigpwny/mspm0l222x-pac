#[doc = "Register `TIMG0_ISET` writer"]
pub type W = crate::W<Timg0IsetSpec>;
#[doc = "Zero event SET\n\nValue on reset: 0"]
...
impl W {
    ...
    #[inline(always)]
    pub fn z(&mut self) -> ZW<'_, Timg0IsetSpec> {
        ZW::new(self, 0)
    }
    #[doc = "Bit 1 - Load event SET"]
    #[inline(always)]
    pub fn l(&mut self) -> LW<'_, Timg0IsetSpec> {
        LW::new(self, 1)
    }
    #[doc = "Bit 4 - Capture or compare down event SET"]
    #[inline(always)]
    pub fn ccd0(&mut self) -> Ccd0W<'_, Timg0IsetSpec> {
        Ccd0W::new(self, 4)
    }
    #[doc = "Bit 5 - Capture or compare down event SET"]
    #[inline(always)]
    pub fn ccd1(&mut self) -> Ccd1W<'_, Timg0IsetSpec> {
        Ccd1W::new(self, 5)
    }
    #[doc = "Bit 8 - Capture or compare up event SET"]
    #[inline(always)]
    pub fn ccu0(&mut self) -> Ccu0W<'_, Timg0IsetSpec> {
        Ccu0W::new(self, 8)
    }
    #[doc = "Bit 9 - Capture or compare up event SET"]
    #[inline(always)]
    pub fn ccu1(&mut self) -> Ccu1W<'_, Timg0IsetSpec> {
        Ccu1W::new(self, 9)
    }
    #[doc = "Bit 25 - Trigger Overflow event SET"]
    #[inline(always)]
    pub fn tov(&mut self) -> TovW<'_, Timg0IsetSpec> {
        TovW::new(self, 25)
    }
}
#[doc = "Interrupt set\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timg0_iset::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg0IsetSpec;
impl crate::RegisterSpec for Timg0IsetSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`timg0_iset::W`](W) writer structure"]
impl crate::Writable for Timg0IsetSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMG0_ISET to value 0"]
impl crate::Resettable for Timg0IsetSpec {}
