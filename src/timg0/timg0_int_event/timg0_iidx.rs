#[doc = "Register `TIMG0_IIDX` reader"]
pub type R = crate::R<Timg0IidxSpec>;
...
#[doc = "Interrupt index\n\nYou can [`read`](crate::Reg::read) this register and get [`timg0_iidx::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg0IidxSpec;
impl crate::RegisterSpec for Timg0IidxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg0_iidx::R`](R) reader structure"]
impl crate::Readable for Timg0IidxSpec {}
#[doc = "`reset()` method sets TIMG0_IIDX to value 0"]
impl crate::Resettable for Timg0IidxSpec {}
