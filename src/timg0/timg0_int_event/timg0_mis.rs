#[doc = "Register `TIMG0_MIS` reader"]
pub type R = crate::R<Timg0MisSpec>;
...
#[doc = "Masked interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`timg0_mis::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg0MisSpec;
impl crate::RegisterSpec for Timg0MisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg0_mis::R`](R) reader structure"]
impl crate::Readable for Timg0MisSpec {}
#[doc = "`reset()` method sets TIMG0_MIS to value 0"]
impl crate::Resettable for Timg0MisSpec {}
