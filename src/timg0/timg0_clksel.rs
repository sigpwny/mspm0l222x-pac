#[doc = "Register `TIMG0_CLKSEL` reader"]
pub type R = crate::R<Timg0ClkselSpec>;
#[doc = "Register `TIMG0_CLKSEL` writer"]
pub type W = crate::W<Timg0ClkselSpec>;
...
impl W {
    #[doc = "Bit 1 - Selects LFCLK as clock source if enabled"]
    #[inline(always)]
    pub fn lfclk_sel(&mut self) -> LfclkSelW<'_, Timg0ClkselSpec> {
        LfclkSelW::new(self, 1)
    }
    #[doc = "Bit 2 - Selects MFCLK as clock source if enabled"]
    #[inline(always)]
    pub fn mfclk_sel(&mut self) -> MfclkSelW<'_, Timg0ClkselSpec> {
        MfclkSelW::new(self, 2)
    }
    #[doc = "Bit 3 - Selects BUSCLK as clock source if enabled"]
    #[inline(always)]
    pub fn busclk_sel(&mut self) -> BusclkSelW<'_, Timg0ClkselSpec> {
        BusclkSelW::new(self, 3)
    }
}
#[doc = "Clock Select for Ultra Low Power peripherals\n\nYou can [`read`](crate::Reg::read) this register and get [`timg0_clksel::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timg0_clksel::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg0ClkselSpec;
impl crate::RegisterSpec for Timg0ClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg0_clksel::R`](R) reader structure"]
impl crate::Readable for Timg0ClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`timg0_clksel::W`](W) writer structure"]
impl crate::Writable for Timg0ClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMG0_CLKSEL to value 0"]
impl crate::Resettable for Timg0ClkselSpec {}
