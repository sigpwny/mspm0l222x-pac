#[doc = "Register `TIMG0_STAT` reader"]
pub type R = crate::R<Timg0StatSpec>;
...
#[doc = "Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`timg0_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg0StatSpec;
impl crate::RegisterSpec for Timg0StatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timg0_stat::R`](R) reader structure"]
impl crate::Readable for Timg0StatSpec {}
#[doc = "`reset()` method sets TIMG0_STAT to value 0"]
impl crate::Resettable for Timg0StatSpec {}
