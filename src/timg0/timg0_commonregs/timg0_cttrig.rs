#[doc = "Register `TIMG0_CTTRIG` writer"]
pub type W = crate::W<Timg0CttrigSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn trig(&mut self) -> TrigW<'_, Timg0CttrigSpec> {
        TrigW::new(self, 0)
    }
}
#[doc = "Timer Cross Trigger Register\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timg0_cttrig::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timg0CttrigSpec;
impl crate::RegisterSpec for Timg0CttrigSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`timg0_cttrig::W`](W) writer structure"]
impl crate::Writable for Timg0CttrigSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMG0_CTTRIG to value 0"]
impl crate::Resettable for Timg0CttrigSpec {}
