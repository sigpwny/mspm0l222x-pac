#[doc = "Register `SPI0_STAT` reader"]
pub type R = crate::R<Spi0StatSpec>;
...
#[doc = "Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`spi0_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi0StatSpec;
impl crate::RegisterSpec for Spi0StatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi0_stat::R`](R) reader structure"]
impl crate::Readable for Spi0StatSpec {}
#[doc = "`reset()` method sets SPI0_STAT to value 0"]
impl crate::Resettable for Spi0StatSpec {}
