#[doc = "Register `SPI0_DMA_TRIG_RX_RIS` reader"]
pub type R = crate::R<Spi0DmaTrigRxRisSpec>;
...
#[doc = "Raw interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`spi0_dma_trig_rx_ris::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi0DmaTrigRxRisSpec;
impl crate::RegisterSpec for Spi0DmaTrigRxRisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi0_dma_trig_rx_ris::R`](R) reader structure"]
impl crate::Readable for Spi0DmaTrigRxRisSpec {}
#[doc = "`reset()` method sets SPI0_DMA_TRIG_RX_RIS to value 0"]
impl crate::Resettable for Spi0DmaTrigRxRisSpec {}
