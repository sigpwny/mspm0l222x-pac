#[doc = "Register `SPI0_DMA_TRIG_RX_MIS` reader"]
pub type R = crate::R<Spi0DmaTrigRxMisSpec>;
...
#[doc = "Masked interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`spi0_dma_trig_rx_mis::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi0DmaTrigRxMisSpec;
impl crate::RegisterSpec for Spi0DmaTrigRxMisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi0_dma_trig_rx_mis::R`](R) reader structure"]
impl crate::Readable for Spi0DmaTrigRxMisSpec {}
#[doc = "`reset()` method sets SPI0_DMA_TRIG_RX_MIS to value 0"]
impl crate::Resettable for Spi0DmaTrigRxMisSpec {}
