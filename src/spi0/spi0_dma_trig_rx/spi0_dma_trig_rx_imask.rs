#[doc = "Register `SPI0_DMA_TRIG_RX_IMASK` reader"]
pub type R = crate::R<Spi0DmaTrigRxImaskSpec>;
#[doc = "Register `SPI0_DMA_TRIG_RX_IMASK` writer"]
pub type W = crate::W<Spi0DmaTrigRxImaskSpec>;
...
impl W {
    #[doc = "Bit 2 - SPI Receive Time-Out event mask."]
    #[inline(always)]
    pub fn rtout(&mut self) -> RtoutW<'_, Spi0DmaTrigRxImaskSpec> {
        RtoutW::new(self, 2)
    }
    #[doc = "Bit 3 - Receive FIFO event mask."]
    #[inline(always)]
    pub fn rx(&mut self) -> RxW<'_, Spi0DmaTrigRxImaskSpec> {
        RxW::new(self, 3)
    }
}
#[doc = "Interrupt mask\n\nYou can [`read`](crate::Reg::read) this register and get [`spi0_dma_trig_rx_imask::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi0_dma_trig_rx_imask::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi0DmaTrigRxImaskSpec;
impl crate::RegisterSpec for Spi0DmaTrigRxImaskSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi0_dma_trig_rx_imask::R`](R) reader structure"]
impl crate::Readable for Spi0DmaTrigRxImaskSpec {}
#[doc = "`write(|w| ..)` method takes [`spi0_dma_trig_rx_imask::W`](W) writer structure"]
impl crate::Writable for Spi0DmaTrigRxImaskSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPI0_DMA_TRIG_RX_IMASK to value 0"]
impl crate::Resettable for Spi0DmaTrigRxImaskSpec {}
