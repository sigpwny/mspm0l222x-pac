#[doc = "Register `SPI0_CPU_INT_RIS` reader"]
pub type R = crate::R<Spi0CpuIntRisSpec>;
...
#[doc = "Raw interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`spi0_cpu_int_ris::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi0CpuIntRisSpec;
impl crate::RegisterSpec for Spi0CpuIntRisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi0_cpu_int_ris::R`](R) reader structure"]
impl crate::Readable for Spi0CpuIntRisSpec {}
#[doc = "`reset()` method sets SPI0_CPU_INT_RIS to value 0"]
impl crate::Resettable for Spi0CpuIntRisSpec {}
