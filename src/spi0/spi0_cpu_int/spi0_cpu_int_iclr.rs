#[doc = "Register `SPI0_CPU_INT_ICLR` writer"]
pub type W = crate::W<Spi0CpuIntIclrSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn rxfifo_ovf(&mut self) -> RxfifoOvfW<'_, Spi0CpuIntIclrSpec> {
        RxfifoOvfW::new(self, 0)
    }
    #[doc = "Bit 1 - Clear Parity error event."]
    #[inline(always)]
    pub fn per(&mut self) -> PerW<'_, Spi0CpuIntIclrSpec> {
        PerW::new(self, 1)
    }
    #[doc = "Bit 2 - Clear SPI Receive Time-Out Event."]
    #[inline(always)]
    pub fn rtout(&mut self) -> RtoutW<'_, Spi0CpuIntIclrSpec> {
        RtoutW::new(self, 2)
    }
    #[doc = "Bit 3 - Clear Receive FIFO event."]
    #[inline(always)]
    pub fn rx(&mut self) -> RxW<'_, Spi0CpuIntIclrSpec> {
        RxW::new(self, 3)
    }
    #[doc = "Bit 4 - Clear Transmit FIFO event."]
    #[inline(always)]
    pub fn tx(&mut self) -> TxW<'_, Spi0CpuIntIclrSpec> {
        TxW::new(self, 4)
    }
    #[doc = "Bit 5 - Clear Transmit FIFO Empty event."]
    #[inline(always)]
    pub fn txempty(&mut self) -> TxemptyW<'_, Spi0CpuIntIclrSpec> {
        TxemptyW::new(self, 5)
    }
    #[doc = "Bit 6 - Clear SPI IDLE mode event."]
    #[inline(always)]
    pub fn idle(&mut self) -> IdleW<'_, Spi0CpuIntIclrSpec> {
        IdleW::new(self, 6)
    }
    #[doc = "Bit 7 - Clear DMA Done 1 event for RX."]
    #[inline(always)]
    pub fn dma_done_rx(&mut self) -> DmaDoneRxW<'_, Spi0CpuIntIclrSpec> {
        DmaDoneRxW::new(self, 7)
    }
    #[doc = "Bit 8 - Clear DMA Done 1 event for TX."]
    #[inline(always)]
    pub fn dma_done_tx(&mut self) -> DmaDoneTxW<'_, Spi0CpuIntIclrSpec> {
        DmaDoneTxW::new(self, 8)
    }
    #[doc = "Bit 9 - Clear TXFIFO underflow event"]
    #[inline(always)]
    pub fn txfifo_unf(&mut self) -> TxfifoUnfW<'_, Spi0CpuIntIclrSpec> {
        TxfifoUnfW::new(self, 9)
    }
    #[doc = "Bit 10 - Clear RX FIFO underflow event"]
    #[inline(always)]
    pub fn rxfull(&mut self) -> RxfullW<'_, Spi0CpuIntIclrSpec> {
        RxfullW::new(self, 10)
    }
}
#[doc = "Interrupt clear\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi0_cpu_int_iclr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi0CpuIntIclrSpec;
impl crate::RegisterSpec for Spi0CpuIntIclrSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`spi0_cpu_int_iclr::W`](W) writer structure"]
impl crate::Writable for Spi0CpuIntIclrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPI0_CPU_INT_ICLR to value 0"]
impl crate::Resettable for Spi0CpuIntIclrSpec {}
