#[doc = "Register `SPI0_CPU_INT_MIS` reader"]
pub type R = crate::R<Spi0CpuIntMisSpec>;
...
#[doc = "Masked interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`spi0_cpu_int_mis::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi0CpuIntMisSpec;
impl crate::RegisterSpec for Spi0CpuIntMisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi0_cpu_int_mis::R`](R) reader structure"]
impl crate::Readable for Spi0CpuIntMisSpec {}
#[doc = "`reset()` method sets SPI0_CPU_INT_MIS to value 0"]
impl crate::Resettable for Spi0CpuIntMisSpec {}
