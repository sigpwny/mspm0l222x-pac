#[doc = "Register `SPI0_CPU_INT_ISET` writer"]
pub type W = crate::W<Spi0CpuIntIsetSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn rxfifo_ovf(&mut self) -> RxfifoOvfW<'_, Spi0CpuIntIsetSpec> {
        RxfifoOvfW::new(self, 0)
    }
    #[doc = "Bit 1 - Set Parity error event."]
    #[inline(always)]
    pub fn per(&mut self) -> PerW<'_, Spi0CpuIntIsetSpec> {
        PerW::new(self, 1)
    }
    #[doc = "Bit 2 - Set SPI Receive Time-Out Event."]
    #[inline(always)]
    pub fn rtout(&mut self) -> RtoutW<'_, Spi0CpuIntIsetSpec> {
        RtoutW::new(self, 2)
    }
    #[doc = "Bit 3 - Set Receive FIFO event."]
    #[inline(always)]
    pub fn rx(&mut self) -> RxW<'_, Spi0CpuIntIsetSpec> {
        RxW::new(self, 3)
    }
    #[doc = "Bit 4 - Set Transmit FIFO event."]
    #[inline(always)]
    pub fn tx(&mut self) -> TxW<'_, Spi0CpuIntIsetSpec> {
        TxW::new(self, 4)
    }
    #[doc = "Bit 5 - Set Transmit FIFO Empty event."]
    #[inline(always)]
    pub fn txempty(&mut self) -> TxemptyW<'_, Spi0CpuIntIsetSpec> {
        TxemptyW::new(self, 5)
    }
    #[doc = "Bit 6 - Set SPI IDLE mode event."]
    #[inline(always)]
    pub fn idle(&mut self) -> IdleW<'_, Spi0CpuIntIsetSpec> {
        IdleW::new(self, 6)
    }
    #[doc = "Bit 7 - Set DMA Done 1 event for RX."]
    #[inline(always)]
    pub fn dma_done_rx(&mut self) -> DmaDoneRxW<'_, Spi0CpuIntIsetSpec> {
        DmaDoneRxW::new(self, 7)
    }
    #[doc = "Bit 8 - Set DMA Done 1 event for TX."]
    #[inline(always)]
    pub fn dma_done_tx(&mut self) -> DmaDoneTxW<'_, Spi0CpuIntIsetSpec> {
        DmaDoneTxW::new(self, 8)
    }
    #[doc = "Bit 9 - Set TX FIFO Underflow Event"]
    #[inline(always)]
    pub fn txfifo_unf(&mut self) -> TxfifoUnfW<'_, Spi0CpuIntIsetSpec> {
        TxfifoUnfW::new(self, 9)
    }
    #[doc = "Bit 10 - Set RX FIFO Full Event"]
    #[inline(always)]
    pub fn rxfull(&mut self) -> RxfullW<'_, Spi0CpuIntIsetSpec> {
        RxfullW::new(self, 10)
    }
}
#[doc = "Interrupt set\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi0_cpu_int_iset::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi0CpuIntIsetSpec;
impl crate::RegisterSpec for Spi0CpuIntIsetSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`spi0_cpu_int_iset::W`](W) writer structure"]
impl crate::Writable for Spi0CpuIntIsetSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPI0_CPU_INT_ISET to value 0"]
impl crate::Resettable for Spi0CpuIntIsetSpec {}
