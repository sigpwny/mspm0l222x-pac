#[doc = "Register `SPI0_CLKDIV` reader"]
pub type R = crate::R<Spi0ClkdivSpec>;
#[doc = "Register `SPI0_CLKDIV` writer"]
pub type W = crate::W<Spi0ClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Selects divide ratio of module clock"]
    #[inline(always)]
    pub fn ratio(&mut self) -> RatioW<'_, Spi0ClkdivSpec> {
        RatioW::new(self, 0)
    }
}
#[doc = "Clock Divider\n\nYou can [`read`](crate::Reg::read) this register and get [`spi0_clkdiv::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi0_clkdiv::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi0ClkdivSpec;
impl crate::RegisterSpec for Spi0ClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi0_clkdiv::R`](R) reader structure"]
impl crate::Readable for Spi0ClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`spi0_clkdiv::W`](W) writer structure"]
impl crate::Writable for Spi0ClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPI0_CLKDIV to value 0"]
impl crate::Resettable for Spi0ClkdivSpec {}
