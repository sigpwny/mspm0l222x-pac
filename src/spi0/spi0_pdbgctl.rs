#[doc = "Register `SPI0_PDBGCTL` reader"]
pub type R = crate::R<Spi0PdbgctlSpec>;
#[doc = "Register `SPI0_PDBGCTL` writer"]
pub type W = crate::W<Spi0PdbgctlSpec>;
...
impl W {
    #[doc = "Bit 0 - Free run control"]
    #[inline(always)]
    pub fn free(&mut self) -> FreeW<'_, Spi0PdbgctlSpec> {
        FreeW::new(self, 0)
    }
    #[doc = "Bit 1 - Soft halt boundary control. This function is only available, if \\[FREE\\] is set to 'STOP'"]
    #[inline(always)]
    pub fn soft(&mut self) -> SoftW<'_, Spi0PdbgctlSpec> {
        SoftW::new(self, 1)
    }
}
#[doc = "Peripheral Debug Control\n\nYou can [`read`](crate::Reg::read) this register and get [`spi0_pdbgctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi0_pdbgctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi0PdbgctlSpec;
impl crate::RegisterSpec for Spi0PdbgctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi0_pdbgctl::R`](R) reader structure"]
impl crate::Readable for Spi0PdbgctlSpec {}
#[doc = "`write(|w| ..)` method takes [`spi0_pdbgctl::W`](W) writer structure"]
impl crate::Writable for Spi0PdbgctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPI0_PDBGCTL to value 0"]
impl crate::Resettable for Spi0PdbgctlSpec {}
