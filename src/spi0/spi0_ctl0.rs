#[doc = "Register `SPI0_CTL0` reader"]
pub type R = crate::R<Spi0Ctl0Spec>;
#[doc = "Register `SPI0_CTL0` writer"]
pub type W = crate::W<Spi0Ctl0Spec>;
...
impl W {
    #[doc = "Bits 0:4 - Data Size Select. Values 0 - 2 are reserved and shall not be used. 3h = 4_BIT : 4-bit data SPI allows only values up to 16 Bit"]
    #[inline(always)]
    pub fn dss(&mut self) -> DssW<'_, Spi0Ctl0Spec> {
        DssW::new(self, 0)
    }
    #[doc = "Bits 5:6 - Frame format Select"]
    #[inline(always)]
    pub fn frf(&mut self) -> FrfW<'_, Spi0Ctl0Spec> {
        FrfW::new(self, 5)
    }
    #[doc = "Bit 7 - Packing Enable. When 1, packing feature is enabled inside the IP When 0, packing feature is disabled inside the IP"]
    #[inline(always)]
    pub fn packen(&mut self) -> PackenW<'_, Spi0Ctl0Spec> {
        PackenW::new(self, 7)
    }
    #[doc = "Bit 8 - CLKOUT polarity (Motorola SPI frame format only)"]
    #[inline(always)]
    pub fn spo(&mut self) -> SpoW<'_, Spi0Ctl0Spec> {
        SpoW::new(self, 8)
    }
    #[doc = "Bit 9 - CLKOUT phase (Motorola SPI frame format only) This bit selects the clock edge that captures data and enables it to change state. It has the most impact on the first bit transmitted by either permitting or not permitting a clock transition before the first data capture edge."]
    #[inline(always)]
    pub fn sph(&mut self) -> SphW<'_, Spi0Ctl0Spec> {
        SphW::new(self, 9)
    }
    #[doc = "Bits 12:13 - Select the CS line to control on data transfer This bit is applicable for both controller/target mode"]
    #[inline(always)]
    pub fn cssel(&mut self) -> CsselW<'_, Spi0Ctl0Spec> {
        CsselW::new(self, 12)
    }
    #[doc = "Bit 14 - Clear shift register counter on CS inactive This bit is relevant only in the peripheral, CTL1.CP=0."]
    #[inline(always)]
    pub fn csclr(&mut self) -> CsclrW<'_, Spi0Ctl0Spec> {
        CsclrW::new(self, 14)
    }
}
#[doc = "SPI control register 0\n\nYou can [`read`](crate::Reg::read) this register and get [`spi0_ctl0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi0_ctl0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi0Ctl0Spec;
impl crate::RegisterSpec for Spi0Ctl0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi0_ctl0::R`](R) reader structure"]
impl crate::Readable for Spi0Ctl0Spec {}
#[doc = "`write(|w| ..)` method takes [`spi0_ctl0::W`](W) writer structure"]
impl crate::Writable for Spi0Ctl0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPI0_CTL0 to value 0"]
impl crate::Resettable for Spi0Ctl0Spec {}
