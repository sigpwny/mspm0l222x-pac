#[doc = "Register `SPI0_GPRCM_STAT` reader"]
pub type R = crate::R<Spi0GprcmStatSpec>;
...
#[doc = "Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`spi0_gprcm_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi0GprcmStatSpec;
impl crate::RegisterSpec for Spi0GprcmStatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi0_gprcm_stat::R`](R) reader structure"]
impl crate::Readable for Spi0GprcmStatSpec {}
#[doc = "`reset()` method sets SPI0_GPRCM_STAT to value 0"]
impl crate::Resettable for Spi0GprcmStatSpec {}
