#[doc = "Register `GPIOB_EVT_MODE` reader"]
pub type R = crate::R<GpiobEvtModeSpec>;
#[doc = "Register `GPIOB_EVT_MODE` writer"]
pub type W = crate::W<GpiobEvtModeSpec>;
...
#[doc = "Field `EVT1_CFG` reader - Event line mode select for event corresponding to \\[IPSTANDARD.GEN_EVENT0\\]"]
...
#[doc = "Event line mode select for event corresponding to \\[IPSTANDARD.GEN_EVENT1\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Evt2Cfg {
    #[doc = "0: The interrupt or event line is disabled."]
...
#[doc = "Field `EVT2_CFG` reader - Event line mode select for event corresponding to \\[IPSTANDARD.GEN_EVENT1\\]"]
...
impl R {
    ...
    #[doc = "Bits 2:3 - Event line mode select for event corresponding to \\[IPSTANDARD.GEN_EVENT0\\]"]
    #[inline(always)]
    pub fn evt1_cfg(&self) -> Evt1CfgR {
        Evt1CfgR::new(((self.bits >> 2) & 3) as u8)
    }
    #[doc = "Bits 4:5 - Event line mode select for event corresponding to \\[IPSTANDARD.GEN_EVENT1\\]"]
    #[inline(always)]
...
impl W {}
#[doc = "Event Mode\n\nYou can [`read`](crate::Reg::read) this register and get [`gpiob_evt_mode::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpiob_evt_mode::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiobEvtModeSpec;
impl crate::RegisterSpec for GpiobEvtModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpiob_evt_mode::R`](R) reader structure"]
impl crate::Readable for GpiobEvtModeSpec {}
#[doc = "`write(|w| ..)` method takes [`gpiob_evt_mode::W`](W) writer structure"]
impl crate::Writable for GpiobEvtModeSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIOB_EVT_MODE to value 0"]
impl crate::Resettable for GpiobEvtModeSpec {}
