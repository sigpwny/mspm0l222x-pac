#[doc = "Register `GPIOB_GEN_EVENT1_MIS` reader"]
pub type R = crate::R<GpiobGenEvent1MisSpec>;
#[doc = "DIO16 event\n\nValue on reset: 0"]
...
#[doc = "Masked interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`gpiob_gen_event1_mis::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiobGenEvent1MisSpec;
impl crate::RegisterSpec for GpiobGenEvent1MisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpiob_gen_event1_mis::R`](R) reader structure"]
impl crate::Readable for GpiobGenEvent1MisSpec {}
#[doc = "`reset()` method sets GPIOB_GEN_EVENT1_MIS to value 0"]
impl crate::Resettable for GpiobGenEvent1MisSpec {}
