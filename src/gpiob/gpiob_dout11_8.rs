#[doc = "Register `GPIOB_DOUT11_8` writer"]
pub type W = crate::W<GpiobDout11_8Spec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn dio8(&mut self) -> Dio8W<'_, GpiobDout11_8Spec> {
        Dio8W::new(self, 0)
    }
    #[doc = "Bit 8 - This bit sets the value of the pin configured as DIO9 when the output is enabled through DOE31_0 register."]
    #[inline(always)]
    pub fn dio9(&mut self) -> Dio9W<'_, GpiobDout11_8Spec> {
        Dio9W::new(self, 8)
    }
    #[doc = "Bit 16 - This bit sets the value of the pin configured as DIO10 when the output is enabled through DOE31_0 register."]
    #[inline(always)]
    pub fn dio10(&mut self) -> Dio10W<'_, GpiobDout11_8Spec> {
        Dio10W::new(self, 16)
    }
    #[doc = "Bit 24 - This bit sets the value of the pin configured as DIO11 when the output is enabled through DOE31_0 register."]
    #[inline(always)]
    pub fn dio11(&mut self) -> Dio11W<'_, GpiobDout11_8Spec> {
        Dio11W::new(self, 24)
    }
}
#[doc = "Data output 11 to 8\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpiob_dout11_8::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiobDout11_8Spec;
impl crate::RegisterSpec for GpiobDout11_8Spec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`gpiob_dout11_8::W`](W) writer structure"]
impl crate::Writable for GpiobDout11_8Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIOB_DOUT11_8 to value 0"]
impl crate::Resettable for GpiobDout11_8Spec {}
