#[doc = "Register `GPIOB_DESC` reader"]
pub type R = crate::R<GpiobDescSpec>;
...
#[doc = "Module Description\n\nYou can [`read`](crate::Reg::read) this register and get [`gpiob_desc::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiobDescSpec;
impl crate::RegisterSpec for GpiobDescSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpiob_desc::R`](R) reader structure"]
impl crate::Readable for GpiobDescSpec {}
#[doc = "`reset()` method sets GPIOB_DESC to value 0"]
impl crate::Resettable for GpiobDescSpec {}
