#[doc = "Register `GPIOB_FILTEREN15_0` reader"]
pub type R = crate::R<GpiobFilteren15_0Spec>;
#[doc = "Register `GPIOB_FILTEREN15_0` writer"]
pub type W = crate::W<GpiobFilteren15_0Spec>;
...
impl W {
    #[doc = "Bits 0:1 - Programmable counter length of digital glitch filter for DIN0"]
    #[inline(always)]
    pub fn din0(&mut self) -> Din0W<'_, GpiobFilteren15_0Spec> {
        Din0W::new(self, 0)
    }
    #[doc = "Bits 2:3 - Programmable counter length of digital glitch filter for DIN1"]
    #[inline(always)]
    pub fn din1(&mut self) -> Din1W<'_, GpiobFilteren15_0Spec> {
        Din1W::new(self, 2)
    }
    #[doc = "Bits 4:5 - Programmable counter length of digital glitch filter for DIN2"]
    #[inline(always)]
    pub fn din2(&mut self) -> Din2W<'_, GpiobFilteren15_0Spec> {
        Din2W::new(self, 4)
    }
    #[doc = "Bits 6:7 - Programmable counter length of digital glitch filter for DIN3"]
    #[inline(always)]
    pub fn din3(&mut self) -> Din3W<'_, GpiobFilteren15_0Spec> {
        Din3W::new(self, 6)
    }
    #[doc = "Bits 8:9 - Programmable counter length of digital glitch filter for DIN4"]
    #[inline(always)]
    pub fn din4(&mut self) -> Din4W<'_, GpiobFilteren15_0Spec> {
        Din4W::new(self, 8)
    }
    #[doc = "Bits 10:11 - Programmable counter length of digital glitch filter for DIN5"]
    #[inline(always)]
    pub fn din5(&mut self) -> Din5W<'_, GpiobFilteren15_0Spec> {
        Din5W::new(self, 10)
    }
    #[doc = "Bits 12:13 - Programmable counter length of digital glitch filter for DIN6"]
    #[inline(always)]
    pub fn din6(&mut self) -> Din6W<'_, GpiobFilteren15_0Spec> {
        Din6W::new(self, 12)
    }
    #[doc = "Bits 14:15 - Programmable counter length of digital glitch filter for DIN7"]
    #[inline(always)]
    pub fn din7(&mut self) -> Din7W<'_, GpiobFilteren15_0Spec> {
        Din7W::new(self, 14)
    }
    #[doc = "Bits 16:17 - Programmable counter length of digital glitch filter for DIN8"]
    #[inline(always)]
    pub fn din8(&mut self) -> Din8W<'_, GpiobFilteren15_0Spec> {
        Din8W::new(self, 16)
    }
    #[doc = "Bits 18:19 - Programmable counter length of digital glitch filter for DIN9"]
    #[inline(always)]
    pub fn din9(&mut self) -> Din9W<'_, GpiobFilteren15_0Spec> {
        Din9W::new(self, 18)
    }
    #[doc = "Bits 20:21 - Programmable counter length of digital glitch filter for DIN10"]
    #[inline(always)]
    pub fn din10(&mut self) -> Din10W<'_, GpiobFilteren15_0Spec> {
        Din10W::new(self, 20)
    }
    #[doc = "Bits 22:23 - Programmable counter length of digital glitch filter for DIN11"]
    #[inline(always)]
    pub fn din11(&mut self) -> Din11W<'_, GpiobFilteren15_0Spec> {
        Din11W::new(self, 22)
    }
    #[doc = "Bits 24:25 - Programmable counter length of digital glitch filter for DIN12"]
    #[inline(always)]
    pub fn din12(&mut self) -> Din12W<'_, GpiobFilteren15_0Spec> {
        Din12W::new(self, 24)
    }
    #[doc = "Bits 26:27 - Programmable counter length of digital glitch filter for DIN13"]
    #[inline(always)]
    pub fn din13(&mut self) -> Din13W<'_, GpiobFilteren15_0Spec> {
        Din13W::new(self, 26)
    }
    #[doc = "Bits 28:29 - Programmable counter length of digital glitch filter for DIN14"]
    #[inline(always)]
    pub fn din14(&mut self) -> Din14W<'_, GpiobFilteren15_0Spec> {
        Din14W::new(self, 28)
    }
    #[doc = "Bits 30:31 - Programmable counter length of digital glitch filter for DIN15"]
    #[inline(always)]
    pub fn din15(&mut self) -> Din15W<'_, GpiobFilteren15_0Spec> {
        Din15W::new(self, 30)
    }
}
#[doc = "Filter Enable 15 to 0\n\nYou can [`read`](crate::Reg::read) this register and get [`gpiob_filteren15_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpiob_filteren15_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiobFilteren15_0Spec;
impl crate::RegisterSpec for GpiobFilteren15_0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpiob_filteren15_0::R`](R) reader structure"]
impl crate::Readable for GpiobFilteren15_0Spec {}
#[doc = "`write(|w| ..)` method takes [`gpiob_filteren15_0::W`](W) writer structure"]
impl crate::Writable for GpiobFilteren15_0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIOB_FILTEREN15_0 to value 0"]
impl crate::Resettable for GpiobFilteren15_0Spec {}
