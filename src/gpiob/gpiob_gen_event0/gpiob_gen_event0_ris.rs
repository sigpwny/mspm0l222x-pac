#[doc = "Register `GPIOB_GEN_EVENT0_RIS` reader"]
pub type R = crate::R<GpiobGenEvent0RisSpec>;
#[doc = "DIO0 event\n\nValue on reset: 0"]
...
#[doc = "Raw interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`gpiob_gen_event0_ris::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiobGenEvent0RisSpec;
impl crate::RegisterSpec for GpiobGenEvent0RisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpiob_gen_event0_ris::R`](R) reader structure"]
impl crate::Readable for GpiobGenEvent0RisSpec {}
#[doc = "`reset()` method sets GPIOB_GEN_EVENT0_RIS to value 0"]
impl crate::Resettable for GpiobGenEvent0RisSpec {}
