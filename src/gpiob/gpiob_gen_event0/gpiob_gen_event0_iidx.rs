#[doc = "Register `GPIOB_GEN_EVENT0_IIDX` reader"]
pub type R = crate::R<GpiobGenEvent0IidxSpec>;
...
#[doc = "Interrupt index\n\nYou can [`read`](crate::Reg::read) this register and get [`gpiob_gen_event0_iidx::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiobGenEvent0IidxSpec;
impl crate::RegisterSpec for GpiobGenEvent0IidxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpiob_gen_event0_iidx::R`](R) reader structure"]
impl crate::Readable for GpiobGenEvent0IidxSpec {}
#[doc = "`reset()` method sets GPIOB_GEN_EVENT0_IIDX to value 0"]
impl crate::Resettable for GpiobGenEvent0IidxSpec {}
