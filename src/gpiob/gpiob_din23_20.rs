#[doc = "Register `GPIOB_DIN23_20` reader"]
pub type R = crate::R<GpiobDin23_20Spec>;
...
#[doc = "Data input 23 to 20\n\nYou can [`read`](crate::Reg::read) this register and get [`gpiob_din23_20::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiobDin23_20Spec;
impl crate::RegisterSpec for GpiobDin23_20Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpiob_din23_20::R`](R) reader structure"]
impl crate::Readable for GpiobDin23_20Spec {}
#[doc = "`reset()` method sets GPIOB_DIN23_20 to value 0"]
impl crate::Resettable for GpiobDin23_20Spec {}
