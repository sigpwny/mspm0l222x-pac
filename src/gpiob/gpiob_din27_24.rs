#[doc = "Register `GPIOB_DIN27_24` reader"]
pub type R = crate::R<GpiobDin27_24Spec>;
...
#[doc = "Data input 27 to 24\n\nYou can [`read`](crate::Reg::read) this register and get [`gpiob_din27_24::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiobDin27_24Spec;
impl crate::RegisterSpec for GpiobDin27_24Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpiob_din27_24::R`](R) reader structure"]
impl crate::Readable for GpiobDin27_24Spec {}
#[doc = "`reset()` method sets GPIOB_DIN27_24 to value 0"]
impl crate::Resettable for GpiobDin27_24Spec {}
