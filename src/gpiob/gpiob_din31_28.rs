#[doc = "Register `GPIOB_DIN31_28` reader"]
pub type R = crate::R<GpiobDin31_28Spec>;
...
#[doc = "Data input 31 to 28\n\nYou can [`read`](crate::Reg::read) this register and get [`gpiob_din31_28::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiobDin31_28Spec;
impl crate::RegisterSpec for GpiobDin31_28Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpiob_din31_28::R`](R) reader structure"]
impl crate::Readable for GpiobDin31_28Spec {}
#[doc = "`reset()` method sets GPIOB_DIN31_28 to value 0"]
impl crate::Resettable for GpiobDin31_28Spec {}
