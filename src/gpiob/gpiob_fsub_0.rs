#[doc = "Register `GPIOB_FSUB_0` reader"]
pub type R = crate::R<GpiobFsub0Spec>;
#[doc = "Register `GPIOB_FSUB_0` writer"]
pub type W = crate::W<GpiobFsub0Spec>;
...
impl W {
    #[doc = "Bits 0:3 - 0 = disconnected. 1-15 = connected to channelID = CHANID."]
    #[inline(always)]
    pub fn chanid(&mut self) -> ChanidW<'_, GpiobFsub0Spec> {
        ChanidW::new(self, 0)
    }
}
#[doc = "Subsciber Port 0\n\nYou can [`read`](crate::Reg::read) this register and get [`gpiob_fsub_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpiob_fsub_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiobFsub0Spec;
impl crate::RegisterSpec for GpiobFsub0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpiob_fsub_0::R`](R) reader structure"]
impl crate::Readable for GpiobFsub0Spec {}
#[doc = "`write(|w| ..)` method takes [`gpiob_fsub_0::W`](W) writer structure"]
impl crate::Writable for GpiobFsub0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIOB_FSUB_0 to value 0"]
impl crate::Resettable for GpiobFsub0Spec {}
