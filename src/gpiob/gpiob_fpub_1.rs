#[doc = "Register `GPIOB_FPUB_1` reader"]
pub type R = crate::R<GpiobFpub1Spec>;
#[doc = "Register `GPIOB_FPUB_1` writer"]
pub type W = crate::W<GpiobFpub1Spec>;
...
impl W {
    #[doc = "Bits 0:3 - 0 = disconnected. 1-15 = connected to channelID = CHANID."]
    #[inline(always)]
    pub fn chanid(&mut self) -> ChanidW<'_, GpiobFpub1Spec> {
        ChanidW::new(self, 0)
    }
}
#[doc = "Publisher Port 1\n\nYou can [`read`](crate::Reg::read) this register and get [`gpiob_fpub_1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpiob_fpub_1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiobFpub1Spec;
impl crate::RegisterSpec for GpiobFpub1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpiob_fpub_1::R`](R) reader structure"]
impl crate::Readable for GpiobFpub1Spec {}
#[doc = "`write(|w| ..)` method takes [`gpiob_fpub_1::W`](W) writer structure"]
impl crate::Writable for GpiobFpub1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIOB_FPUB_1 to value 0"]
impl crate::Resettable for GpiobFpub1Spec {}
