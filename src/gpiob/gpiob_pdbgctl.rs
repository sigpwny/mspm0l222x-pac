#[doc = "Register `GPIOB_PDBGCTL` reader"]
pub type R = crate::R<GpiobPdbgctlSpec>;
#[doc = "Register `GPIOB_PDBGCTL` writer"]
pub type W = crate::W<GpiobPdbgctlSpec>;
...
impl W {
    #[doc = "Bit 0 - Free run control"]
    #[inline(always)]
    pub fn free(&mut self) -> FreeW<'_, GpiobPdbgctlSpec> {
        FreeW::new(self, 0)
    }
}
#[doc = "Peripheral Debug Control\n\nYou can [`read`](crate::Reg::read) this register and get [`gpiob_pdbgctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpiob_pdbgctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiobPdbgctlSpec;
impl crate::RegisterSpec for GpiobPdbgctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpiob_pdbgctl::R`](R) reader structure"]
impl crate::Readable for GpiobPdbgctlSpec {}
#[doc = "`write(|w| ..)` method takes [`gpiob_pdbgctl::W`](W) writer structure"]
impl crate::Writable for GpiobPdbgctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIOB_PDBGCTL to value 0x01"]
impl crate::Resettable for GpiobPdbgctlSpec {
