#[doc = "Register `GPIOB_DIN31_0` reader"]
pub type R = crate::R<GpiobDin31_0Spec>;
...
#[doc = "Data input 31 to 0\n\nYou can [`read`](crate::Reg::read) this register and get [`gpiob_din31_0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiobDin31_0Spec;
impl crate::RegisterSpec for GpiobDin31_0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpiob_din31_0::R`](R) reader structure"]
impl crate::Readable for GpiobDin31_0Spec {}
#[doc = "`reset()` method sets GPIOB_DIN31_0 to value 0"]
impl crate::Resettable for GpiobDin31_0Spec {}
