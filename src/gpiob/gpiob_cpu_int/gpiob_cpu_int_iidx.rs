#[doc = "Register `GPIOB_CPU_INT_IIDX` reader"]
pub type R = crate::R<GpiobCpuIntIidxSpec>;
...
#[doc = "Interrupt index\n\nYou can [`read`](crate::Reg::read) this register and get [`gpiob_cpu_int_iidx::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiobCpuIntIidxSpec;
impl crate::RegisterSpec for GpiobCpuIntIidxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpiob_cpu_int_iidx::R`](R) reader structure"]
impl crate::Readable for GpiobCpuIntIidxSpec {}
#[doc = "`reset()` method sets GPIOB_CPU_INT_IIDX to value 0"]
impl crate::Resettable for GpiobCpuIntIidxSpec {}
