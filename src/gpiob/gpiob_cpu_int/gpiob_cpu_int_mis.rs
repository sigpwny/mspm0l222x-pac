#[doc = "Register `GPIOB_CPU_INT_MIS` reader"]
pub type R = crate::R<GpiobCpuIntMisSpec>;
#[doc = "DIO0 event\n\nValue on reset: 0"]
...
#[doc = "Masked interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`gpiob_cpu_int_mis::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiobCpuIntMisSpec;
impl crate::RegisterSpec for GpiobCpuIntMisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpiob_cpu_int_mis::R`](R) reader structure"]
impl crate::Readable for GpiobCpuIntMisSpec {}
#[doc = "`reset()` method sets GPIOB_CPU_INT_MIS to value 0"]
impl crate::Resettable for GpiobCpuIntMisSpec {}
