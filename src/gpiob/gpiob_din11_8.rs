#[doc = "Register `GPIOB_DIN11_8` reader"]
pub type R = crate::R<GpiobDin11_8Spec>;
...
#[doc = "Data input 11 to 8\n\nYou can [`read`](crate::Reg::read) this register and get [`gpiob_din11_8::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiobDin11_8Spec;
impl crate::RegisterSpec for GpiobDin11_8Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpiob_din11_8::R`](R) reader structure"]
impl crate::Readable for GpiobDin11_8Spec {}
#[doc = "`reset()` method sets GPIOB_DIN11_8 to value 0"]
impl crate::Resettable for GpiobDin11_8Spec {}
