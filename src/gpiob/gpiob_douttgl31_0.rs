#[doc = "Register `GPIOB_DOUTTGL31_0` writer"]
pub type W = crate::W<GpiobDouttgl31_0Spec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn dio0(&mut self) -> Dio0W<'_, GpiobDouttgl31_0Spec> {
        Dio0W::new(self, 0)
    }
    #[doc = "Bit 1 - This bit is used to toggle DIO1 output."]
    #[inline(always)]
    pub fn dio1(&mut self) -> Dio1W<'_, GpiobDouttgl31_0Spec> {
        Dio1W::new(self, 1)
    }
    #[doc = "Bit 2 - This bit is used to toggle DIO2 output."]
    #[inline(always)]
    pub fn dio2(&mut self) -> Dio2W<'_, GpiobDouttgl31_0Spec> {
        Dio2W::new(self, 2)
    }
    #[doc = "Bit 3 - This bit is used to toggle DIO3 output."]
    #[inline(always)]
    pub fn dio3(&mut self) -> Dio3W<'_, GpiobDouttgl31_0Spec> {
        Dio3W::new(self, 3)
    }
    #[doc = "Bit 4 - This bit is used to toggle DIO4 output."]
    #[inline(always)]
    pub fn dio4(&mut self) -> Dio4W<'_, GpiobDouttgl31_0Spec> {
        Dio4W::new(self, 4)
    }
    #[doc = "Bit 5 - This bit is used to toggle DIO5 output."]
    #[inline(always)]
    pub fn dio5(&mut self) -> Dio5W<'_, GpiobDouttgl31_0Spec> {
        Dio5W::new(self, 5)
    }
    #[doc = "Bit 6 - This bit is used to toggle DIO6 output."]
    #[inline(always)]
    pub fn dio6(&mut self) -> Dio6W<'_, GpiobDouttgl31_0Spec> {
        Dio6W::new(self, 6)
    }
    #[doc = "Bit 7 - This bit is used to toggle DIO7 output."]
    #[inline(always)]
    pub fn dio7(&mut self) -> Dio7W<'_, GpiobDouttgl31_0Spec> {
        Dio7W::new(self, 7)
    }
    #[doc = "Bit 8 - This bit is used to toggle DIO8 output."]
    #[inline(always)]
    pub fn dio8(&mut self) -> Dio8W<'_, GpiobDouttgl31_0Spec> {
        Dio8W::new(self, 8)
    }
    #[doc = "Bit 9 - This bit is used to toggle DIO9 output."]
    #[inline(always)]
    pub fn dio9(&mut self) -> Dio9W<'_, GpiobDouttgl31_0Spec> {
        Dio9W::new(self, 9)
    }
    #[doc = "Bit 10 - This bit is used to toggle DIO10 output."]
    #[inline(always)]
    pub fn dio10(&mut self) -> Dio10W<'_, GpiobDouttgl31_0Spec> {
        Dio10W::new(self, 10)
    }
    #[doc = "Bit 11 - This bit is used to toggle DIO11 output."]
    #[inline(always)]
    pub fn dio11(&mut self) -> Dio11W<'_, GpiobDouttgl31_0Spec> {
        Dio11W::new(self, 11)
    }
    #[doc = "Bit 12 - This bit is used to toggle DIO12 output."]
    #[inline(always)]
    pub fn dio12(&mut self) -> Dio12W<'_, GpiobDouttgl31_0Spec> {
        Dio12W::new(self, 12)
    }
    #[doc = "Bit 13 - This bit is used to toggle DIO13 output."]
    #[inline(always)]
    pub fn dio13(&mut self) -> Dio13W<'_, GpiobDouttgl31_0Spec> {
        Dio13W::new(self, 13)
    }
    #[doc = "Bit 14 - This bit is used to toggle DIO14 output."]
    #[inline(always)]
    pub fn dio14(&mut self) -> Dio14W<'_, GpiobDouttgl31_0Spec> {
        Dio14W::new(self, 14)
    }
    #[doc = "Bit 15 - This bit is used to toggle DIO15 output."]
    #[inline(always)]
    pub fn dio15(&mut self) -> Dio15W<'_, GpiobDouttgl31_0Spec> {
        Dio15W::new(self, 15)
    }
    #[doc = "Bit 16 - This bit is used to toggle DIO16 output."]
    #[inline(always)]
    pub fn dio16(&mut self) -> Dio16W<'_, GpiobDouttgl31_0Spec> {
        Dio16W::new(self, 16)
    }
    #[doc = "Bit 17 - This bit is used to toggle DIO17 output."]
    #[inline(always)]
    pub fn dio17(&mut self) -> Dio17W<'_, GpiobDouttgl31_0Spec> {
        Dio17W::new(self, 17)
    }
    #[doc = "Bit 18 - This bit is used to toggle DIO18 output."]
    #[inline(always)]
    pub fn dio18(&mut self) -> Dio18W<'_, GpiobDouttgl31_0Spec> {
        Dio18W::new(self, 18)
    }
    #[doc = "Bit 19 - This bit is used to toggle DIO19 output."]
    #[inline(always)]
    pub fn dio19(&mut self) -> Dio19W<'_, GpiobDouttgl31_0Spec> {
        Dio19W::new(self, 19)
    }
    #[doc = "Bit 20 - This bit is used to toggle DIO20 output."]
    #[inline(always)]
    pub fn dio20(&mut self) -> Dio20W<'_, GpiobDouttgl31_0Spec> {
        Dio20W::new(self, 20)
    }
    #[doc = "Bit 21 - This bit is used to toggle DIO21 output."]
    #[inline(always)]
    pub fn dio21(&mut self) -> Dio21W<'_, GpiobDouttgl31_0Spec> {
        Dio21W::new(self, 21)
    }
    #[doc = "Bit 22 - This bit is used to toggle DIO22 output."]
    #[inline(always)]
    pub fn dio22(&mut self) -> Dio22W<'_, GpiobDouttgl31_0Spec> {
        Dio22W::new(self, 22)
    }
    #[doc = "Bit 23 - This bit is used to toggle DIO23 output."]
    #[inline(always)]
    pub fn dio23(&mut self) -> Dio23W<'_, GpiobDouttgl31_0Spec> {
        Dio23W::new(self, 23)
    }
    #[doc = "Bit 24 - This bit is used to toggle DIO24 output."]
    #[inline(always)]
    pub fn dio24(&mut self) -> Dio24W<'_, GpiobDouttgl31_0Spec> {
        Dio24W::new(self, 24)
    }
    #[doc = "Bit 25 - This bit is used to toggle DIO25 output."]
    #[inline(always)]
    pub fn dio25(&mut self) -> Dio25W<'_, GpiobDouttgl31_0Spec> {
        Dio25W::new(self, 25)
    }
    #[doc = "Bit 26 - This bit is used to toggle DIO26 output."]
    #[inline(always)]
    pub fn dio26(&mut self) -> Dio26W<'_, GpiobDouttgl31_0Spec> {
        Dio26W::new(self, 26)
    }
    #[doc = "Bit 27 - This bit is used to toggle DIO27 output."]
    #[inline(always)]
    pub fn dio27(&mut self) -> Dio27W<'_, GpiobDouttgl31_0Spec> {
        Dio27W::new(self, 27)
    }
    #[doc = "Bit 28 - This bit is used to toggle DIO28 output."]
    #[inline(always)]
    pub fn dio28(&mut self) -> Dio28W<'_, GpiobDouttgl31_0Spec> {
        Dio28W::new(self, 28)
    }
    #[doc = "Bit 29 - This bit is used to toggle DIO29 output."]
    #[inline(always)]
    pub fn dio29(&mut self) -> Dio29W<'_, GpiobDouttgl31_0Spec> {
        Dio29W::new(self, 29)
    }
    #[doc = "Bit 30 - This bit is used to toggle DIO30 output."]
    #[inline(always)]
    pub fn dio30(&mut self) -> Dio30W<'_, GpiobDouttgl31_0Spec> {
        Dio30W::new(self, 30)
    }
    #[doc = "Bit 31 - This bit is used to toggle DIO31 output."]
    #[inline(always)]
    pub fn dio31(&mut self) -> Dio31W<'_, GpiobDouttgl31_0Spec> {
        Dio31W::new(self, 31)
    }
}
#[doc = "Data output toggle 31 to 0\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpiob_douttgl31_0::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiobDouttgl31_0Spec;
impl crate::RegisterSpec for GpiobDouttgl31_0Spec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`gpiob_douttgl31_0::W`](W) writer structure"]
impl crate::Writable for GpiobDouttgl31_0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIOB_DOUTTGL31_0 to value 0"]
impl crate::Resettable for GpiobDouttgl31_0Spec {}
