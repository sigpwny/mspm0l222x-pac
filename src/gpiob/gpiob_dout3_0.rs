#[doc = "Register `GPIOB_DOUT3_0` writer"]
pub type W = crate::W<GpiobDout3_0Spec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn dio0(&mut self) -> Dio0W<'_, GpiobDout3_0Spec> {
        Dio0W::new(self, 0)
    }
    #[doc = "Bit 8 - This bit sets the value of the pin configured as DIO1 when the output is enabled through DOE31_0 register."]
    #[inline(always)]
    pub fn dio1(&mut self) -> Dio1W<'_, GpiobDout3_0Spec> {
        Dio1W::new(self, 8)
    }
    #[doc = "Bit 16 - This bit sets the value of the pin configured as DIO2 when the output is enabled through DOE31_0 register."]
    #[inline(always)]
    pub fn dio2(&mut self) -> Dio2W<'_, GpiobDout3_0Spec> {
        Dio2W::new(self, 16)
    }
    #[doc = "Bit 24 - This bit sets the value of the pin configured as DIO3 when the output is enabled through DOE31_0 register."]
    #[inline(always)]
    pub fn dio3(&mut self) -> Dio3W<'_, GpiobDout3_0Spec> {
        Dio3W::new(self, 24)
    }
}
#[doc = "Data output 3 to 0\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpiob_dout3_0::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiobDout3_0Spec;
impl crate::RegisterSpec for GpiobDout3_0Spec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`gpiob_dout3_0::W`](W) writer structure"]
impl crate::Writable for GpiobDout3_0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIOB_DOUT3_0 to value 0"]
impl crate::Resettable for GpiobDout3_0Spec {}
