#[doc = "Register `GPIOB_STAT` reader"]
pub type R = crate::R<GpiobStatSpec>;
...
#[doc = "Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`gpiob_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpiobStatSpec;
impl crate::RegisterSpec for GpiobStatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpiob_stat::R`](R) reader structure"]
impl crate::Readable for GpiobStatSpec {}
#[doc = "`reset()` method sets GPIOB_STAT to value 0"]
impl crate::Resettable for GpiobStatSpec {}
