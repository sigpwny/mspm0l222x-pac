#[doc = "Register `TRNG_ISET` writer"]
pub type W = crate::W<TrngIsetSpec>;
...
pub enum IrqHealthFail {
    ...
    NoEffect = 0,
    #[doc = "1: RIS bit corresponding to HEALTH_FAIL is set"]
    Set = 1,
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[doc = "RIS bit corresponding to HEALTH_FAIL is set"]
    #[inline(always)]
    pub fn set_(self) -> &'a mut crate::W<REG> {
        self.variant(IrqHealthFail::Set)
    }
}
...
pub enum IrqCmdFail {
    #[doc = "0: Writing a 0 has no effect."]
    NoEffect = 0,
    #[doc = "1: RIS bit corresponding to CMD_FAIL is set"]
    Set = 1,
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[doc = "RIS bit corresponding to CMD_FAIL is set"]
    #[inline(always)]
    pub fn set_(self) -> &'a mut crate::W<REG> {
        self.variant(IrqCmdFail::Set)
    }
}
...
pub enum IrqCmdDone {
    #[doc = "0: Writing a 0 has no effect."]
    NoEffect = 0,
    #[doc = "1: RIS bit corresponding to CMD_DONE is set"]
    Set = 1,
}
...
#[doc = "Field `IRQ_CMD_DONE` writer - Write to turn on CMD_DONE IRQ. Indicates that the last issued TRNG command has finished."]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[doc = "RIS bit corresponding to CMD_DONE is set"]
    #[inline(always)]
    pub fn set_(self) -> &'a mut crate::W<REG> {
        self.variant(IrqCmdDone::Set)
    }
}
...
pub enum IrqCapturedRdy {
    #[doc = "0: Writing a 0 has no effect"]
    NoEffect = 0,
    #[doc = "1: RIS bit corresponding to CAPTURED_READY is set"]
    Set = 1,
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[doc = "RIS bit corresponding to CAPTURED_READY is set"]
    #[inline(always)]
    pub fn set_(self) -> &'a mut crate::W<REG> {
        self.variant(IrqCapturedRdy::Set)
    }
}
impl W {
    ...
    #[inline(always)]
    pub fn irq_health_fail(&mut self) -> IrqHealthFailW<'_, TrngIsetSpec> {
    ...
    #[inline(always)]
    pub fn irq_captured_rdy(&mut self) -> IrqCapturedRdyW<'_, TrngIsetSpec> {
        IrqCapturedRdyW::new(self, 3)
    }
}
#[doc = "Interrupt set\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`trng_iset::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TrngIsetSpec;
impl crate::RegisterSpec for TrngIsetSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`trng_iset::W`](W) writer structure"]
impl crate::Writable for TrngIsetSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TRNG_ISET to value 0"]
impl crate::Resettable for TrngIsetSpec {}
