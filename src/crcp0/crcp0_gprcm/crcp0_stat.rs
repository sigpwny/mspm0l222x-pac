#[doc = "Register `CRCP0_STAT` reader"]
pub type R = crate::R<Crcp0StatSpec>;
...
#[doc = "Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`crcp0_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Crcp0StatSpec;
impl crate::RegisterSpec for Crcp0StatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`crcp0_stat::R`](R) reader structure"]
impl crate::Readable for Crcp0StatSpec {}
#[doc = "`reset()` method sets CRCP0_STAT to value 0"]
impl crate::Resettable for Crcp0StatSpec {}
