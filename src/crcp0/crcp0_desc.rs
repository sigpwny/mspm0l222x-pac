#[doc = "Register `CRCP0_DESC` reader"]
pub type R = crate::R<Crcp0DescSpec>;
...
#[doc = "Module Description\n\nYou can [`read`](crate::Reg::read) this register and get [`crcp0_desc::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Crcp0DescSpec;
impl crate::RegisterSpec for Crcp0DescSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`crcp0_desc::R`](R) reader structure"]
impl crate::Readable for Crcp0DescSpec {}
#[doc = "`reset()` method sets CRCP0_DESC to value 0"]
impl crate::Resettable for Crcp0DescSpec {}
