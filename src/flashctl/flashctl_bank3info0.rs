#[doc = "Register `FLASHCTL_BANK3INFO0` reader"]
pub type R = crate::R<FlashctlBank3info0Spec>;
...
#[doc = "Bank Information Register 0 for Bank 3\n\nYou can [`read`](crate::Reg::read) this register and get [`flashctl_bank3info0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FlashctlBank3info0Spec;
impl crate::RegisterSpec for FlashctlBank3info0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flashctl_bank3info0::R`](R) reader structure"]
impl crate::Readable for FlashctlBank3info0Spec {}
#[doc = "`reset()` method sets FLASHCTL_BANK3INFO0 to value 0"]
impl crate::Resettable for FlashctlBank3info0Spec {}
