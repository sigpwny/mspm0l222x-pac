#[doc = "Register `FLASHCTL_EVT_MODE` reader"]
pub type R = crate::R<FlashctlEvtModeSpec>;
...
pub enum Int0Cfg {
    ...
    Software = 1,
    #[doc = "2: The interrupt or event line is in hardware mode. Hardware must clear the RIS."]
    Hardware = 2,
}
...
#[doc = "Field `INT0_CFG` reader - Event line mode select for peripheral event"]
...
impl R {
    #[doc = "Bits 0:1 - Event line mode select for peripheral event"]
    #[inline(always)]
    pub fn int0_cfg(&self) -> Int0CfgR {
        Int0CfgR::new((self.bits & 3) as u8)
    }
}
#[doc = "Event Mode\n\nYou can [`read`](crate::Reg::read) this register and get [`flashctl_evt_mode::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FlashctlEvtModeSpec;
impl crate::RegisterSpec for FlashctlEvtModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flashctl_evt_mode::R`](R) reader structure"]
impl crate::Readable for FlashctlEvtModeSpec {}
#[doc = "`reset()` method sets FLASHCTL_EVT_MODE to value 0"]
impl crate::Resettable for FlashctlEvtModeSpec {}
