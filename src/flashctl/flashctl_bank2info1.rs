#[doc = "Register `FLASHCTL_BANK2INFO1` reader"]
pub type R = crate::R<FlashctlBank2info1Spec>;
...
#[doc = "Bank Information Register 1 for Bank 2\n\nYou can [`read`](crate::Reg::read) this register and get [`flashctl_bank2info1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FlashctlBank2info1Spec;
impl crate::RegisterSpec for FlashctlBank2info1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flashctl_bank2info1::R`](R) reader structure"]
impl crate::Readable for FlashctlBank2info1Spec {}
#[doc = "`reset()` method sets FLASHCTL_BANK2INFO1 to value 0"]
impl crate::Resettable for FlashctlBank2info1Spec {}
