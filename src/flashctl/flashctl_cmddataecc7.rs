#[doc = "Register `FLASHCTL_CMDDATAECC7` reader"]
pub type R = crate::R<FlashctlCmddataecc7Spec>;
#[doc = "Register `FLASHCTL_CMDDATAECC7` writer"]
pub type W = crate::W<FlashctlCmddataecc7Spec>;
...
impl W {
    #[doc = "Bits 0:7 - ECC data for bits 63:0 of the data is placed here."]
    #[inline(always)]
    pub fn val0(&mut self) -> Val0W<'_, FlashctlCmddataecc7Spec> {
        Val0W::new(self, 0)
    }
    #[doc = "Bits 8:15 - ECC data for bits 127:64 of the data is placed here."]
    #[inline(always)]
    pub fn val1(&mut self) -> Val1W<'_, FlashctlCmddataecc7Spec> {
        Val1W::new(self, 8)
    }
}
...
pub struct FlashctlCmddataecc7Spec;
impl crate::RegisterSpec for FlashctlCmddataecc7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flashctl_cmddataecc7::R`](R) reader structure"]
impl crate::Readable for FlashctlCmddataecc7Spec {}
#[doc = "`write(|w| ..)` method takes [`flashctl_cmddataecc7::W`](W) writer structure"]
impl crate::Writable for FlashctlCmddataecc7Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FLASHCTL_CMDDATAECC7 to value 0"]
impl crate::Resettable for FlashctlCmddataecc7Spec {}
