#[doc = "Register `FLASHCTL_BANK0INFO1` reader"]
pub type R = crate::R<FlashctlBank0info1Spec>;
...
#[doc = "Field `NONMAINSIZE` reader - Non-main region size in sectors Minimum: 0x0 (0) Maximum: 0x10 (16)"]
...
#[doc = "Field `TRIMSIZE` reader - Trim region size in sectors Minimum: 0x0 (0) Maximum: 0x10 (16)"]
...
#[doc = "Field `ENGRSIZE` reader - Engr region size in sectors Minimum: 0x0 (0) Maximum: 0x10 (16)"]
...
impl R {
    #[doc = "Bits 0:7 - Non-main region size in sectors Minimum: 0x0 (0) Maximum: 0x10 (16)"]
    #[inline(always)]
    pub fn nonmainsize(&self) -> NonmainsizeR {
        NonmainsizeR::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 8:15 - Trim region size in sectors Minimum: 0x0 (0) Maximum: 0x10 (16)"]
    #[inline(always)]
    pub fn trimsize(&self) -> TrimsizeR {
        TrimsizeR::new(((self.bits >> 8) & 0xff) as u8)
    }
    #[doc = "Bits 16:23 - Engr region size in sectors Minimum: 0x0 (0) Maximum: 0x10 (16)"]
    #[inline(always)]
    pub fn engrsize(&self) -> EngrsizeR {
        EngrsizeR::new(((self.bits >> 16) & 0xff) as u8)
    }
}
#[doc = "Bank Information Register 1 for Bank 0\n\nYou can [`read`](crate::Reg::read) this register and get [`flashctl_bank0info1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FlashctlBank0info1Spec;
impl crate::RegisterSpec for FlashctlBank0info1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flashctl_bank0info1::R`](R) reader structure"]
impl crate::Readable for FlashctlBank0info1Spec {}
#[doc = "`reset()` method sets FLASHCTL_BANK0INFO1 to value 0"]
impl crate::Resettable for FlashctlBank0info1Spec {}
