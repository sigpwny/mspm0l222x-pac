#[doc = "Register `FLASHCTL_BANK0INFO0` reader"]
pub type R = crate::R<FlashctlBank0info0Spec>;
...
#[doc = "Bank Information Register 0 for Bank 0\n\nYou can [`read`](crate::Reg::read) this register and get [`flashctl_bank0info0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FlashctlBank0info0Spec;
impl crate::RegisterSpec for FlashctlBank0info0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flashctl_bank0info0::R`](R) reader structure"]
impl crate::Readable for FlashctlBank0info0Spec {}
#[doc = "`reset()` method sets FLASHCTL_BANK0INFO0 to value 0"]
impl crate::Resettable for FlashctlBank0info0Spec {}
