#[doc = "Register `FLASHCTL_BANK1INFO0` reader"]
pub type R = crate::R<FlashctlBank1info0Spec>;
...
#[doc = "Bank Information Register 0 for Bank 1\n\nYou can [`read`](crate::Reg::read) this register and get [`flashctl_bank1info0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FlashctlBank1info0Spec;
impl crate::RegisterSpec for FlashctlBank1info0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flashctl_bank1info0::R`](R) reader structure"]
impl crate::Readable for FlashctlBank1info0Spec {}
#[doc = "`reset()` method sets FLASHCTL_BANK1INFO0 to value 0"]
impl crate::Resettable for FlashctlBank1info0Spec {}
