#[doc = "Register `FLASHCTL_BANK2INFO0` reader"]
pub type R = crate::R<FlashctlBank2info0Spec>;
...
#[doc = "Field `MAINSIZE` reader - Main region size in sectors Minimum: 0x8 (8) Maximum: 0x200 (512)"]
...
impl R {
    #[doc = "Bits 0:11 - Main region size in sectors Minimum: 0x8 (8) Maximum: 0x200 (512)"]
    #[inline(always)]
    pub fn mainsize(&self) -> MainsizeR {
        MainsizeR::new((self.bits & 0x0fff) as u16)
    }
}
#[doc = "Bank Information Register 0 for Bank 2\n\nYou can [`read`](crate::Reg::read) this register and get [`flashctl_bank2info0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FlashctlBank2info0Spec;
impl crate::RegisterSpec for FlashctlBank2info0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flashctl_bank2info0::R`](R) reader structure"]
impl crate::Readable for FlashctlBank2info0Spec {}
#[doc = "`reset()` method sets FLASHCTL_BANK2INFO0 to value 0"]
impl crate::Resettable for FlashctlBank2info0Spec {}
