#[doc = "Register `FLASHCTL_BANK4INFO1` reader"]
pub type R = crate::R<FlashctlBank4info1Spec>;
...
#[doc = "Bank Information Register 1 for Bank 4\n\nYou can [`read`](crate::Reg::read) this register and get [`flashctl_bank4info1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FlashctlBank4info1Spec;
impl crate::RegisterSpec for FlashctlBank4info1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flashctl_bank4info1::R`](R) reader structure"]
impl crate::Readable for FlashctlBank4info1Spec {}
#[doc = "`reset()` method sets FLASHCTL_BANK4INFO1 to value 0"]
impl crate::Resettable for FlashctlBank4info1Spec {}
