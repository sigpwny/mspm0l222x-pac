#[doc = "Register `I2C1_RSTCTL` writer"]
pub type W = crate::W<I2c1RstctlSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn resetassert(&mut self) -> ResetassertW<'_, I2c1RstctlSpec> {
        ResetassertW::new(self, 0)
    }
    #[doc = "Bit 1 - Clear the RESETSTKY bit in the STAT register"]
    #[inline(always)]
    pub fn resetstkyclr(&mut self) -> ResetstkyclrW<'_, I2c1RstctlSpec> {
        ResetstkyclrW::new(self, 1)
    }
}
#[doc = "Reset Control\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i2c1_rstctl::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c1RstctlSpec;
impl crate::RegisterSpec for I2c1RstctlSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`i2c1_rstctl::W`](W) writer structure"]
impl crate::Writable for I2c1RstctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I2C1_RSTCTL to value 0"]
impl crate::Resettable for I2c1RstctlSpec {}
