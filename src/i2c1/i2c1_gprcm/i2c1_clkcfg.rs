#[doc = "Register `I2C1_CLKCFG` reader"]
pub type R = crate::R<I2c1ClkcfgSpec>;
#[doc = "Register `I2C1_CLKCFG` writer"]
pub type W = crate::W<I2c1ClkcfgSpec>;
...
impl W {
    #[doc = "Bit 8 - Async Clock Request is blocked from starting SYSOSC or forcing bus clock to 32MHz"]
    #[inline(always)]
    pub fn blockasync(&mut self) -> BlockasyncW<'_, I2c1ClkcfgSpec> {
        BlockasyncW::new(self, 8)
    }
}
#[doc = "Peripheral Clock Configuration Register\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c1_clkcfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i2c1_clkcfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c1ClkcfgSpec;
impl crate::RegisterSpec for I2c1ClkcfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c1_clkcfg::R`](R) reader structure"]
impl crate::Readable for I2c1ClkcfgSpec {}
#[doc = "`write(|w| ..)` method takes [`i2c1_clkcfg::W`](W) writer structure"]
impl crate::Writable for I2c1ClkcfgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I2C1_CLKCFG to value 0"]
impl crate::Resettable for I2c1ClkcfgSpec {}
