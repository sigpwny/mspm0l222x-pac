#[doc = "Register `I2C1_CLKDIV` reader"]
pub type R = crate::R<I2c1ClkdivSpec>;
#[doc = "Register `I2C1_CLKDIV` writer"]
pub type W = crate::W<I2c1ClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Selects divide ratio of module clock"]
    #[inline(always)]
    pub fn ratio(&mut self) -> RatioW<'_, I2c1ClkdivSpec> {
        RatioW::new(self, 0)
    }
}
#[doc = "Clock Divider\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c1_clkdiv::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i2c1_clkdiv::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c1ClkdivSpec;
impl crate::RegisterSpec for I2c1ClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c1_clkdiv::R`](R) reader structure"]
impl crate::Readable for I2c1ClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`i2c1_clkdiv::W`](W) writer structure"]
impl crate::Writable for I2c1ClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I2C1_CLKDIV to value 0"]
impl crate::Resettable for I2c1ClkdivSpec {}
