#[doc = "Register `I2C1_TIMEOUT_CTL` reader"]
pub type R = crate::R<I2c1TimeoutCtlSpec>;
#[doc = "Register `I2C1_TIMEOUT_CTL` writer"]
pub type W = crate::W<I2c1TimeoutCtlSpec>;
...
impl W {
    #[doc = "Bits 0:7 - Timeout counter A load value Counter A is used for SCL low detection. This field contains the upper 8 bits of a 12-bit pre-load value for the Timeout A count. NOTE: The value of CNTLA must be greater than 1h. Each count is equal to 520 times the timeout period of functional clock. For example, with 8MHz functional clock and a 100KHz operating I2C clock, one timeout period will be equal to (1 / 8MHz) * 520 or 65 us."]
    #[inline(always)]
    pub fn tcntla(&mut self) -> TcntlaW<'_, I2c1TimeoutCtlSpec> {
        TcntlaW::new(self, 0)
    }
    #[doc = "Bit 15 - Timeout Counter A Enable"]
    #[inline(always)]
    pub fn tcntaen(&mut self) -> TcntaenW<'_, I2c1TimeoutCtlSpec> {
        TcntaenW::new(self, 15)
    }
    #[doc = "Bits 16:23 - Timeout Count B Load: Counter B is used for SCL High Detection. This field contains the upper 8 bits of a 12-bit pre-load value for the Timeout B count. NOTE: The value of CNTLB must be greater than 1h. Each count is equal to 1* clock period. For example, with 10MHz functional clock one timeout period will be equal to1*100ns."]
    #[inline(always)]
    pub fn tcntlb(&mut self) -> TcntlbW<'_, I2c1TimeoutCtlSpec> {
        TcntlbW::new(self, 16)
    }
    #[doc = "Bit 31 - Timeout Counter B Enable"]
    #[inline(always)]
    pub fn tcntben(&mut self) -> TcntbenW<'_, I2c1TimeoutCtlSpec> {
        TcntbenW::new(self, 31)
    }
}
#[doc = "I2C Timeout Count Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c1_timeout_ctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i2c1_timeout_ctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c1TimeoutCtlSpec;
impl crate::RegisterSpec for I2c1TimeoutCtlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c1_timeout_ctl::R`](R) reader structure"]
impl crate::Readable for I2c1TimeoutCtlSpec {}
#[doc = "`write(|w| ..)` method takes [`i2c1_timeout_ctl::W`](W) writer structure"]
impl crate::Writable for I2c1TimeoutCtlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I2C1_TIMEOUT_CTL to value 0x0002_0002"]
impl crate::Resettable for I2c1TimeoutCtlSpec {
