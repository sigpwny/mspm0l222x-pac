#[doc = "Register `I2C1_CFIFOCTL` reader"]
pub type R = crate::R<I2c1CfifoctlSpec>;
#[doc = "Register `I2C1_CFIFOCTL` writer"]
pub type W = crate::W<I2c1CfifoctlSpec>;
...
impl W {
    #[doc = "Bits 0:2 - TX FIFO Trigger Indicates at what fill level in the TX FIFO a trigger will be generated."]
    #[inline(always)]
    pub fn txtrig(&mut self) -> TxtrigW<'_, I2c1CfifoctlSpec> {
        TxtrigW::new(self, 0)
    }
    #[doc = "Bit 7 - TX FIFO Flush Setting this bit will Flush the TX FIFO. Before clearing this bit to stop Flush the TXFIFOCNT should be checked to be 8 and indicating that the Flush has completed."]
    #[inline(always)]
    pub fn txflush(&mut self) -> TxflushW<'_, I2c1CfifoctlSpec> {
        TxflushW::new(self, 7)
    }
    #[doc = "Bits 8:10 - RX FIFO Trigger Indicates at what fill level in the RX FIFO a trigger will be generated. Note: Programming RXTRIG to 0x0 has no effect since no data is present to transfer out of RX FIFO."]
    #[inline(always)]
    pub fn rxtrig(&mut self) -> RxtrigW<'_, I2c1CfifoctlSpec> {
        RxtrigW::new(self, 8)
    }
    #[doc = "Bit 15 - RX FIFO Flush Setting this bit will Flush the RX FIFO. Before clearing this bit to stop Flush the RXFIFOCNT should be checked to be 0 and indicating that the Flush has completed."]
    #[inline(always)]
    pub fn rxflush(&mut self) -> RxflushW<'_, I2c1CfifoctlSpec> {
        RxflushW::new(self, 15)
    }
}
#[doc = "I2C Controller FIFO Control\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c1_cfifoctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i2c1_cfifoctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c1CfifoctlSpec;
impl crate::RegisterSpec for I2c1CfifoctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c1_cfifoctl::R`](R) reader structure"]
impl crate::Readable for I2c1CfifoctlSpec {}
#[doc = "`write(|w| ..)` method takes [`i2c1_cfifoctl::W`](W) writer structure"]
impl crate::Writable for I2c1CfifoctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I2C1_CFIFOCTL to value 0"]
impl crate::Resettable for I2c1CfifoctlSpec {}
