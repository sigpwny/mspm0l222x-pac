#[doc = "Register `I2C1_CFIFOSR` reader"]
pub type R = crate::R<I2c1CfifosrSpec>;
...
#[doc = "I2C Controller FIFO Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c1_cfifosr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c1CfifosrSpec;
impl crate::RegisterSpec for I2c1CfifosrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c1_cfifosr::R`](R) reader structure"]
impl crate::Readable for I2c1CfifosrSpec {}
#[doc = "`reset()` method sets I2C1_CFIFOSR to value 0x0800"]
impl crate::Resettable for I2c1CfifosrSpec {
