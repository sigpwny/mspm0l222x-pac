#[doc = "Register `I2C1_CONTROLLER_PECSR` reader"]
pub type R = crate::R<I2c1ControllerPecsrSpec>;
#[doc = "Field `PECBYTECNT` reader - PEC Byte Count This is the current PEC Byte Count of the Controller State Machine."]
...
pub enum PecstsCheck {
    ...
    Cleared = 0,
    #[doc = "1: Indicates if the PEC was checked in the transaction that occurred before the last Stop"]
    Set = 1,
}
...
impl PecstsCheckR {
    ...
    #[doc = "Indicates if the PEC was checked in the transaction that occurred before the last Stop"]
    #[inline(always)]
...
pub enum PecstsError {
    ...
    Cleared = 0,
    #[doc = "1: Indicates if a PEC check error occurred in the transaction that occurred before the last Stop"]
    Set = 1,
}
...
impl PecstsErrorR {
    ...
    #[doc = "Indicates if a PEC check error occurred in the transaction that occurred before the last Stop"]
    #[inline(always)]
    pub fn is_set(&self) -> bool {
...
impl R {
    #[doc = "Bits 0:8 - PEC Byte Count This is the current PEC Byte Count of the Controller State Machine."]
    #[inline(always)]
...
#[doc = "I2C Controller PEC status register\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c1_controller_pecsr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c1ControllerPecsrSpec;
impl crate::RegisterSpec for I2c1ControllerPecsrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c1_controller_pecsr::R`](R) reader structure"]
impl crate::Readable for I2c1ControllerPecsrSpec {}
#[doc = "`reset()` method sets I2C1_CONTROLLER_PECSR to value 0"]
impl crate::Resettable for I2c1ControllerPecsrSpec {}
