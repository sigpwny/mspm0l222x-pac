#[doc = "Register `I2C1_CPU_INT_MIS` reader"]
pub type R = crate::R<I2c1CpuIntMisSpec>;
#[doc = "Controller Receive Data Interrupt\n\nValue on reset: 0"]
...
#[doc = "Field `CRXDONE` reader - Controller Receive Data Interrupt"]
...
#[doc = "Field `CRXFIFOFULL` reader - RXFIFO full event. This interrupt is set if the RX FIFO is full."]
...
#[doc = "Field `TSTART` reader - Target START Detection Interrupt"]
...
#[doc = "Field `TSTOP` reader - Target STOP Detection Interrupt"]
...
#[doc = "Field `INTR_OVFL` reader - Interrupt overflow"]
...
impl R {
    #[doc = "Bit 0 - Controller Receive Data Interrupt"]
    #[inline(always)]
...
#[doc = "Masked interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c1_cpu_int_mis::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c1CpuIntMisSpec;
impl crate::RegisterSpec for I2c1CpuIntMisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c1_cpu_int_mis::R`](R) reader structure"]
impl crate::Readable for I2c1CpuIntMisSpec {}
#[doc = "`reset()` method sets I2C1_CPU_INT_MIS to value 0"]
impl crate::Resettable for I2c1CpuIntMisSpec {}
