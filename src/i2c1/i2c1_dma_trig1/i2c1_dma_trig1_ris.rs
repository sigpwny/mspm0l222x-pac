#[doc = "Register `I2C1_DMA_TRIG1_RIS` reader"]
pub type R = crate::R<I2c1DmaTrig1RisSpec>;
...
#[doc = "Raw interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c1_dma_trig1_ris::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c1DmaTrig1RisSpec;
impl crate::RegisterSpec for I2c1DmaTrig1RisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c1_dma_trig1_ris::R`](R) reader structure"]
impl crate::Readable for I2c1DmaTrig1RisSpec {}
#[doc = "`reset()` method sets I2C1_DMA_TRIG1_RIS to value 0"]
impl crate::Resettable for I2c1DmaTrig1RisSpec {}
