#[doc = "Register `I2C1_DESC` reader"]
pub type R = crate::R<I2c1DescSpec>;
...
#[doc = "Module Description\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c1_desc::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c1DescSpec;
impl crate::RegisterSpec for I2c1DescSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c1_desc::R`](R) reader structure"]
impl crate::Readable for I2c1DescSpec {}
#[doc = "`reset()` method sets I2C1_DESC to value 0"]
impl crate::Resettable for I2c1DescSpec {}
