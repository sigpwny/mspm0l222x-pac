#[doc = "Register `I2C1_TIMEOUT_CNT` reader"]
pub type R = crate::R<I2c1TimeoutCntSpec>;
...
#[doc = "I2C Timeout Count Register\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c1_timeout_cnt::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c1TimeoutCntSpec;
impl crate::RegisterSpec for I2c1TimeoutCntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c1_timeout_cnt::R`](R) reader structure"]
impl crate::Readable for I2c1TimeoutCntSpec {}
#[doc = "`reset()` method sets I2C1_TIMEOUT_CNT to value 0x0002_0002"]
impl crate::Resettable for I2c1TimeoutCntSpec {
