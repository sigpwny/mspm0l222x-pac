#[doc = "Register `I2C1_CLKSEL` reader"]
pub type R = crate::R<I2c1ClkselSpec>;
#[doc = "Register `I2C1_CLKSEL` writer"]
pub type W = crate::W<I2c1ClkselSpec>;
...
impl W {
    #[doc = "Bit 2 - Selects MFCLK as clock source if enabled"]
    #[inline(always)]
    pub fn mfclk_sel(&mut self) -> MfclkSelW<'_, I2c1ClkselSpec> {
        MfclkSelW::new(self, 2)
    }
    #[doc = "Bit 3 - Selects BUSCLK as clock source if enabled"]
    #[inline(always)]
    pub fn busclk_sel(&mut self) -> BusclkSelW<'_, I2c1ClkselSpec> {
        BusclkSelW::new(self, 3)
    }
}
#[doc = "Clock Select for Ultra Low Power peripherals\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c1_clksel::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i2c1_clksel::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c1ClkselSpec;
impl crate::RegisterSpec for I2c1ClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c1_clksel::R`](R) reader structure"]
impl crate::Readable for I2c1ClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`i2c1_clksel::W`](W) writer structure"]
impl crate::Writable for I2c1ClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I2C1_CLKSEL to value 0"]
impl crate::Resettable for I2c1ClkselSpec {}
