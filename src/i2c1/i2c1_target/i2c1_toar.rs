#[doc = "Register `I2C1_TOAR` reader"]
pub type R = crate::R<I2c1ToarSpec>;
#[doc = "Register `I2C1_TOAR` writer"]
pub type W = crate::W<I2c1ToarSpec>;
...
impl W {
    #[doc = "Bits 0:9 - I2C Target Own Address: This field specifies bits A9 through A0 of the Target address. In 7-bit addressing mode as selected by I2CSOAR.MODE bit, the top 3 bits are don't care"]
    #[inline(always)]
    pub fn oar(&mut self) -> OarW<'_, I2c1ToarSpec> {
        OarW::new(self, 0)
    }
    #[doc = "Bit 14 - I2C Target Own Address Enable"]
    #[inline(always)]
    pub fn oaren(&mut self) -> OarenW<'_, I2c1ToarSpec> {
        OarenW::new(self, 14)
    }
    #[doc = "Bit 15 - This bit selects the adressing mode to be used in Target mode. When 0, 7-bit addressing is used. When 1, 10-bit addressing is used."]
    #[inline(always)]
    pub fn tmode(&mut self) -> TmodeW<'_, I2c1ToarSpec> {
        TmodeW::new(self, 15)
    }
}
#[doc = "I2C Target Own Address\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c1_toar::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i2c1_toar::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c1ToarSpec;
impl crate::RegisterSpec for I2c1ToarSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c1_toar::R`](R) reader structure"]
impl crate::Readable for I2c1ToarSpec {}
#[doc = "`write(|w| ..)` method takes [`i2c1_toar::W`](W) writer structure"]
impl crate::Writable for I2c1ToarSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I2C1_TOAR to value 0x4000"]
impl crate::Resettable for I2c1ToarSpec {
