#[doc = "Register `I2C1_TCTR` reader"]
pub type R = crate::R<I2c1TctrSpec>;
#[doc = "Register `I2C1_TCTR` writer"]
pub type W = crate::W<I2c1TctrSpec>;
...
impl W {
    #[doc = "Bit 0 - Device Active. Setting this bit enables the Target functionality."]
    #[inline(always)]
    pub fn active(&mut self) -> ActiveW<'_, I2c1TctrSpec> {
        ActiveW::new(self, 0)
    }
    #[doc = "Bit 1 - General call response enable Modify only when UCSWRST = 1. 0b = Do not respond to a general call 1b = Respond to a general call"]
    #[inline(always)]
    pub fn gencall(&mut self) -> GencallW<'_, I2c1TctrSpec> {
        GencallW::new(self, 1)
    }
    #[doc = "Bit 2 - Target Clock Stretch Enable"]
    #[inline(always)]
    pub fn tclkstretch(&mut self) -> TclkstretchW<'_, I2c1TctrSpec> {
        TclkstretchW::new(self, 2)
    }
    #[doc = "Bit 3 - Tx Empty Interrupt on TREQ"]
    #[inline(always)]
    pub fn txempty_on_treq(&mut self) -> TxemptyOnTreqW<'_, I2c1TctrSpec> {
        TxemptyOnTreqW::new(self, 3)
    }
    #[doc = "Bit 4 - Tx Trigger when Target FSM is in Tx Mode"]
    #[inline(always)]
    pub fn txtrig_txmode(&mut self) -> TxtrigTxmodeW<'_, I2c1TctrSpec> {
        TxtrigTxmodeW::new(self, 4)
    }
    #[doc = "Bit 5 - Tx transfer waits when stale data in Tx FIFO. This prevents stale bytes left in the TX FIFO from automatically being sent on the next I2C packet. Note: this should be used with TXEMPTY_ON_TREQ set to prevent the Target State Machine from waiting for TX FIFO data without an interrupt notification when the FIFO data is stale."]
    #[inline(always)]
    pub fn txwait_stale_txfifo(&mut self) -> TxwaitStaleTxfifoW<'_, I2c1TctrSpec> {
        TxwaitStaleTxfifoW::new(self, 5)
    }
    #[doc = "Bit 6 - Rx full interrupt generated on RREQ condition as indicated in SSR"]
    #[inline(always)]
    pub fn rxfull_on_rreq(&mut self) -> RxfullOnRreqW<'_, I2c1TctrSpec> {
        RxfullOnRreqW::new(self, 6)
    }
    #[doc = "Bit 7 - Enable Default Host Address"]
    #[inline(always)]
    pub fn en_defhostadr(&mut self) -> EnDefhostadrW<'_, I2c1TctrSpec> {
        EnDefhostadrW::new(self, 7)
    }
    #[doc = "Bit 8 - Enable Alert Response Address"]
    #[inline(always)]
    pub fn en_alrespadr(&mut self) -> EnAlrespadrW<'_, I2c1TctrSpec> {
        EnAlrespadrW::new(self, 8)
    }
    #[doc = "Bit 9 - Enable Deault device address"]
    #[inline(always)]
    pub fn en_defdevadr(&mut self) -> EnDefdevadrW<'_, I2c1TctrSpec> {
        EnDefdevadrW::new(self, 9)
    }
    #[doc = "Bit 10 - Target Wakeup Enable"]
    #[inline(always)]
    pub fn twuen(&mut self) -> TwuenW<'_, I2c1TctrSpec> {
        TwuenW::new(self, 10)
    }
}
#[doc = "I2C Target Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c1_tctr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i2c1_tctr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2c1TctrSpec;
impl crate::RegisterSpec for I2c1TctrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c1_tctr::R`](R) reader structure"]
impl crate::Readable for I2c1TctrSpec {}
#[doc = "`write(|w| ..)` method takes [`i2c1_tctr::W`](W) writer structure"]
impl crate::Writable for I2c1TctrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I2C1_TCTR to value 0x0404"]
impl crate::Resettable for I2c1TctrSpec {
