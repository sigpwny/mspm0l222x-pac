#[doc = "Register `UART0_RXDATA` reader"]
pub type R = crate::R<Uart0RxdataSpec>;
...
#[doc = "UART Receive Data Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uart0_rxdata::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart0RxdataSpec;
impl crate::RegisterSpec for Uart0RxdataSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart0_rxdata::R`](R) reader structure"]
impl crate::Readable for Uart0RxdataSpec {}
#[doc = "`reset()` method sets UART0_RXDATA to value 0"]
impl crate::Resettable for Uart0RxdataSpec {}
