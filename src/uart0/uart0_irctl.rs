#[doc = "Register `UART0_IRCTL` reader"]
pub type R = crate::R<Uart0IrctlSpec>;
#[doc = "Register `UART0_IRCTL` writer"]
pub type W = crate::W<Uart0IrctlSpec>;
...
impl W {
    #[doc = "Bit 0 - IrDA encoder/decoder enable"]
    #[inline(always)]
    pub fn iren(&mut self) -> IrenW<'_, Uart0IrctlSpec> {
        IrenW::new(self, 0)
    }
    #[doc = "Bit 1 - IrDA transmit pulse clock select"]
    #[inline(always)]
    pub fn irtxclk(&mut self) -> IrtxclkW<'_, Uart0IrctlSpec> {
        IrtxclkW::new(self, 1)
    }
    #[doc = "Bits 2:7 - Transmit pulse length. Pulse length t(PULSE) = (IRTXPLx + 1) / \\[2 * f(IRTXCLK)\\] (IRTXCLK = functional clock of the UART)"]
    #[inline(always)]
    pub fn irtxpl(&mut self) -> IrtxplW<'_, Uart0IrctlSpec> {
        IrtxplW::new(self, 2)
    }
    #[doc = "Bit 9 - IrDA receive input UCAxRXD polarity"]
    #[inline(always)]
    pub fn irrxpl(&mut self) -> IrrxplW<'_, Uart0IrctlSpec> {
        IrrxplW::new(self, 9)
    }
}
#[doc = "eUSCI_Ax IrDA Control Word Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uart0_irctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uart0_irctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart0IrctlSpec;
impl crate::RegisterSpec for Uart0IrctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart0_irctl::R`](R) reader structure"]
impl crate::Readable for Uart0IrctlSpec {}
#[doc = "`write(|w| ..)` method takes [`uart0_irctl::W`](W) writer structure"]
impl crate::Writable for Uart0IrctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UART0_IRCTL to value 0"]
impl crate::Resettable for Uart0IrctlSpec {}
