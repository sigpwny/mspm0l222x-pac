#[doc = "Register `UART0_CLKCFG` reader"]
pub type R = crate::R<Uart0ClkcfgSpec>;
#[doc = "Register `UART0_CLKCFG` writer"]
pub type W = crate::W<Uart0ClkcfgSpec>;
...
impl W {
    #[doc = "Bit 8 - Async Clock Request is blocked from starting SYSOSC or forcing bus clock to 32MHz"]
    #[inline(always)]
    pub fn blockasync(&mut self) -> BlockasyncW<'_, Uart0ClkcfgSpec> {
        BlockasyncW::new(self, 8)
    }
}
#[doc = "Peripheral Clock Configuration Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uart0_clkcfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uart0_clkcfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart0ClkcfgSpec;
impl crate::RegisterSpec for Uart0ClkcfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart0_clkcfg::R`](R) reader structure"]
impl crate::Readable for Uart0ClkcfgSpec {}
#[doc = "`write(|w| ..)` method takes [`uart0_clkcfg::W`](W) writer structure"]
impl crate::Writable for Uart0ClkcfgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UART0_CLKCFG to value 0"]
impl crate::Resettable for Uart0ClkcfgSpec {}
