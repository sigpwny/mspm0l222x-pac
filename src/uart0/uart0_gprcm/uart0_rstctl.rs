#[doc = "Register `UART0_RSTCTL` writer"]
pub type W = crate::W<Uart0RstctlSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn resetassert(&mut self) -> ResetassertW<'_, Uart0RstctlSpec> {
        ResetassertW::new(self, 0)
    }
    #[doc = "Bit 1 - Clear the RESETSTKY bit in the STAT register"]
    #[inline(always)]
    pub fn resetstkyclr(&mut self) -> ResetstkyclrW<'_, Uart0RstctlSpec> {
        ResetstkyclrW::new(self, 1)
    }
}
#[doc = "Reset Control\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uart0_rstctl::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart0RstctlSpec;
impl crate::RegisterSpec for Uart0RstctlSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`uart0_rstctl::W`](W) writer structure"]
impl crate::Writable for Uart0RstctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UART0_RSTCTL to value 0"]
impl crate::Resettable for Uart0RstctlSpec {}
