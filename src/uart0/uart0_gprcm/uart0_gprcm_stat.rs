#[doc = "Register `UART0_GPRCM_STAT` reader"]
pub type R = crate::R<Uart0GprcmStatSpec>;
...
#[doc = "Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uart0_gprcm_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart0GprcmStatSpec;
impl crate::RegisterSpec for Uart0GprcmStatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart0_gprcm_stat::R`](R) reader structure"]
impl crate::Readable for Uart0GprcmStatSpec {}
#[doc = "`reset()` method sets UART0_GPRCM_STAT to value 0"]
impl crate::Resettable for Uart0GprcmStatSpec {}
