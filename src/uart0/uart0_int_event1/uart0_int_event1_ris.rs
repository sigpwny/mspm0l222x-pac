#[doc = "Register `UART0_INT_EVENT1_RIS` reader"]
pub type R = crate::R<Uart0IntEvent1RisSpec>;
...
#[doc = "Raw interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`uart0_int_event1_ris::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart0IntEvent1RisSpec;
impl crate::RegisterSpec for Uart0IntEvent1RisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart0_int_event1_ris::R`](R) reader structure"]
impl crate::Readable for Uart0IntEvent1RisSpec {}
#[doc = "`reset()` method sets UART0_INT_EVENT1_RIS to value 0"]
impl crate::Resettable for Uart0IntEvent1RisSpec {}
