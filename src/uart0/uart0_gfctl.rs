#[doc = "Register `UART0_GFCTL` reader"]
pub type R = crate::R<Uart0GfctlSpec>;
#[doc = "Register `UART0_GFCTL` writer"]
pub type W = crate::W<Uart0GfctlSpec>;
...
impl W {
    #[doc = "Bits 0:5 - Glitch Suppression Pulse Width This field controls the pulse width select for glitch suppression on the RX line. The value programmed in this field gives the number of cycles of functional clock up to which the glitch has to be suppressed on the RX line. In IRDA mode: The minimum pulse length for receive is given by: t(MIN) = (DGFSEL) / f(IRTXCLK)"]
    #[inline(always)]
    pub fn dgfsel(&mut self) -> DgfselW<'_, Uart0GfctlSpec> {
        DgfselW::new(self, 0)
    }
    #[doc = "Bit 8 - Analog Glitch Suppression Enable"]
    #[inline(always)]
    pub fn agfen(&mut self) -> AgfenW<'_, Uart0GfctlSpec> {
        AgfenW::new(self, 8)
    }
    #[doc = "Bits 9:10 - Analog Glitch Suppression Pulse Width This field controls the pulse width select for the analog glitch suppression on the RX line. See device datasheet for exact values."]
    #[inline(always)]
    pub fn agfsel(&mut self) -> AgfselW<'_, Uart0GfctlSpec> {
        AgfselW::new(self, 9)
    }
    #[doc = "Bit 11 - Analog and digital noise filters chaining enable. 0 DISABLE: When 0, chaining is disabled and only digital filter output is available to IP logic for sampling 1 ENABLE: When 1, analog and digital glitch filters are chained and the output of the combination is made available to IP logic for sampling"]
    #[inline(always)]
    pub fn chain(&mut self) -> ChainW<'_, Uart0GfctlSpec> {
        ChainW::new(self, 11)
    }
}
#[doc = "Glitch Filter Control\n\nYou can [`read`](crate::Reg::read) this register and get [`uart0_gfctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uart0_gfctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart0GfctlSpec;
impl crate::RegisterSpec for Uart0GfctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart0_gfctl::R`](R) reader structure"]
impl crate::Readable for Uart0GfctlSpec {}
#[doc = "`write(|w| ..)` method takes [`uart0_gfctl::W`](W) writer structure"]
impl crate::Writable for Uart0GfctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UART0_GFCTL to value 0"]
impl crate::Resettable for Uart0GfctlSpec {}
