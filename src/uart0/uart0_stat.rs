#[doc = "Register `UART0_STAT` reader"]
pub type R = crate::R<Uart0StatSpec>;
...
#[doc = "UART Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uart0_stat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart0StatSpec;
impl crate::RegisterSpec for Uart0StatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart0_stat::R`](R) reader structure"]
impl crate::Readable for Uart0StatSpec {}
#[doc = "`reset()` method sets UART0_STAT to value 0"]
impl crate::Resettable for Uart0StatSpec {}
