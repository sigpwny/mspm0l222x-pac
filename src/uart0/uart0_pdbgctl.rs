#[doc = "Register `UART0_PDBGCTL` reader"]
pub type R = crate::R<Uart0PdbgctlSpec>;
#[doc = "Register `UART0_PDBGCTL` writer"]
pub type W = crate::W<Uart0PdbgctlSpec>;
...
impl W {
    #[doc = "Bit 0 - Free run control"]
    #[inline(always)]
    pub fn free(&mut self) -> FreeW<'_, Uart0PdbgctlSpec> {
        FreeW::new(self, 0)
    }
    #[doc = "Bit 1 - Soft halt boundary control. This function is only available, if \\[FREE\\] is set to 'STOP'"]
    #[inline(always)]
    pub fn soft(&mut self) -> SoftW<'_, Uart0PdbgctlSpec> {
        SoftW::new(self, 1)
    }
}
#[doc = "Peripheral Debug Control\n\nYou can [`read`](crate::Reg::read) this register and get [`uart0_pdbgctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uart0_pdbgctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart0PdbgctlSpec;
impl crate::RegisterSpec for Uart0PdbgctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart0_pdbgctl::R`](R) reader structure"]
impl crate::Readable for Uart0PdbgctlSpec {}
#[doc = "`write(|w| ..)` method takes [`uart0_pdbgctl::W`](W) writer structure"]
impl crate::Writable for Uart0PdbgctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UART0_PDBGCTL to value 0"]
impl crate::Resettable for Uart0PdbgctlSpec {}
