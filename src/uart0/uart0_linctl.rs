#[doc = "Register `UART0_LINCTL` reader"]
pub type R = crate::R<Uart0LinctlSpec>;
#[doc = "Register `UART0_LINCTL` writer"]
pub type W = crate::W<Uart0LinctlSpec>;
...
impl W {
    #[doc = "Bit 0 - LIN Counter Enable. LIN counter will only count when enabled."]
    #[inline(always)]
    pub fn ctrena(&mut self) -> CtrenaW<'_, Uart0LinctlSpec> {
        CtrenaW::new(self, 0)
    }
    #[doc = "Bit 1 - Zero on negative Edge of RXD. When enabled the counter is set to 0 and starts counting on a negative edge of RXD"]
    #[inline(always)]
    pub fn zerone(&mut self) -> ZeroneW<'_, Uart0LinctlSpec> {
        ZeroneW::new(self, 1)
    }
    #[doc = "Bit 2 - Count while low Signal on RXD When counter is enabled and the signal on RXD is low, the counter increments."]
    #[inline(always)]
    pub fn cntrxlow(&mut self) -> CntrxlowW<'_, Uart0LinctlSpec> {
        CntrxlowW::new(self, 2)
    }
    #[doc = "Bit 4 - Capture Counter on negative RXD Edge. When enabled the counter value is captured to LINC0 register on each negative RXD edge. A LINC0 interrupt is triggered when enabled."]
    #[inline(always)]
    pub fn linc0cap(&mut self) -> Linc0capW<'_, Uart0LinctlSpec> {
        Linc0capW::new(self, 4)
    }
    #[doc = "Bit 5 - Capture Counter on positive RXD Edge. When enabled the counter value is captured to LINC1 register on each positive RXD edge. A LINC1 interrupt is triggered when enabled."]
    #[inline(always)]
    pub fn linc1cap(&mut self) -> Linc1capW<'_, Uart0LinctlSpec> {
        Linc1capW::new(self, 5)
    }
    #[doc = "Bit 6 - Counter Compare Match Mode When this bit is set to 1 a counter compare match with LINC0 register triggers an LINC0 interrupt when enabled."]
    #[inline(always)]
    pub fn linc0_match(&mut self) -> Linc0MatchW<'_, Uart0LinctlSpec> {
        Linc0MatchW::new(self, 6)
    }
}
#[doc = "UART LIN Mode Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uart0_linctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uart0_linctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart0LinctlSpec;
impl crate::RegisterSpec for Uart0LinctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart0_linctl::R`](R) reader structure"]
impl crate::Readable for Uart0LinctlSpec {}
#[doc = "`write(|w| ..)` method takes [`uart0_linctl::W`](W) writer structure"]
impl crate::Writable for Uart0LinctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UART0_LINCTL to value 0"]
impl crate::Resettable for Uart0LinctlSpec {}
