#[doc = "Register `UART0_INT_EVENT0_RIS` reader"]
pub type R = crate::R<Uart0IntEvent0RisSpec>;
...
#[doc = "LIN Capture 0 / Match Interrupt .\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Linc0 {
    #[doc = "0: Interrupt did not occur"]
    Clr = 0,
...
#[doc = "Field `LINC0` reader - LIN Capture 0 / Match Interrupt ."]
...
#[doc = "Field `LINC1` reader - LIN Capture 1 Interrupt."]
...
#[doc = "Field `LINOVF` reader - LIN Hardware Counter Overflow Interrupt."]
...
impl R {
    ...
    #[doc = "Bit 7 - LIN Capture 0 / Match Interrupt ."]
    #[inline(always)]
    pub fn linc0(&self) -> Linc0R {
        Linc0R::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8 - LIN Capture 1 Interrupt."]
    #[inline(always)]
    pub fn linc1(&self) -> Linc1R {
        Linc1R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - LIN Hardware Counter Overflow Interrupt."]
    #[inline(always)]
...
#[doc = "Raw interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`uart0_int_event0_ris::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart0IntEvent0RisSpec;
impl crate::RegisterSpec for Uart0IntEvent0RisSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart0_int_event0_ris::R`](R) reader structure"]
impl crate::Readable for Uart0IntEvent0RisSpec {}
#[doc = "`reset()` method sets UART0_INT_EVENT0_RIS to value 0"]
impl crate::Resettable for Uart0IntEvent0RisSpec {}
