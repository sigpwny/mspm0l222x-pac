#[doc = "Register `UART0_INT_EVENT0_IIDX` reader"]
pub type R = crate::R<Uart0IntEvent0IidxSpec>;
...
#[doc = "Interrupt index\n\nYou can [`read`](crate::Reg::read) this register and get [`uart0_int_event0_iidx::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uart0IntEvent0IidxSpec;
impl crate::RegisterSpec for Uart0IntEvent0IidxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart0_int_event0_iidx::R`](R) reader structure"]
impl crate::Readable for Uart0IntEvent0IidxSpec {}
#[doc = "`reset()` method sets UART0_INT_EVENT0_IIDX to value 0"]
impl crate::Resettable for Uart0IntEvent0IidxSpec {}
