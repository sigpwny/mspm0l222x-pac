#[doc = "Register `WWDT0_DESC` reader"]
pub type R = crate::R<Wwdt0DescSpec>;
...
#[doc = "Module Description\n\nYou can [`read`](crate::Reg::read) this register and get [`wwdt0_desc::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Wwdt0DescSpec;
impl crate::RegisterSpec for Wwdt0DescSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`wwdt0_desc::R`](R) reader structure"]
impl crate::Readable for Wwdt0DescSpec {}
#[doc = "`reset()` method sets WWDT0_DESC to value 0"]
impl crate::Resettable for Wwdt0DescSpec {}
