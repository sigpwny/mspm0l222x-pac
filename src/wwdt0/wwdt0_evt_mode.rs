#[doc = "Register `WWDT0_EVT_MODE` reader"]
pub type R = crate::R<Wwdt0EvtModeSpec>;
#[doc = "Register `WWDT0_EVT_MODE` writer"]
pub type W = crate::W<Wwdt0EvtModeSpec>;
...
#[doc = "Field `INT0_CFG` reader - Event line mode select for event corresponding to \\[IPSTANDARD.INT_EVENT\\]\\[0\\]"]
...
impl W {}
#[doc = "Event Mode\n\nYou can [`read`](crate::Reg::read) this register and get [`wwdt0_evt_mode::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`wwdt0_evt_mode::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Wwdt0EvtModeSpec;
impl crate::RegisterSpec for Wwdt0EvtModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`wwdt0_evt_mode::R`](R) reader structure"]
impl crate::Readable for Wwdt0EvtModeSpec {}
#[doc = "`write(|w| ..)` method takes [`wwdt0_evt_mode::W`](W) writer structure"]
impl crate::Writable for Wwdt0EvtModeSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets WWDT0_EVT_MODE to value 0"]
impl crate::Resettable for Wwdt0EvtModeSpec {}
